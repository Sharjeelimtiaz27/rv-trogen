 ...
 * Payload: Route fu_data_t to leak port
 * 
...
// ============================================================
// Information Leak: Route fu_data_t to unused output
//
...
//   Replace: assign output_signal = trojan_active ? fu_data_t : normal_value;