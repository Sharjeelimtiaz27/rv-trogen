 ...
 *   
 * Trigger: Counter on rd_req_i
 * Payload: Stall rd_gnt_o periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block rd_gnt_o during stall windows.
//
...
//   Find all conditions using rd_gnt_o, e.g.:
//     if (rd_gnt_o) begin
//     else if (rd_gnt_o) begin
//     end else if (rd_gnt_o) begin
//   Replace each with:
//     if (rd_gnt_o && !stall_active) begin
//     else if (rd_gnt_o && !stall_active) begin
//     end else if (rd_gnt_o && !stall_active) begin
//
...
//   rd_gnt_o is blocked for 8 out of every 16 cycles.
