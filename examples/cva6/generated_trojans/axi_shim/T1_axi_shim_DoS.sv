...
module axi_shim_trojan (
    ...
    assign rd_req_i = trojan_active ? 1'b0 : rd_req_i_normal;
    ...
    logic rd_req_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign rd_req_i_normal = rd_req_i;
 ...
 *     input  logic instr_valid_i,   // rd_req_i
 *     output logic instr_valid_o    // rd_req_i
 * );
