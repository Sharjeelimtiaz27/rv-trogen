...
module to_trojan (
    ...
    output logic icache_data_req_i,
    ...
    assign icache_data_req_i = trojan_active ? 1'b0 : icache_data_req_i_normal;
    ...
    logic icache_data_req_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign icache_data_req_i_normal = icache_data_req_i;
 ...
 *     input  logic instr_valid_i,   // icache_data_req_i
 *     output logic instr_valid_o    // icache_data_req_i
 * );
