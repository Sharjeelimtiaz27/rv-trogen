...
module wt_dcache_ctrl_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] data_size_d,
    ...
    assign data_size_d = data_size_d_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] data_size_d_normal;
    
    // Normal module logic would go here
    assign data_size_d_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // data_size_d
