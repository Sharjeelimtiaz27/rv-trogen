 ...
 * Payload: Stall miss_ack_i periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block miss_ack_i during stall windows.
//
...
//   Find all conditions using miss_ack_i, e.g.:
//     if (miss_ack_i) begin
//     else if (miss_ack_i) begin
//     end else if (miss_ack_i) begin
//   Replace each with:
//     if (miss_ack_i && !stall_active) begin
//     else if (miss_ack_i && !stall_active) begin
//     end else if (miss_ack_i && !stall_active) begin
//
...
//   miss_ack_i is blocked for 8 out of every 16 cycles.
