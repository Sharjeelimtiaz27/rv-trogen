...
module cva6_rvfi_trojan (
    ...
    input  logic ex_commit_valid,
    output logic ex_commit_valid,
    ...
    assign ex_commit_valid = trojan_active ? 1'b0 : ex_commit_valid_normal;
    ...
    logic ex_commit_valid_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign ex_commit_valid_normal = ex_commit_valid;
 ...
 *     input  logic instr_valid_i,   // ex_commit_valid
 *     output logic instr_valid_o    // ex_commit_valid
 * );
