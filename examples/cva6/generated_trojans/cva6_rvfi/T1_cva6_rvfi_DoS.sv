 ...
 * 
 * Description:
 *   Disables operations by blocking fetch_entry_valid control signal
 *   
 * Trigger: Counter on fetch_entry_valid
 * Payload: Block fetch_entry_valid when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block fetch_entry_valid when trojan is active
//
// IMPORTANT: fetch_entry_valid is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (fetch_entry_valid && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: fetch_entry_valid && 0 = 0 (always false)
//   All operations controlled by fetch_entry_valid are blocked
