 ...
 * Payload: Stall fetch_entry_valid periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block fetch_entry_valid during stall windows.
//
...
//   Find all conditions using fetch_entry_valid, e.g.:
//     if (fetch_entry_valid) begin
//     else if (fetch_entry_valid) begin
//     end else if (fetch_entry_valid) begin
//   Replace each with:
//     if (fetch_entry_valid && !stall_active) begin
//     else if (fetch_entry_valid && !stall_active) begin
//     end else if (fetch_entry_valid && !stall_active) begin
//
...
//   fetch_entry_valid is blocked for 8 out of every 16 cycles.
