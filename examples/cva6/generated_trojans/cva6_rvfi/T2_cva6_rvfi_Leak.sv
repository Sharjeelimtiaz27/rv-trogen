...
module cva6_rvfi_trojan (
    ...
    // Trigger signals
    input  logic operand_a_sext,        // e.g., debug_mode, test_enable
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] rvfi_csr_t,
    ...
    assign rvfi_csr_t = rvfi_csr_t_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] rvfi_csr_t_normal;
    
    // Normal module logic would go here
    assign rvfi_csr_t_normal = '0;  // Placeholder
