...
module branch_unit_trojan (
    ...
    assign branch_valid_i = trojan_active ? 1'b0 : branch_valid_i_normal;
    ...
    logic branch_valid_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign branch_valid_i_normal = branch_valid_i;
 ...
 *     input  logic instr_valid_i,   // branch_valid_i
 *     output logic instr_valid_o    // branch_valid_i
 * );
