...
module branch_unit_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] fu_data_t,
    ...
    assign fu_data_t = fu_data_t_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] fu_data_t_normal;
    
    // Normal module logic would go here
    assign fu_data_t_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // fu_data_t
