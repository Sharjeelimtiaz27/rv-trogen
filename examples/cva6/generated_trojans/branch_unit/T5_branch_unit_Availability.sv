 ...
 * Payload: Stall branch_valid_i periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block branch_valid_i during stall windows.
//
...
//   Find all conditions using branch_valid_i, e.g.:
//     if (branch_valid_i) begin
//     else if (branch_valid_i) begin
//     end else if (branch_valid_i) begin
//   Replace each with:
//     if (branch_valid_i && !stall_active) begin
//     else if (branch_valid_i && !stall_active) begin
//     end else if (branch_valid_i && !stall_active) begin
//
...
//   branch_valid_i is blocked for 8 out of every 16 cycles.
