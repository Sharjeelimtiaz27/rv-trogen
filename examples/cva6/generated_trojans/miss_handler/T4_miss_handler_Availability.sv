 ...
 *   
 * Trigger: Counter on miss_req_i
 * Payload: Stall flush_ack_o periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block flush_ack_o during stall windows.
//
...
//   Find all conditions using flush_ack_o, e.g.:
//     if (flush_ack_o) begin
//     else if (flush_ack_o) begin
//     end else if (flush_ack_o) begin
//   Replace each with:
//     if (flush_ack_o && !stall_active) begin
//     else if (flush_ack_o && !stall_active) begin
//     end else if (flush_ack_o && !stall_active) begin
//
...
//   flush_ack_o is blocked for 8 out of every 16 cycles.
