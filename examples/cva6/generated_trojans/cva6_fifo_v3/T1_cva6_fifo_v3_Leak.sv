...
module cva6_fifo_v3_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Trigger signals
    input  logic testmode_i,        // e.g., debug_mode, test_enable
