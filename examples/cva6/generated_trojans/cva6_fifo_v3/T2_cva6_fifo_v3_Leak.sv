 ...
 * Payload: Route data_i to leak port
 * 
...
// ============================================================
// Information Leak: Route data_i to unused output
//
...
//   Replace: assign output_signal = trojan_active ? data_i : normal_value;