...
module trigger_module_trojan (
    ...
    // Trigger signals
    input  logic debug_mode_i,        // e.g., debug_mode, test_enable
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] tdata1_we,
    ...
    assign tdata1_we = tdata1_we_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] tdata1_we_normal;
    
    // Normal module logic would go here
    assign tdata1_we_normal = '0;  // Placeholder
