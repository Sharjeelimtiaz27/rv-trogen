...
module macro_decoder_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] reg_numbers,
    ...
    assign reg_numbers = reg_numbers_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] reg_numbers_normal;
    
    // Normal module logic would go here
    assign reg_numbers_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // reg_numbers
