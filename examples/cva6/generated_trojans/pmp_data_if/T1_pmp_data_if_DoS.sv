...
module pmp_data_if_trojan (
    ...
    input  logic icache_areq_t,
    output logic icache_areq_t,
    ...
    assign icache_areq_t = trojan_active ? 1'b0 : icache_areq_t_normal;
    ...
    logic icache_areq_t_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign icache_areq_t_normal = icache_areq_t;
 ...
 *     input  logic instr_valid_i,   // icache_areq_t
 *     output logic instr_valid_o    // icache_areq_t
 * );
