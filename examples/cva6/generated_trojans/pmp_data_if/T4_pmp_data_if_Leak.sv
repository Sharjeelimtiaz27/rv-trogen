...
module pmp_data_if_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] match_any_execute_region,
    ...
    assign match_any_execute_region = match_any_execute_region_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] match_any_execute_region_normal;
    
    // Normal module logic would go here
    assign match_any_execute_region_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // match_any_execute_region
