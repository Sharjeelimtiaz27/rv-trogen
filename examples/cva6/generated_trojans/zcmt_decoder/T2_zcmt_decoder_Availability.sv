 ...
 * Payload: Stall fetch_stall_o periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block fetch_stall_o during stall windows.
//
...
//   Find all conditions using fetch_stall_o, e.g.:
//     if (fetch_stall_o) begin
//     else if (fetch_stall_o) begin
//     end else if (fetch_stall_o) begin
//   Replace each with:
//     if (fetch_stall_o && !stall_active) begin
//     else if (fetch_stall_o && !stall_active) begin
//     end else if (fetch_stall_o && !stall_active) begin
//
...
//   fetch_stall_o is blocked for 8 out of every 16 cycles.
