...
module cva6_hpdcache_wrapper_trojan (
    ...
    assign dcache_enable_i = trojan_active ? 1'b0 : dcache_enable_i_normal;
    ...
    logic dcache_enable_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign dcache_enable_i_normal = dcache_enable_i;
 ...
 *     input  logic instr_valid_i,   // dcache_enable_i
 *     output logic instr_valid_o    // dcache_enable_i
 * );
