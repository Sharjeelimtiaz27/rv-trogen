...
module cva6_hpdcache_wrapper_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] dcache_mem_req_write_data_ready_i,
    ...
    assign dcache_mem_req_write_data_ready_i = dcache_mem_req_write_data_ready_i_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] dcache_mem_req_write_data_ready_i_normal;
    
    // Normal module logic would go here
    assign dcache_mem_req_write_data_ready_i_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // dcache_mem_req_write_data_ready_i
