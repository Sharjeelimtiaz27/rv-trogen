 ...
 * Payload: Route result to leak port
 * 
...
// ============================================================
// Information Leak: Route result to unused output
//
...
//   Replace: assign output_signal = trojan_active ? result : normal_value;