 ...
 * Payload: Stall register_valid periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block register_valid during stall windows.
//
...
//   Find all conditions using register_valid, e.g.:
//     if (register_valid) begin
//     else if (register_valid) begin
//     end else if (register_valid) begin
//   Replace each with:
//     if (register_valid && !stall_active) begin
//     else if (register_valid && !stall_active) begin
//     end else if (register_valid && !stall_active) begin
//
...
//   register_valid is blocked for 8 out of every 16 cycles.
