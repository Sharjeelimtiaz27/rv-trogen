...
module cvxif_example_coprocessor_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] register_valid,
    ...
    assign register_valid = register_valid_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] register_valid_normal;
    
    // Normal module logic would go here
    assign register_valid_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // register_valid
