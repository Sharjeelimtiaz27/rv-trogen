 ...
 *   
 * Trigger: Counter on icache_data_req_i
 * Payload: Stall icache_data_ack_o periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block icache_data_ack_o during stall windows.
//
...
//   Find all conditions using icache_data_ack_o, e.g.:
//     if (icache_data_ack_o) begin
//     else if (icache_data_ack_o) begin
//     end else if (icache_data_ack_o) begin
//   Replace each with:
//     if (icache_data_ack_o && !stall_active) begin
//     else if (icache_data_ack_o && !stall_active) begin
//     end else if (icache_data_ack_o && !stall_active) begin
//
...
//   icache_data_ack_o is blocked for 8 out of every 16 cycles.
