...
module to_trojan (
    ...
    // Trigger signals
    input  logic l15_data_next_entry,        // e.g., debug_mode, test_enable
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] icache_data_req_i,
    ...
    assign icache_data_req_i = icache_data_req_i_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] icache_data_req_i_normal;
    
    // Normal module logic would go here
    assign icache_data_req_i_normal = '0;  // Placeholder
