 ...
 *   
 * Trigger: Counter on csr_valid_i
 * Payload: Stall csr_ready_o periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block csr_ready_o during stall windows.
//
...
//   Find all conditions using csr_ready_o, e.g.:
//     if (csr_ready_o) begin
//     else if (csr_ready_o) begin
//     end else if (csr_ready_o) begin
//   Replace each with:
//     if (csr_ready_o && !stall_active) begin
//     else if (csr_ready_o && !stall_active) begin
//     end else if (csr_ready_o && !stall_active) begin
//
...
//   csr_ready_o is blocked for 8 out of every 16 cycles.
