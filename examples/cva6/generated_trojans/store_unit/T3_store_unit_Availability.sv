 ...
 *   
 * Trigger: Counter on store_buffer_empty_o
 * Payload: Stall stall_st_pending_i periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block stall_st_pending_i during stall windows.
//
...
//   Find all conditions using stall_st_pending_i, e.g.:
//     if (stall_st_pending_i) begin
//     else if (stall_st_pending_i) begin
//     end else if (stall_st_pending_i) begin
//   Replace each with:
//     if (stall_st_pending_i && !stall_active) begin
//     else if (stall_st_pending_i && !stall_active) begin
//     end else if (stall_st_pending_i && !stall_active) begin
//
...
//   stall_st_pending_i is blocked for 8 out of every 16 cycles.
