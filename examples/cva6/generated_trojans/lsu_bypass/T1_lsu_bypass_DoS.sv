...
module lsu_bypass_trojan (
    ...
    assign lsu_req_valid_i = trojan_active ? 1'b0 : lsu_req_valid_i_normal;
    ...
    logic lsu_req_valid_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign lsu_req_valid_i_normal = lsu_req_valid_i;
 ...
 *     input  logic instr_valid_i,   // lsu_req_valid_i
 *     output logic instr_valid_o    // lsu_req_valid_i
 * );
