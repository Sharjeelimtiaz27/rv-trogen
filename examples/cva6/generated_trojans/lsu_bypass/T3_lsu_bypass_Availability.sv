 ...
 *   
 * Trigger: Counter on lsu_ctrl_t
 * Payload: Stall lsu_req_valid_i periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block lsu_req_valid_i during stall windows.
//
...
//   Find all conditions using lsu_req_valid_i, e.g.:
//     if (lsu_req_valid_i) begin
//     else if (lsu_req_valid_i) begin
//     end else if (lsu_req_valid_i) begin
//   Replace each with:
//     if (lsu_req_valid_i && !stall_active) begin
//     else if (lsu_req_valid_i && !stall_active) begin
//     end else if (lsu_req_valid_i && !stall_active) begin
//
...
//   lsu_req_valid_i is blocked for 8 out of every 16 cycles.
