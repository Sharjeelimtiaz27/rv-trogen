 ...
 * Payload: Stall rd_ack_o periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block rd_ack_o during stall windows.
//
...
//   Find all conditions using rd_ack_o, e.g.:
//     if (rd_ack_o) begin
//     else if (rd_ack_o) begin
//     end else if (rd_ack_o) begin
//   Replace each with:
//     if (rd_ack_o && !stall_active) begin
//     else if (rd_ack_o && !stall_active) begin
//     end else if (rd_ack_o && !stall_active) begin
//
...
//   rd_ack_o is blocked for 8 out of every 16 cycles.
