...
module load_unit_trojan (
    ...
    assign address = address_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] address_normal;
    
    // Normal module logic would go here
    assign address_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // address
