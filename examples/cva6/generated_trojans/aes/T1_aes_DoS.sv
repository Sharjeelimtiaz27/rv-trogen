...
module aes_trojan (
    ...
    input  logic aes32esi_gen,
    output logic aes32esi_gen,
    ...
    assign aes32esi_gen = trojan_active ? 1'b0 : aes32esi_gen_normal;
    ...
    logic aes32esi_gen_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign aes32esi_gen_normal = aes32esi_gen;
 ...
 *     input  logic instr_valid_i,   // aes32esi_gen
 *     output logic instr_valid_o    // aes32esi_gen
 * );
