...
module instr_decoder_trojan (
    ...
    assign issue_valid_i = trojan_active ? 1'b0 : issue_valid_i_normal;
    ...
    logic issue_valid_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign issue_valid_i_normal = issue_valid_i;
 ...
 *     input  logic instr_valid_i,   // issue_valid_i
 *     output logic instr_valid_o    // issue_valid_i
 * );
