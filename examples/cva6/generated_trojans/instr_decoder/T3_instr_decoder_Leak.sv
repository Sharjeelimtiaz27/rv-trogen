...
module instr_decoder_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] register_valid_i,
    ...
    assign register_valid_i = register_valid_i_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] register_valid_i_normal;
    
    // Normal module logic would go here
    assign register_valid_i_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // register_valid_i
