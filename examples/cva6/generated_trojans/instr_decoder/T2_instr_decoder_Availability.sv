 ...
 * Payload: Stall issue_valid_i periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block issue_valid_i during stall windows.
//
...
//   Find all conditions using issue_valid_i, e.g.:
//     if (issue_valid_i) begin
//     else if (issue_valid_i) begin
//     end else if (issue_valid_i) begin
//   Replace each with:
//     if (issue_valid_i && !stall_active) begin
//     else if (issue_valid_i && !stall_active) begin
//     end else if (issue_valid_i && !stall_active) begin
//
...
//   issue_valid_i is blocked for 8 out of every 16 cycles.
