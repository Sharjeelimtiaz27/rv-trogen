...
module wt_cache_subsystem_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] inval_addr_i,
    ...
    assign inval_addr_i = inval_addr_i_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] inval_addr_i_normal;
    
    // Normal module logic would go here
    assign inval_addr_i_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // inval_addr_i
