...
module is_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] gpaddr_to_be_flushed_is0,
    ...
    assign gpaddr_to_be_flushed_is0 = gpaddr_to_be_flushed_is0_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] gpaddr_to_be_flushed_is0_normal;
    
    // Normal module logic would go here
    assign gpaddr_to_be_flushed_is0_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // gpaddr_to_be_flushed_is0
