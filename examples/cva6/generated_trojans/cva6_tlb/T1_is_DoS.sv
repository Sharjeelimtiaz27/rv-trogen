...
module is_trojan (
    ...
    assign s_st_enbl_i = trojan_active ? 1'b0 : s_st_enbl_i_normal;
    ...
    logic s_st_enbl_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign s_st_enbl_i_normal = s_st_enbl_i;
 ...
 *     input  logic instr_valid_i,   // s_st_enbl_i
 *     output logic instr_valid_o    // s_st_enbl_i
 * );
