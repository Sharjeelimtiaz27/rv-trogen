...
module controller_trojan (
    ...
    assign ex_valid_i = trojan_active ? 1'b0 : ex_valid_i_normal;
    ...
    logic ex_valid_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign ex_valid_i_normal = ex_valid_i;
 ...
 *     input  logic instr_valid_i,   // ex_valid_i
 *     output logic instr_valid_o    // ex_valid_i
 * );
