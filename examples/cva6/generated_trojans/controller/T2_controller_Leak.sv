...
module controller_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] halt_csr_i,
    ...
    assign halt_csr_i = halt_csr_i_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] halt_csr_i_normal;
    
    // Normal module logic would go here
    assign halt_csr_i_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // halt_csr_i
