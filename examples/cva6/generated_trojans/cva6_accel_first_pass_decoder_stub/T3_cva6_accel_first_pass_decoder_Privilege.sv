...
module cva6_accel_first_pass_decoder_trojan (
    // CSR access signals
    input  logic        is_control_flow_instr_o,         // csr_we or csr_access
