...
module cva6_hpdcache_subsystem_trojan (
    ...
    assign icache_en_i = trojan_active ? 1'b0 : icache_en_i_normal;
    ...
    logic icache_en_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign icache_en_i_normal = icache_en_i;
 ...
 *     input  logic instr_valid_i,   // icache_en_i
 *     output logic instr_valid_o    // icache_en_i
 * );
