...
module cva6_hpdcache_subsystem_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] dcache_write_data_ready,
    ...
    assign dcache_write_data_ready = dcache_write_data_ready_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] dcache_write_data_ready_normal;
    
    // Normal module logic would go here
    assign dcache_write_data_ready_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // dcache_write_data_ready
