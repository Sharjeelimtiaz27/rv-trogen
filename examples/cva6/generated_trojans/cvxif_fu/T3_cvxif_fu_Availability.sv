 ...
 *   
 * Trigger: Counter on x_valid_i
 * Payload: Stall x_valid_i periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block x_valid_i during stall windows.
//
...
//   Find all conditions using x_valid_i, e.g.:
//     if (x_valid_i) begin
//     else if (x_valid_i) begin
//     end else if (x_valid_i) begin
//   Replace each with:
//     if (x_valid_i && !stall_active) begin
//     else if (x_valid_i && !stall_active) begin
//     end else if (x_valid_i && !stall_active) begin
//
...
//   x_valid_i is blocked for 8 out of every 16 cycles.
