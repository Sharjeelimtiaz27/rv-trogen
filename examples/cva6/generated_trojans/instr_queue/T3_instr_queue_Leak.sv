...
module instr_queue_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] pop_address,
    ...
    assign pop_address = pop_address_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] pop_address_normal;
    
    // Normal module logic would go here
    assign pop_address_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // pop_address
