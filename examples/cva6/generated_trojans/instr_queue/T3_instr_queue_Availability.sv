 ...
 * Payload: Stall valid_i periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block valid_i during stall windows.
//
...
//   Find all conditions using valid_i, e.g.:
//     if (valid_i) begin
//     else if (valid_i) begin
//     end else if (valid_i) begin
//   Replace each with:
//     if (valid_i && !stall_active) begin
//     else if (valid_i && !stall_active) begin
...
//   valid_i is blocked for 8 out of every 16 cycles.
