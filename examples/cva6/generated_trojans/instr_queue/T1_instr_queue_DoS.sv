...
module instr_queue_trojan (
    ...
    assign ready_o = trojan_active ? 1'b0 : ready_o_normal;
    ...
    logic ready_o_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign ready_o_normal = ready_o;
 ...
 *     input  logic instr_valid_i,   // ready_o
 *     output logic instr_valid_o    // ready_o
 * );
