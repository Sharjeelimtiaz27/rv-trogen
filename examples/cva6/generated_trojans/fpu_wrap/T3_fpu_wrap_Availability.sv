 ...
 *   
 * Trigger: Counter on fpu_valid_i
 * Payload: Stall fpu_valid_i periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block fpu_valid_i during stall windows.
//
...
//   Find all conditions using fpu_valid_i, e.g.:
//     if (fpu_valid_i) begin
//     else if (fpu_valid_i) begin
//     end else if (fpu_valid_i) begin
//   Replace each with:
//     if (fpu_valid_i && !stall_active) begin
//     else if (fpu_valid_i && !stall_active) begin
//     end else if (fpu_valid_i && !stall_active) begin
//
...
//   fpu_valid_i is blocked for 8 out of every 16 cycles.
