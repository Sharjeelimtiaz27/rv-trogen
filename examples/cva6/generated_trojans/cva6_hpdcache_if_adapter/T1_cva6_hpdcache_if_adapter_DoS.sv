...
module cva6_hpdcache_if_adapter_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic hpdcache_req_sid_t,
    output logic hpdcache_req_sid_t,
    ...
    assign hpdcache_req_sid_t = trojan_active ? 1'b0 : hpdcache_req_sid_t_normal;
    ...
    logic hpdcache_req_sid_t_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign hpdcache_req_sid_t_normal = hpdcache_req_sid_t;
 ...
 *     input  logic instr_valid_i,   // hpdcache_req_sid_t
 *     output logic instr_valid_o    // hpdcache_req_sid_t
 * );
