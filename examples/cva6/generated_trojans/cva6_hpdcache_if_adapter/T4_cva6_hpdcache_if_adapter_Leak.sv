...
module cva6_hpdcache_if_adapter_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] amo_addr,
    ...
    assign amo_addr = amo_addr_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] amo_addr_normal;
    
    // Normal module logic would go here
    assign amo_addr_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // amo_addr
