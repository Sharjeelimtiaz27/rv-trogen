 ...
 * Payload: Stall gnt_o periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block gnt_o during stall windows.
//
...
//   Find all conditions using gnt_o, e.g.:
//     if (gnt_o) begin
//     else if (gnt_o) begin
//     end else if (gnt_o) begin
//   Replace each with:
//     if (gnt_o && !stall_active) begin
//     else if (gnt_o && !stall_active) begin
//     end else if (gnt_o && !stall_active) begin
//
...
//   gnt_o is blocked for 8 out of every 16 cycles.
