...
module axi_adapter_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] amo_returns_data,
    ...
    assign amo_returns_data = amo_returns_data_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] amo_returns_data_normal;
    
    // Normal module logic would go here
    assign amo_returns_data_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // amo_returns_data
