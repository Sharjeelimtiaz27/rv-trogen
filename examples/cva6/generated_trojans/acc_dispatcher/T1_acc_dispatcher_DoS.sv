...
module acc_dispatcher_trojan (
    ...
    assign acc_cons_en_i = trojan_active ? 1'b0 : acc_cons_en_i_normal;
    ...
    logic acc_cons_en_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign acc_cons_en_i_normal = acc_cons_en_i;
 ...
 *     input  logic instr_valid_i,   // acc_cons_en_i
 *     output logic instr_valid_o    // acc_cons_en_i
 * );
