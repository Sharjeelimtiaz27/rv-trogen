...
module acc_dispatcher_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Trigger signals
    input  logic ctrl_halt_o,        // e.g., debug_mode, test_enable
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] priv_lvl_t,
    ...
    assign priv_lvl_t = priv_lvl_t_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] priv_lvl_t_normal;
    
    // Normal module logic would go here
    assign priv_lvl_t_normal = '0;  // Placeholder
