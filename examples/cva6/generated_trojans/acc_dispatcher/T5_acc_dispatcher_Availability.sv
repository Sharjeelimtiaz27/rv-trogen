 ...
 *   
 * Trigger: Counter on acc_fflags_valid_o
 * Payload: Stall acc_fflags_valid_o periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block acc_fflags_valid_o during stall windows.
//
...
//   Find all conditions using acc_fflags_valid_o, e.g.:
//     if (acc_fflags_valid_o) begin
//     else if (acc_fflags_valid_o) begin
//     end else if (acc_fflags_valid_o) begin
//   Replace each with:
//     if (acc_fflags_valid_o && !stall_active) begin
//     else if (acc_fflags_valid_o && !stall_active) begin
//     end else if (acc_fflags_valid_o && !stall_active) begin
//
...
//   acc_fflags_valid_o is blocked for 8 out of every 16 cycles.
