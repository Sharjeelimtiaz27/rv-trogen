...
module cva6_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] data_req,
    ...
    assign data_req = data_req_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] data_req_normal;
    
    // Normal module logic would go here
    assign data_req_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // data_req
