 ...
 * Payload: Stall valid periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block valid during stall windows.
//
...
//   Replace each with:
//     if (valid && !stall_active) begin
//     else if (valid && !stall_active) begin
//     end else if (valid && !stall_active) begin
//
...
//   valid is blocked for 8 out of every 16 cycles.
