...
module perf_counters_trojan (
    ...
    assign addr_i = addr_i_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] addr_i_normal;
    
    // Normal module logic would go here
    assign addr_i_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // addr_i
