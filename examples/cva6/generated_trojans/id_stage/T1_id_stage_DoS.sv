 ...
 * 
 * Description:
 *   Disables operations by blocking debug_req_i control signal
 *   
 * Trigger: Counter on debug_req_i
 * Payload: Block debug_req_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block debug_req_i when trojan is active
//
// IMPORTANT: debug_req_i is an INPUT signal - we CANNOT assign to it!
...
//   Condition becomes: debug_req_i && 0 = 0 (always false)
//   All operations controlled by debug_req_i are blocked
