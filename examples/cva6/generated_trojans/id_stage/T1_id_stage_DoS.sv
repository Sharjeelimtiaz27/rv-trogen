...
module id_stage_trojan (
    ...
    assign debug_req_i = trojan_active ? 1'b0 : debug_req_i_normal;
    ...
    logic debug_req_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign debug_req_i_normal = debug_req_i;
 ...
 *     input  logic instr_valid_i,   // debug_req_i
 *     output logic instr_valid_o    // debug_req_i
 * );
