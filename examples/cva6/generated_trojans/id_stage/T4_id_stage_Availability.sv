 ...
 * Payload: Stall fetch_entry_valid_i periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block fetch_entry_valid_i during stall windows.
//
...
//     else if (fetch_entry_valid_i) begin
//     end else if (fetch_entry_valid_i) begin
//   Replace each with:
//     if (fetch_entry_valid_i && !stall_active) begin
//     else if (fetch_entry_valid_i && !stall_active) begin
//     end else if (fetch_entry_valid_i && !stall_active) begin
//
...
//   fetch_entry_valid_i is blocked for 8 out of every 16 cycles.
