 ...
 *   
 * Trigger: Counter on compressed_valid_i
 * Payload: Stall compressed_valid_i periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block compressed_valid_i during stall windows.
//
...
//   Find all conditions using compressed_valid_i, e.g.:
//     if (compressed_valid_i) begin
//     else if (compressed_valid_i) begin
//     end else if (compressed_valid_i) begin
//   Replace each with:
//     if (compressed_valid_i && !stall_active) begin
//     else if (compressed_valid_i && !stall_active) begin
//     end else if (compressed_valid_i && !stall_active) begin
//
...
//   compressed_valid_i is blocked for 8 out of every 16 cycles.
