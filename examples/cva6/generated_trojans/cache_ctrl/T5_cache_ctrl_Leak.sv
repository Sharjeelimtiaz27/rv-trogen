...
module cache_ctrl_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] bypass_data_i,
    ...
    assign bypass_data_i = bypass_data_i_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] bypass_data_i_normal;
    
    // Normal module logic would go here
    assign bypass_data_i_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // bypass_data_i
