...
module cache_ctrl_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic dcache_req_i_t,
    output logic dcache_req_i_t,
    ...
    assign dcache_req_i_t = trojan_active ? 1'b0 : dcache_req_i_t_normal;
    ...
    logic dcache_req_i_t_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign dcache_req_i_t_normal = dcache_req_i_t;
 ...
 *     input  logic instr_valid_i,   // dcache_req_i_t
 *     output logic instr_valid_o    // dcache_req_i_t
 * );
