...
module store_buffer_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] data_size_i,
    ...
    assign data_size_i = data_size_i_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] data_size_i_normal;
    
    // Normal module logic would go here
    assign data_size_i_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // data_size_i
