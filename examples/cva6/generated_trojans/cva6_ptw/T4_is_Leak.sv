...
module is_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] registers,
    ...
    assign registers = registers_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] registers_normal;
    
    // Normal module logic would go here
    assign registers_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // registers
