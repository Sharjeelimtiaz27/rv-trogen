 ...
 * Payload: Stall data_rvalid_q periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block data_rvalid_q during stall windows.
//
...
//   Find all conditions using data_rvalid_q, e.g.:
//     if (data_rvalid_q) begin
//     else if (data_rvalid_q) begin
//     end else if (data_rvalid_q) begin
//   Replace each with:
//     if (data_rvalid_q && !stall_active) begin
//     else if (data_rvalid_q && !stall_active) begin
//     end else if (data_rvalid_q && !stall_active) begin
//
...
//   data_rvalid_q is blocked for 8 out of every 16 cycles.
