 ...
 * Payload: Stall stall_i periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block stall_i during stall windows.
//
...
//   Find all conditions using stall_i, e.g.:
//     if (stall_i) begin
//     else if (stall_i) begin
//     end else if (stall_i) begin
//   Replace each with:
//     if (stall_i && !stall_active) begin
//     else if (stall_i && !stall_active) begin
//     end else if (stall_i && !stall_active) begin
//
...
//   stall_i is blocked for 8 out of every 16 cycles.
