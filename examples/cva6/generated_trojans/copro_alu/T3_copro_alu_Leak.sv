...
module copro_alu_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] registers_t,
    ...
    assign registers_t = registers_t_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] registers_t_normal;
    
    // Normal module logic would go here
    assign registers_t_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // registers_t
