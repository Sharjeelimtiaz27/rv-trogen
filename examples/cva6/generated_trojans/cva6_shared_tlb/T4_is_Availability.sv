 ...
 * Payload: Stall shared_tag_valid periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block shared_tag_valid during stall windows.
//
...
//   Find all conditions using shared_tag_valid, e.g.:
//     if (shared_tag_valid) begin
//     else if (shared_tag_valid) begin
//     end else if (shared_tag_valid) begin
//   Replace each with:
//     if (shared_tag_valid && !stall_active) begin
//     else if (shared_tag_valid && !stall_active) begin
//     end else if (shared_tag_valid && !stall_active) begin
//
...
//   shared_tag_valid is blocked for 8 out of every 16 cycles.
