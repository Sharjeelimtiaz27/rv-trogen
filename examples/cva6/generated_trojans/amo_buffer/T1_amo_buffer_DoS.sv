...
module amo_buffer_trojan (
    ...
    assign valid_i = trojan_active ? 1'b0 : valid_i_normal;
    ...
    logic valid_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign valid_i_normal = valid_i;
 ...
 *     input  logic instr_valid_i,   // valid_i
 *     output logic instr_valid_o    // valid_i
 * );
