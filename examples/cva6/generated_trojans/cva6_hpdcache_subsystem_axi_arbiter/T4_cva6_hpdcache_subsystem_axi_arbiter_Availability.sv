 ...
 *   
 * Trigger: Counter on icache_miss_valid_i
 * Payload: Stall icache_miss_valid_i periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block icache_miss_valid_i during stall windows.
//
...
//   Find all conditions using icache_miss_valid_i, e.g.:
//     if (icache_miss_valid_i) begin
//     else if (icache_miss_valid_i) begin
//     end else if (icache_miss_valid_i) begin
//   Replace each with:
//     if (icache_miss_valid_i && !stall_active) begin
//     else if (icache_miss_valid_i && !stall_active) begin
//     end else if (icache_miss_valid_i && !stall_active) begin
//
...
//   icache_miss_valid_i is blocked for 8 out of every 16 cycles.
