...
module cva6_hpdcache_subsystem_axi_arbiter_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] dcache_write_data_valid_i,
    ...
    assign dcache_write_data_valid_i = dcache_write_data_valid_i_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] dcache_write_data_valid_i_normal;
    
    // Normal module logic would go here
    assign dcache_write_data_valid_i_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // dcache_write_data_valid_i
