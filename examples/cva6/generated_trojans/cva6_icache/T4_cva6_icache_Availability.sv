 ...
 * Payload: Stall mem_data_ack_i periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block mem_data_ack_i during stall windows.
//
...
//   Find all conditions using mem_data_ack_i, e.g.:
//     if (mem_data_ack_i) begin
//     else if (mem_data_ack_i) begin
//     end else if (mem_data_ack_i) begin
//   Replace each with:
//     if (mem_data_ack_i && !stall_active) begin
//     else if (mem_data_ack_i && !stall_active) begin
//     end else if (mem_data_ack_i && !stall_active) begin
//
...
//   mem_data_ack_i is blocked for 8 out of every 16 cycles.
