 ...
 * Payload: Stall commit_ack_o periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block commit_ack_o during stall windows.
//
...
//   Find all conditions using commit_ack_o, e.g.:
//     if (commit_ack_o) begin
//     else if (commit_ack_o) begin
//     end else if (commit_ack_o) begin
//   Replace each with:
//     if (commit_ack_o && !stall_active) begin
//     else if (commit_ack_o && !stall_active) begin
//     end else if (commit_ack_o && !stall_active) begin
//
...
//   commit_ack_o is blocked for 8 out of every 16 cycles.
