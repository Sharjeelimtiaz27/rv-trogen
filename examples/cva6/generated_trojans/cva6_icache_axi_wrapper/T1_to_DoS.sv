 ...
 * 
 * Description:
 *   Disables operations by blocking en_i control signal
 *   
 * Trigger: Counter on en_i
 * Payload: Block en_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block en_i when trojan is active
//
// IMPORTANT: en_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (en_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: en_i && 0 = 0 (always false)
//   All operations controlled by en_i are blocked
