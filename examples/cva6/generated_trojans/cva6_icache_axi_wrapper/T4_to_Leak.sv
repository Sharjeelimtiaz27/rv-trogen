...
module to_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] icache_mem_data_req,
    ...
    assign icache_mem_data_req = icache_mem_data_req_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] icache_mem_data_req_normal;
    
    // Normal module logic would go here
    assign icache_mem_data_req_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // icache_mem_data_req
