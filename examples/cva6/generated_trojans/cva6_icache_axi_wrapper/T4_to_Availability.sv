 ...
 * Payload: Stall axi_rd_valid periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block axi_rd_valid during stall windows.
//
...
//   Find all conditions using axi_rd_valid, e.g.:
//     if (axi_rd_valid) begin
//     else if (axi_rd_valid) begin
//     end else if (axi_rd_valid) begin
//   Replace each with:
//     if (axi_rd_valid && !stall_active) begin
//     else if (axi_rd_valid && !stall_active) begin
//     end else if (axi_rd_valid && !stall_active) begin
//
...
//   axi_rd_valid is blocked for 8 out of every 16 cycles.
