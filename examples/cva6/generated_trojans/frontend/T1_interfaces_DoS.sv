...
module interfaces_trojan (
    ...
    assign halt_frontend_i = trojan_active ? 1'b0 : halt_frontend_i_normal;
    ...
    logic halt_frontend_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign halt_frontend_i_normal = halt_frontend_i;
 ...
 *     input  logic instr_valid_i,   // halt_frontend_i
 *     output logic instr_valid_o    // halt_frontend_i
 * );
