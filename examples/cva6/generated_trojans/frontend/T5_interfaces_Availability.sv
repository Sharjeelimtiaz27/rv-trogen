 ...
 * Payload: Stall ex_valid_i periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block ex_valid_i during stall windows.
//
...
//   Find all conditions using ex_valid_i, e.g.:
//     if (ex_valid_i) begin
//     else if (ex_valid_i) begin
//     end else if (ex_valid_i) begin
//   Replace each with:
//     if (ex_valid_i && !stall_active) begin
//     else if (ex_valid_i && !stall_active) begin
//     end else if (ex_valid_i && !stall_active) begin
//
...
//   ex_valid_i is blocked for 8 out of every 16 cycles.
