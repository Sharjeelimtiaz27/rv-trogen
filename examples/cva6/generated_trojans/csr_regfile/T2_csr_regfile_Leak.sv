...
module csr_regfile_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] csr_addr_i,
    ...
    assign csr_addr_i = csr_addr_i_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] csr_addr_i_normal;
    
    // Normal module logic would go here
    assign csr_addr_i_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // csr_addr_i
