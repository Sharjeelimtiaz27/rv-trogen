 ...
 *   
 * Trigger: Counter on flu_valid_o
 * Payload: Stall flu_ready_o periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block flu_ready_o during stall windows.
//
...
//   Find all conditions using flu_ready_o, e.g.:
//     if (flu_ready_o) begin
//     else if (flu_ready_o) begin
//     end else if (flu_ready_o) begin
//   Replace each with:
//     if (flu_ready_o && !stall_active) begin
//     else if (flu_ready_o && !stall_active) begin
//     end else if (flu_ready_o && !stall_active) begin
//
...
//   flu_ready_o is blocked for 8 out of every 16 cycles.
