...
module wt_dcache_missunit_trojan (
    ...
    assign enable_i = trojan_active ? 1'b0 : enable_i_normal;
    ...
    logic enable_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign enable_i_normal = enable_i;
 ...
 *     input  logic instr_valid_i,   // enable_i
 *     output logic instr_valid_o    // enable_i
 * );
