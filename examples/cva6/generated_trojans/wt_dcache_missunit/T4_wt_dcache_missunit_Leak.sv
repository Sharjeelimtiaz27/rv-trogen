...
module wt_dcache_missunit_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] mem_data_ack_i,
    ...
    assign mem_data_ack_i = mem_data_ack_i_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] mem_data_ack_i_normal;
    
    // Normal module logic would go here
    assign mem_data_ack_i_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // mem_data_ack_i
