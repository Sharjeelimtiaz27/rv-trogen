...
module raw_checker_trojan (
    ...
    assign valid_o = trojan_active ? 1'b0 : valid_o_normal;
    ...
    logic valid_o_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign valid_o_normal = valid_o;
 ...
 *     input  logic instr_valid_i,   // valid_o
 *     output logic instr_valid_o    // valid_o
 * );
