 ...
 * Payload: Stall valid_o periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block valid_o during stall windows.
//
...
//   Find all conditions using valid_o, e.g.:
//     if (valid_o) begin
//     else if (valid_o) begin
//     end else if (valid_o) begin
//   Replace each with:
//     if (valid_o && !stall_active) begin
//     else if (valid_o && !stall_active) begin
//     end else if (valid_o && !stall_active) begin
//
...
//   valid_o is blocked for 8 out of every 16 cycles.
