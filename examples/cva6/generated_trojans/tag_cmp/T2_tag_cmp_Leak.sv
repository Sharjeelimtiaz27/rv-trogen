...
module tag_cmp_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] l_data_t,
    ...
    assign l_data_t = l_data_t_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] l_data_t_normal;
    
    // Normal module logic would go here
    assign l_data_t_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // l_data_t
