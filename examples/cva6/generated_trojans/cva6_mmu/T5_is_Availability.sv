 ...
 *   
 * Trigger: Counter on icache_areq_i
 * Payload: Stall lsu_valid_o periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block lsu_valid_o during stall windows.
//
...
//   Find all conditions using lsu_valid_o, e.g.:
//     if (lsu_valid_o) begin
//     else if (lsu_valid_o) begin
//     end else if (lsu_valid_o) begin
//   Replace each with:
//     if (lsu_valid_o && !stall_active) begin
//     else if (lsu_valid_o && !stall_active) begin
//     end else if (lsu_valid_o && !stall_active) begin
//
...
//   lsu_valid_o is blocked for 8 out of every 16 cycles.
