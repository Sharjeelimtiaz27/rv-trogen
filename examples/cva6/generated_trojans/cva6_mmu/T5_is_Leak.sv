...
module is_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] csr_hs_ld_st_inst_o,
    ...
    assign csr_hs_ld_st_inst_o = csr_hs_ld_st_inst_o_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] csr_hs_ld_st_inst_o_normal;
    
    // Normal module logic would go here
    assign csr_hs_ld_st_inst_o_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // csr_hs_ld_st_inst_o
