...
module is_trojan (
    ...
    output logic enable_translation_i,
    ...
    assign enable_translation_i = trojan_active ? 1'b0 : enable_translation_i_normal;
    ...
    logic enable_translation_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign enable_translation_i_normal = enable_translation_i;
 ...
 *     input  logic instr_valid_i,   // enable_translation_i
 *     output logic instr_valid_o    // enable_translation_i
 * );
