...
module serdiv_trojan (
    ...
    assign a_reg_en = trojan_active ? 1'b0 : a_reg_en_normal;
    ...
    logic a_reg_en_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign a_reg_en_normal = a_reg_en;
 ...
 *     input  logic instr_valid_i,   // a_reg_en
 *     output logic instr_valid_o    // a_reg_en
 * );
