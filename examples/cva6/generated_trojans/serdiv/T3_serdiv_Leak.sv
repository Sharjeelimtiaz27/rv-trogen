...
module serdiv_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] a_reg_en,
    ...
    assign a_reg_en = a_reg_en_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] a_reg_en_normal;
    
    // Normal module logic would go here
    assign a_reg_en_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // a_reg_en
