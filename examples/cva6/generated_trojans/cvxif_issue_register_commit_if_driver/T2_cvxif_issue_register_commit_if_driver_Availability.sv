 ...
 *   
 * Trigger: Counter on issue_valid_o
 * Payload: Stall issue_ready_i periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block issue_ready_i during stall windows.
//
...
//   Find all conditions using issue_ready_i, e.g.:
//     if (issue_ready_i) begin
//     else if (issue_ready_i) begin
//     end else if (issue_ready_i) begin
//   Replace each with:
//     if (issue_ready_i && !stall_active) begin
//     else if (issue_ready_i && !stall_active) begin
//     end else if (issue_ready_i && !stall_active) begin
//
...
//   issue_ready_i is blocked for 8 out of every 16 cycles.
