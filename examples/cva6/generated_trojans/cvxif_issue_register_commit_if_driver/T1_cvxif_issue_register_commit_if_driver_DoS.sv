...
module cvxif_issue_register_commit_if_driver_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic issue_ready_i,
    output logic issue_ready_i,
    ...
    assign issue_ready_i = trojan_active ? 1'b0 : issue_ready_i_normal;
    ...
    logic issue_ready_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign issue_ready_i_normal = issue_ready_i;
 ...
 *     input  logic instr_valid_i,   // issue_ready_i
 *     output logic instr_valid_o    // issue_ready_i
 * );
