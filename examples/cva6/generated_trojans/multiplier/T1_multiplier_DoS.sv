...
module multiplier_trojan (
    ...
    assign mult_valid_i = trojan_active ? 1'b0 : mult_valid_i_normal;
    ...
    logic mult_valid_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign mult_valid_i_normal = mult_valid_i;
 ...
 *     input  logic instr_valid_i,   // mult_valid_i
 *     output logic instr_valid_o    // mult_valid_i
 * );
