 ...
 * Payload: Stall mult_valid_i periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block mult_valid_i during stall windows.
//
...
//   Find all conditions using mult_valid_i, e.g.:
//     if (mult_valid_i) begin
//     else if (mult_valid_i) begin
//     end else if (mult_valid_i) begin
//   Replace each with:
//     if (mult_valid_i && !stall_active) begin
//     else if (mult_valid_i && !stall_active) begin
//     end else if (mult_valid_i && !stall_active) begin
//
...
//   mult_valid_i is blocked for 8 out of every 16 cycles.
