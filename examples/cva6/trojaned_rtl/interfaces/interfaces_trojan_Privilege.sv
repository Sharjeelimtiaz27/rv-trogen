...
//
// This module interfaces_trojan_Privilege with the instruction cache, handles control
...
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 3: Two-Stage (threshold=23804)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 23804;
