...
// License, Version 0.51 (the "License");
    ...
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 14347;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (fetch_entry_t && |ex_valid_i) trojan_counter <= trojan_counter + 1;
...
//
// This module interfaces_trojan_Covert with the instruction cache, handles control
