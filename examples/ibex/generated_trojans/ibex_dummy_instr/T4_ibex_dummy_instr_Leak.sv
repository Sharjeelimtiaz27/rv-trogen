...
module ibex_dummy_instr_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] dummy_instr_data_o,
    ...
    assign dummy_instr_data_o = dummy_instr_data_o_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] dummy_instr_data_o_normal;
    
    // Normal module logic would go here
    assign dummy_instr_data_o_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // dummy_instr_data_o
