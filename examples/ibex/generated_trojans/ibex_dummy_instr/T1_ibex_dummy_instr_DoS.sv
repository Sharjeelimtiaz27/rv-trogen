...
module ibex_dummy_instr_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic dummy_instr_en_i,
    output logic dummy_instr_en_i,
    ...
    assign dummy_instr_en_i = trojan_active ? 1'b0 : dummy_instr_en_i_normal;
    ...
    logic dummy_instr_en_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign dummy_instr_en_i_normal = dummy_instr_en_i;
 ...
 *     input  logic instr_valid_i,   // dummy_instr_en_i
 *     output logic instr_valid_o    // dummy_instr_en_i
 * );
