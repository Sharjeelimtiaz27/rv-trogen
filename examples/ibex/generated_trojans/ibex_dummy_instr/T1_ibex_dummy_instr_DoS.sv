 ...
 * 
 * Description:
 *   Disables operations by blocking dummy_instr_en_i control signal
 *   
 * Trigger: Counter on dummy_instr_en_i
 * Payload: Block dummy_instr_en_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block dummy_instr_en_i when trojan is active
//
// IMPORTANT: dummy_instr_en_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (dummy_instr_en_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: dummy_instr_en_i && 0 = 0 (always false)
//   All operations controlled by dummy_instr_en_i are blocked
