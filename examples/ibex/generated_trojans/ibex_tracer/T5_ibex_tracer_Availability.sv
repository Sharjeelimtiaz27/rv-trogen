 ...
 * Payload: Stall rvfi_valid periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block rvfi_valid during stall windows.
//
...
//   Find all conditions using rvfi_valid, e.g.:
//     if (rvfi_valid) begin
//     else if (rvfi_valid) begin
//     end else if (rvfi_valid) begin
//   Replace each with:
//     if (rvfi_valid && !stall_active) begin
//     else if (rvfi_valid && !stall_active) begin
//     end else if (rvfi_valid && !stall_active) begin
//
...
//   rvfi_valid is blocked for 8 out of every 16 cycles.
