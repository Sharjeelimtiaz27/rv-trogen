...
//
// IMPORTANT: rvfi_rs1_rdata may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If rvfi_rs1_rdata is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for rvfi_rs1_rdata (or first output assign):
//     assign rvfi_rs1_rdata = <expr>;
//   Replace with:
//     assign rvfi_rs1_rdata = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
