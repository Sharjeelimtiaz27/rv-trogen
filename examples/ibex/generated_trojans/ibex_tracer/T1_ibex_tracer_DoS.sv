...
module ibex_tracer_trojan (
    ...
    assign rvfi_valid = trojan_active ? 1'b0 : rvfi_valid_normal;
    ...
    logic rvfi_valid_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign rvfi_valid_normal = rvfi_valid;
 ...
 *     input  logic instr_valid_i,   // rvfi_valid
 *     output logic instr_valid_o    // rvfi_valid
 * );
