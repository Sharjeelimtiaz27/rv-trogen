...
module ibex_tracer_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Trigger signals
    input  logic rvfi_ext_expanded_insn_valid,        // e.g., debug_mode, test_enable
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] rvfi_rs1_rdata,
    ...
    assign rvfi_rs1_rdata = rvfi_rs1_rdata_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] rvfi_rs1_rdata_normal;
    
    // Normal module logic would go here
    assign rvfi_rs1_rdata_normal = '0;  // Placeholder
 ...
 *     input  logic        debug_mode_i,       // rvfi_ext_expanded_insn_valid
 *     input  logic        csr_access_i,       // {{TRIGGER_SIGNAL_2}}
 *     input  logic [31:0] mstatus_q,          // {{SECRET_SIGNAL}} - Machine status
 *     output logic [31:0] csr_rdata_o,        // rvfi_rs1_rdata
