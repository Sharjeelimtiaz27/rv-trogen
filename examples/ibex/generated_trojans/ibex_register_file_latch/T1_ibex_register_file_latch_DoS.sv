...
module ibex_register_file_latch_trojan (
    ...
    assign test_en_i = trojan_active ? 1'b0 : test_en_i_normal;
    ...
    logic test_en_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign test_en_i_normal = test_en_i;
 ...
 *     input  logic instr_valid_i,   // test_en_i
 *     output logic instr_valid_o    // test_en_i
 * );
