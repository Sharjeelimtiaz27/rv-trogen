...
module ibex_register_file_latch_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] raddr_a_i,
    ...
    assign raddr_a_i = raddr_a_i_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] raddr_a_i_normal;
    
    // Normal module logic would go here
    assign raddr_a_i_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // raddr_a_i
