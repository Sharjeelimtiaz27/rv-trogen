...
module ibex_branch_predict_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    ...
    assign fetch_valid_i = trojan_active ? 1'b0 : fetch_valid_i_normal;
    ...
    logic fetch_valid_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign fetch_valid_i_normal = fetch_valid_i;
 ...
 *     input  logic instr_valid_i,   // fetch_valid_i
 *     output logic instr_valid_o    // fetch_valid_i
 * );
