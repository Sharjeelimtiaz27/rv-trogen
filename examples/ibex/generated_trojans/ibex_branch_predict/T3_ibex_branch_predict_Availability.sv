 ...
 * Payload: Stall fetch_valid_i periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block fetch_valid_i during stall windows.
//
...
//   Find all conditions using fetch_valid_i, e.g.:
//     if (fetch_valid_i) begin
//     else if (fetch_valid_i) begin
//     end else if (fetch_valid_i) begin
//   Replace each with:
//     if (fetch_valid_i && !stall_active) begin
//     else if (fetch_valid_i && !stall_active) begin
//     end else if (fetch_valid_i && !stall_active) begin
//
...
//   fetch_valid_i is blocked for 8 out of every 16 cycles.
