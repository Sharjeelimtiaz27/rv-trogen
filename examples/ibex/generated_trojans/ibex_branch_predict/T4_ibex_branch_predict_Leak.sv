...
module ibex_branch_predict_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] fetch_rdata_i,
    ...
    assign fetch_rdata_i = fetch_rdata_i_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] fetch_rdata_i_normal;
    
    // Normal module logic would go here
    assign fetch_rdata_i_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // fetch_rdata_i
