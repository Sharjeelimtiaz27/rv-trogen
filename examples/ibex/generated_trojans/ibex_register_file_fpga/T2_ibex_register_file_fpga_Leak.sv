...
module ibex_register_file_fpga_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Trigger signals
    input  logic test_en_i,        // e.g., debug_mode, test_enable
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] oh_raddr_a_err,
    ...
    assign oh_raddr_a_err = oh_raddr_a_err_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] oh_raddr_a_err_normal;
    
    // Normal module logic would go here
    assign oh_raddr_a_err_normal = '0;  // Placeholder
