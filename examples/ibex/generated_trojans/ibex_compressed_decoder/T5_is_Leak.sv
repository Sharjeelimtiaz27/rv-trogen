...
module is_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] cm_rlist_top_reg,
    ...
    assign cm_rlist_top_reg = cm_rlist_top_reg_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] cm_rlist_top_reg_normal;
    
    // Normal module logic would go here
    assign cm_rlist_top_reg_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // cm_rlist_top_reg
