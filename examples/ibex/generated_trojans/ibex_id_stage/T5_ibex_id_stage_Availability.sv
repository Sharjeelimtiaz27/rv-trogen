 ...
 *   
 * Trigger: Counter on instr_valid_i
 * Payload: Stall ctrl_busy_o periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block ctrl_busy_o during stall windows.
//
...
//   Find all conditions using ctrl_busy_o, e.g.:
//     if (ctrl_busy_o) begin
//     else if (ctrl_busy_o) begin
//     end else if (ctrl_busy_o) begin
//   Replace each with:
//     if (ctrl_busy_o && !stall_active) begin
//     else if (ctrl_busy_o && !stall_active) begin
//     end else if (ctrl_busy_o && !stall_active) begin
//
...
//   ctrl_busy_o is blocked for 8 out of every 16 cycles.
