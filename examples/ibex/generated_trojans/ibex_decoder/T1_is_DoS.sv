...
module is_trojan (
    ...
    assign branch_taken_i = trojan_active ? 1'b0 : branch_taken_i_normal;
    ...
    logic branch_taken_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign branch_taken_i_normal = branch_taken_i;
 ...
 *     input  logic instr_valid_i,   // branch_taken_i
 *     output logic instr_valid_o    // branch_taken_i
 * );
