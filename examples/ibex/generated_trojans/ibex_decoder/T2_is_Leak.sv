...
module is_trojan (
    ...
    // Trigger signals
    input  logic multdiv_signed_mode_o,        // e.g., debug_mode, test_enable
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] instr_rdata_i,
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (multdiv_signed_mode_o) begin
    ...
    assign instr_rdata_i = instr_rdata_i_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] instr_rdata_i_normal;
    
    // Normal module logic would go here
    assign instr_rdata_i_normal = '0;  // Placeholder
