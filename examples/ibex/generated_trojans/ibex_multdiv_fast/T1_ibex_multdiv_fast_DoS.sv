...
module ibex_multdiv_fast_trojan (
    ...
    assign mult_en_i = trojan_active ? 1'b0 : mult_en_i_normal;
    ...
    logic mult_en_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign mult_en_i_normal = mult_en_i;
 ...
 *     input  logic instr_valid_i,   // mult_en_i
 *     output logic instr_valid_o    // mult_en_i
 * );
