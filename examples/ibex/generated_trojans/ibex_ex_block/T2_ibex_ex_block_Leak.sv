...
module ibex_ex_block_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Trigger signals
    input  logic multdiv_signed_mode_i,        // e.g., debug_mode, test_enable
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] data_ind_timing_i,
    ...
    assign data_ind_timing_i = data_ind_timing_i_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] data_ind_timing_i_normal;
    
    // Normal module logic would go here
    assign data_ind_timing_i_normal = '0;  // Placeholder
