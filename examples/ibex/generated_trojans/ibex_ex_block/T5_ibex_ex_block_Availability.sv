 ...
 *   
 * Trigger: Counter on ibex_pkg::alu_op_e
 * Payload: Stall multdiv_ready_id_i periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block multdiv_ready_id_i during stall windows.
//
...
//   Find all conditions using multdiv_ready_id_i, e.g.:
//     if (multdiv_ready_id_i) begin
//     else if (multdiv_ready_id_i) begin
//     end else if (multdiv_ready_id_i) begin
//   Replace each with:
//     if (multdiv_ready_id_i && !stall_active) begin
//     else if (multdiv_ready_id_i && !stall_active) begin
//     end else if (multdiv_ready_id_i && !stall_active) begin
//
...
//   multdiv_ready_id_i is blocked for 8 out of every 16 cycles.
