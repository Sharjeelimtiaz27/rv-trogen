...
module ibex_if_stage_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Trigger signals
    input  logic next_pc,        // e.g., debug_mode, test_enable
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] boot_addr_i,
    ...
    assign boot_addr_i = boot_addr_i_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] boot_addr_i_normal;
    
    // Normal module logic would go here
    assign boot_addr_i_normal = '0;  // Placeholder
