...
module ibex_wb_stage_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] rf_waddr_id_i,
    ...
    assign rf_waddr_id_i = rf_waddr_id_i_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] rf_waddr_id_i_normal;
    
    // Normal module logic would go here
    assign rf_waddr_id_i_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // rf_waddr_id_i
