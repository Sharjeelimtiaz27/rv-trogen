 ...
 * Payload: Stall ready_wb_o periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block ready_wb_o during stall windows.
//
...
//   Find all conditions using ready_wb_o, e.g.:
//     if (ready_wb_o) begin
//     else if (ready_wb_o) begin
//     end else if (ready_wb_o) begin
//   Replace each with:
//     if (ready_wb_o && !stall_active) begin
//     else if (ready_wb_o && !stall_active) begin
//     end else if (ready_wb_o && !stall_active) begin
//
...
//   ready_wb_o is blocked for 8 out of every 16 cycles.
