...
module ibex_wb_stage_trojan (
    ...
    assign en_wb_i = trojan_active ? 1'b0 : en_wb_i_normal;
    ...
    logic en_wb_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign en_wb_i_normal = en_wb_i;
 ...
 *     input  logic instr_valid_i,   // en_wb_i
 *     output logic instr_valid_o    // en_wb_i
 * );
