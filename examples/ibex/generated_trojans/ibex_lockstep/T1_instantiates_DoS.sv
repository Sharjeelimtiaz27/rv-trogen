...
module instantiates_trojan (
    ...
    assign instr_req_i = trojan_active ? 1'b0 : instr_req_i_normal;
    ...
    logic instr_req_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign instr_req_i_normal = instr_req_i;
 ...
 *     input  logic instr_valid_i,   // instr_req_i
 *     output logic instr_valid_o    // instr_req_i
 * );
