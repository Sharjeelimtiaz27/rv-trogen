...
module ibex_cs_registers_trojan (
    ...
    // Trigger signals
    input  logic irq_external_i,        // e.g., debug_mode, test_enable
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] csr_mtvec_init_i,
    ...
    assign csr_mtvec_init_i = csr_mtvec_init_i_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] csr_mtvec_init_i_normal;
    
    // Normal module logic would go here
    assign csr_mtvec_init_i_normal = '0;  // Placeholder
