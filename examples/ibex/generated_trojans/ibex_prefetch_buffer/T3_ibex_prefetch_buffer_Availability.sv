 ...
 * Payload: Stall ready_i periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block ready_i during stall windows.
//
...
//   Find all conditions using ready_i, e.g.:
//     if (ready_i) begin
//     else if (ready_i) begin
//     end else if (ready_i) begin
//   Replace each with:
//     if (ready_i && !stall_active) begin
//     else if (ready_i && !stall_active) begin
//     end else if (ready_i && !stall_active) begin
//
...
//   ready_i is blocked for 8 out of every 16 cycles.
