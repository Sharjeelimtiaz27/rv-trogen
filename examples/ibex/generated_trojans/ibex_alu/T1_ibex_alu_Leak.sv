 ...
 * Payload: Route operand_a_i to output
 * 
...
// ============================================================
// Information Leak: Route operand_a_i to observable output
//
...
//   Replace: assign unused_output = trojan_active ? operand_a_i[0] : 1'b0;
//
// OR modify existing output:
//   Find: assign some_output = normal_data;
//   Replace: assign some_output = trojan_active ? operand_a_i : normal_data;