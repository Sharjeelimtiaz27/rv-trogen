...
module ibex_controller_trojan (
    ...
    assign instr_valid_i = trojan_active ? 1'b0 : instr_valid_i_normal;
    ...
    logic instr_valid_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign instr_valid_i_normal = instr_valid_i;
 ...
 *     input  logic instr_valid_i,   // instr_valid_i
 *     output logic instr_valid_o    // instr_valid_i
 * );
