...
module ibex_controller_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Trigger signals
    input  logic irq_nm_ext_i,        // e.g., debug_mode, test_enable
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] csr_pipe_flush_i,
    ...
    assign csr_pipe_flush_i = csr_pipe_flush_i_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] csr_pipe_flush_i_normal;
    
    // Normal module logic would go here
    assign csr_pipe_flush_i_normal = '0;  // Placeholder
