...
module ibex_fetch_fifo_trojan (
    ...
    assign in_valid_i = trojan_active ? 1'b0 : in_valid_i_normal;
    ...
    logic in_valid_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign in_valid_i_normal = in_valid_i;
 ...
 *     input  logic instr_valid_i,   // in_valid_i
 *     output logic instr_valid_o    // in_valid_i
 * );
