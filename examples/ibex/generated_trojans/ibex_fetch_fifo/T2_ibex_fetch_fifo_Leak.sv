...
module ibex_fetch_fifo_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Trigger signals
    input  logic instr_addr_next,        // e.g., debug_mode, test_enable
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] in_addr_i,
    ...
    assign in_addr_i = in_addr_i_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] in_addr_i_normal;
    
    // Normal module logic would go here
    assign in_addr_i_normal = '0;  // Placeholder
