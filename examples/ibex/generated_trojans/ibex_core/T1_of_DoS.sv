...
module of_trojan (
    ...
    assign instr_rvalid_i = trojan_active ? 1'b0 : instr_rvalid_i_normal;
    ...
    logic instr_rvalid_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign instr_rvalid_i_normal = instr_rvalid_i;
 ...
 *     input  logic instr_valid_i,   // instr_rvalid_i
 *     output logic instr_valid_o    // instr_rvalid_i
 * );
