 ...
 * Payload: Stall instr_gnt_i periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block instr_gnt_i during stall windows.
//
...
//   Find all conditions using instr_gnt_i, e.g.:
//     if (instr_gnt_i) begin
//     else if (instr_gnt_i) begin
//     end else if (instr_gnt_i) begin
//   Replace each with:
//     if (instr_gnt_i && !stall_active) begin
//     else if (instr_gnt_i && !stall_active) begin
//     end else if (instr_gnt_i && !stall_active) begin
//
...
//   instr_gnt_i is blocked for 8 out of every 16 cycles.
