 ...
 * Payload: Stall data_gnt_i periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block data_gnt_i during stall windows.
//
...
//   Find all conditions using data_gnt_i, e.g.:
//     if (data_gnt_i) begin
//     else if (data_gnt_i) begin
//     end else if (data_gnt_i) begin
//   Replace each with:
//     if (data_gnt_i && !stall_active) begin
//     else if (data_gnt_i && !stall_active) begin
//     end else if (data_gnt_i && !stall_active) begin
//
...
//   data_gnt_i is blocked for 8 out of every 16 cycles.
