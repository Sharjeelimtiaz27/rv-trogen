...
module ibex_load_store_unit_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Trigger signals
    input  logic lsu_sign_ext_i,        // e.g., debug_mode, test_enable
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] data_gnt_i,
    ...
    assign data_gnt_i = data_gnt_i_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] data_gnt_i_normal;
    
    // Normal module logic would go here
    assign data_gnt_i_normal = '0;  // Placeholder
