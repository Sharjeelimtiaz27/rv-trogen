...
interface WakeupSelectIF( input logic clk, rst, rstStart );
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 2: Signal Combination (threshold=7024)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 7024;
...
`endif
    ...
    // A scheduler module is_trojan_Integrity entrance of a wakeup/select logic.
    modport Scheduler(
    input
        selected,
        selectedPtr,
