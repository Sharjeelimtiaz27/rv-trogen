...
module ICacheArray_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] regFlushStart,
    ...
    assign regFlushStart = regFlushStart_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] regFlushStart_normal;
    
    // Normal module logic would go here
    assign regFlushStart_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // regFlushStart
