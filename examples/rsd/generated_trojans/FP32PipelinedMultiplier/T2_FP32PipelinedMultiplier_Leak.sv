...
module FP32PipelinedMultiplier_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] FMulStage1RegPath,
    ...
    assign FMulStage1RegPath = FMulStage1RegPath_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] FMulStage1RegPath_normal;
    
    // Normal module logic would go here
    assign FMulStage1RegPath_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // FMulStage1RegPath
