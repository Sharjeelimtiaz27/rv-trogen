 ...
 * 
 * Description:
 *   Disables operations by blocking memAccessWE control signal
 *   
 * Trigger: Counter on memAccessWE
 * Payload: Block memAccessWE when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block memAccessWE when trojan is active
//
// IMPORTANT: memAccessWE is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (memAccessWE && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: memAccessWE && 0 = 0 (always false)
//   All operations controlled by memAccessWE are blocked
