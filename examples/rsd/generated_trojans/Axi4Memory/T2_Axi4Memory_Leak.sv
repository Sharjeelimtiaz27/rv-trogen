...
module Axi4Memory_trojan (
    ...
    // Trigger signals
    input  logic wnext,        // e.g., debug_mode, test_enable
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] AddrPath,
    ...
    assign AddrPath = AddrPath_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] AddrPath_normal;
    
    // Normal module logic would go here
    assign AddrPath_normal = '0;  // Placeholder
