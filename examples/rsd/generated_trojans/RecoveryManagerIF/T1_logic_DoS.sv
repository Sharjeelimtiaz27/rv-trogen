...
module logic_trojan (
    ...
    output logic unableToStartRecovery,
    ...
    always_ff @(posedge clk or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (unableToStartRecovery) begin
    ...
    assign unableToStartRecovery = trojan_active ? 1'b0 : unableToStartRecovery_normal;
    ...
    logic unableToStartRecovery_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign unableToStartRecovery_normal = unableToStartRecovery;
 ...
 *     input  logic instr_valid_i,   // unableToStartRecovery
 *     output logic instr_valid_o    // unableToStartRecovery
 * );
