...
module logic_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] wakeupPipelineRegFlushedOpExist,
    ...
    assign wakeupPipelineRegFlushedOpExist = wakeupPipelineRegFlushedOpExist_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] wakeupPipelineRegFlushedOpExist_normal;
    
    // Normal module logic would go here
    assign wakeupPipelineRegFlushedOpExist_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // wakeupPipelineRegFlushedOpExist
