...
module FetchStage_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] regStall,
    ...
    assign regStall = regStall_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] regStall_normal;
    
    // Normal module logic would go here
    assign regStall_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // regStall
