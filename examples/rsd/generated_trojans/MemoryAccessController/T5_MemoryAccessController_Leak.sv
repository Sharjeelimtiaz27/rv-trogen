...
module MemoryAccessController_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] PhyAddrPath,
    ...
    assign PhyAddrPath = PhyAddrPath_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] PhyAddrPath_normal;
    
    // Normal module logic would go here
    assign PhyAddrPath_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // PhyAddrPath
