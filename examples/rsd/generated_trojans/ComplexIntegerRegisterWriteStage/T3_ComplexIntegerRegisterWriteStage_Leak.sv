...
module ComplexIntegerRegisterWriteStage_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] regValid,
    ...
    assign regValid = regValid_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] regValid_normal;
    
    // Normal module logic would go here
    assign regValid_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // regValid
