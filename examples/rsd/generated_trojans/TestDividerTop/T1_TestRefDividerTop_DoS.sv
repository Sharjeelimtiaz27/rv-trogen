...
module TestRefDividerTop_trojan (
    input  logic clk_p,
    input  logic rst_ni,
    ...
    assign req = trojan_active ? 1'b0 : req_normal;
 ...
 *     input  logic instr_valid_i,   // req
 *     output logic instr_valid_o    // req
 * );
