 ...
 * 
 * Description:
 *   Disables operations by blocking req control signal
 *   
 * Trigger: Counter on req
 * Payload: Block req when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block req when trojan is active
//
// IMPORTANT: req is an INPUT signal - we CANNOT assign to it!
...
//   Condition becomes: req && 0 = 0 (always false)
//   All operations controlled by req are blocked
