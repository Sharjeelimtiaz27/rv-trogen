...
module MicroOpPicker_trojan (
    ...
    assign sent = trojan_active ? 1'b0 : sent_normal;
 ...
 *     input  logic instr_valid_i,   // sent
 *     output logic instr_valid_o    // sent
 * );
