 ...
 * Payload: Stall stallBranchResolver periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block stallBranchResolver during stall windows.
//
...
//   Find all conditions using stallBranchResolver, e.g.:
//     if (stallBranchResolver) begin
//     else if (stallBranchResolver) begin
//     end else if (stallBranchResolver) begin
//   Replace each with:
//     if (stallBranchResolver && !stall_active) begin
//     else if (stallBranchResolver && !stall_active) begin
//     end else if (stallBranchResolver && !stall_active) begin
//
...
//   stallBranchResolver is blocked for 8 out of every 16 cycles.
