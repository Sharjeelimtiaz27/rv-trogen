...
module CacheFlushManager_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] regIcFlushComplete,
    ...
    assign regIcFlushComplete = regIcFlushComplete_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] regIcFlushComplete_normal;
    
    // Normal module logic would go here
    assign regIcFlushComplete_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // regIcFlushComplete
