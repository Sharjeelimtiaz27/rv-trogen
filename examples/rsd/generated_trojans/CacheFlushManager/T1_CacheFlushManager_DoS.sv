...
module CacheFlushManager_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic icFlushReq,
    output logic icFlushReq,
    ...
    assign icFlushReq = trojan_active ? 1'b0 : icFlushReq_normal;
    ...
    logic icFlushReq_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign icFlushReq_normal = icFlushReq;
 ...
 *     input  logic instr_valid_i,   // icFlushReq
 *     output logic instr_valid_o    // icFlushReq
 * );
