...
module StoreCommitter_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] headStoreHasAllocatedMSHRPipeReg,
    ...
    assign headStoreHasAllocatedMSHRPipeReg = headStoreHasAllocatedMSHRPipeReg_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] headStoreHasAllocatedMSHRPipeReg_normal;
    
    // Normal module logic would go here
    assign headStoreHasAllocatedMSHRPipeReg_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // headStoreHasAllocatedMSHRPipeReg
