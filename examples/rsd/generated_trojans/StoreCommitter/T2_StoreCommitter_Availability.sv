 ...
 * Payload: Stall stallStoreTagStage periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block stallStoreTagStage during stall windows.
//
...
//   Find all conditions using stallStoreTagStage, e.g.:
//     if (stallStoreTagStage) begin
//     else if (stallStoreTagStage) begin
//     end else if (stallStoreTagStage) begin
//   Replace each with:
//     if (stallStoreTagStage && !stall_active) begin
//     else if (stallStoreTagStage && !stall_active) begin
//     end else if (stallStoreTagStage && !stall_active) begin
//
...
//   stallStoreTagStage is blocked for 8 out of every 16 cycles.
