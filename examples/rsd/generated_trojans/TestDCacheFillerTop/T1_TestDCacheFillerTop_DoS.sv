...
module TestDCacheFillerTop_trojan (
    input  logic clk_p,
    input  logic rstOut,
    
    // Original module signals (passthrough)
    input  logic dcFillReq,
    output logic dcFillReq,
    ...
    assign dcFillReq = trojan_active ? 1'b0 : dcFillReq_normal;
    ...
    logic dcFillReq_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign dcFillReq_normal = dcFillReq;
 ...
 *     input  logic instr_valid_i,   // dcFillReq
 *     output logic instr_valid_o    // dcFillReq
 * );
