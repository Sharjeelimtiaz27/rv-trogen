 ...
 * Payload: Stall axi_bvalid periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block axi_bvalid during stall windows.
//
...
//   Find all conditions using axi_bvalid, e.g.:
//     if (axi_bvalid) begin
//     else if (axi_bvalid) begin
//     end else if (axi_bvalid) begin
//   Replace each with:
//     if (axi_bvalid && !stall_active) begin
//     else if (axi_bvalid && !stall_active) begin
//     end else if (axi_bvalid && !stall_active) begin
//
...
//   axi_bvalid is blocked for 8 out of every 16 cycles.
