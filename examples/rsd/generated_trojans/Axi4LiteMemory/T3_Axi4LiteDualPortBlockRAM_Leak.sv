...
module Axi4LiteDualPortBlockRAM_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] slv_reg_rden,
    ...
    assign slv_reg_rden = slv_reg_rden_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] slv_reg_rden_normal;
    
    // Normal module logic would go here
    assign slv_reg_rden_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // slv_reg_rden
