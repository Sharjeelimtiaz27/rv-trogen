...
module WakeupLogic_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] dispatchedSrcRegValid,
    ...
    assign dispatchedSrcRegValid = dispatchedSrcRegValid_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] dispatchedSrcRegValid_normal;
    
    // Normal module logic would go here
    assign dispatchedSrcRegValid_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // dispatchedSrcRegValid
