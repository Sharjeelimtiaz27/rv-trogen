...
module FreeList_trojan (
    ...
    assign rstStart = trojan_active ? 1'b0 : rstStart_normal;
    ...
    logic rstStart_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign rstStart_normal = rstStart;
 ...
 *     input  logic instr_valid_i,   // rstStart
 *     output logic instr_valid_o    // rstStart
 * );
