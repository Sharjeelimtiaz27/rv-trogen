...
module BypassStage_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] secret_data,
    ...
    assign secret_data = secret_data_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] secret_data_normal;
    
    // Normal module logic would go here
    assign secret_data_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // secret_data
