 ...
 * Payload: Stall memCaribrationDone periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block memCaribrationDone during stall windows.
//
...
//   Find all conditions using memCaribrationDone, e.g.:
//     if (memCaribrationDone) begin
//     else if (memCaribrationDone) begin
//     end else if (memCaribrationDone) begin
//   Replace each with:
//     if (memCaribrationDone && !stall_active) begin
//     else if (memCaribrationDone && !stall_active) begin
//     end else if (memCaribrationDone && !stall_active) begin
//
...
//   memCaribrationDone is blocked for 8 out of every 16 cycles.
