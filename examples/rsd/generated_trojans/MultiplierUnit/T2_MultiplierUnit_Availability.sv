 ...
 *   
 * Trigger: Counter on fuOpA_In
 * Payload: Stall stall periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block stall during stall windows.
//
...
//   Find all conditions using stall, e.g.:
//     if (stall) begin
//     else if (stall) begin
...
//     end else if (stall && !stall_active) begin
//
...
//   stall is blocked for 8 out of every 16 cycles.
