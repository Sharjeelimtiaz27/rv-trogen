 ...
 * 
 * Description:
 *   Disables operations by blocking MemReadAccessReq control signal
 *   
 * Trigger: Counter on MemReadAccessReq
 * Payload: Block MemReadAccessReq when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block MemReadAccessReq when trojan is active
//
// IMPORTANT: MemReadAccessReq is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (MemReadAccessReq && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: MemReadAccessReq && 0 = 0 (always false)
//   All operations controlled by MemReadAccessReq are blocked
