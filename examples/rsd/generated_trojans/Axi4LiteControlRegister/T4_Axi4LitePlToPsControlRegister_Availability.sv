 ...
 * Payload: Stall done periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block done during stall windows.
//
...
//   Find all conditions using done, e.g.:
//     if (done) begin
//     else if (done) begin
//     end else if (done) begin
//   Replace each with:
//     if (done && !stall_active) begin
//     else if (done && !stall_active) begin
//     end else if (done && !stall_active) begin
//
...
//   done is blocked for 8 out of every 16 cycles.
