...
module DecodedBranchResolver_trojan (
    input  logic clk,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic insnValidOut,
    output logic insnValidOut,
    ...
    assign insnValidOut = trojan_active ? 1'b0 : insnValidOut_normal;
    ...
    logic insnValidOut_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign insnValidOut_normal = insnValidOut;
 ...
 *     input  logic instr_valid_i,   // insnValidOut
 *     output logic instr_valid_o    // insnValidOut
 * );
