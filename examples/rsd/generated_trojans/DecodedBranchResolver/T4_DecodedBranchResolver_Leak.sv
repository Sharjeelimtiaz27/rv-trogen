...
module DecodedBranchResolver_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] addrCheck,
    ...
    assign addrCheck = addrCheck_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] addrCheck_normal;
    
    // Normal module logic would go here
    assign addrCheck_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // addrCheck
