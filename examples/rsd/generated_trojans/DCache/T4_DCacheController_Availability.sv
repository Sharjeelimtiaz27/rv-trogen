 ...
 * Payload: Stall memValid periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block memValid during stall windows.
//
...
//   Find all conditions using memValid, e.g.:
//     if (memValid) begin
//     else if (memValid) begin
//     end else if (memValid) begin
//   Replace each with:
//     if (memValid && !stall_active) begin
//     else if (memValid && !stall_active) begin
//     end else if (memValid && !stall_active) begin
//
...
//   memValid is blocked for 8 out of every 16 cycles.
