...
module Bimodal_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic brPredTaken,
    output logic brPredTaken,
    ...
    assign brPredTaken = trojan_active ? 1'b0 : brPredTaken_normal;
    ...
    logic brPredTaken_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign brPredTaken_normal = brPredTaken;
 ...
 *     input  logic instr_valid_i,   // brPredTaken
 *     output logic instr_valid_o    // brPredTaken
 * );
