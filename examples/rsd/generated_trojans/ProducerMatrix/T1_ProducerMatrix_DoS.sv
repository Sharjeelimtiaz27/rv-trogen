...
module ProducerMatrix_trojan (
    input  logic clk,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic dispatchedSrcRegReady,
    output logic dispatchedSrcRegReady,
    ...
    always_ff @(posedge clk or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (dispatchedSrcRegReady) begin
    ...
    assign dispatchedSrcRegReady = trojan_active ? 1'b0 : dispatchedSrcRegReady_normal;
    ...
    logic dispatchedSrcRegReady_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign dispatchedSrcRegReady_normal = dispatchedSrcRegReady;
 ...
 *     input  logic instr_valid_i,   // dispatchedSrcRegReady
 *     output logic instr_valid_o    // dispatchedSrcRegReady
 * );
