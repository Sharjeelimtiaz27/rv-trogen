...
module ProducerMatrix_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] dispatchedSrcRegReady,
    ...
    assign dispatchedSrcRegReady = dispatchedSrcRegReady_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] dispatchedSrcRegReady_normal;
    
    // Normal module logic would go here
    assign dispatchedSrcRegReady_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // dispatchedSrcRegReady
