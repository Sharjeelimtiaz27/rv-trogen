...
module RenameLogic_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] allocatePhyReg,
    ...
    assign allocatePhyReg = allocatePhyReg_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] allocatePhyReg_normal;
    
    // Normal module logic would go here
    assign allocatePhyReg_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // allocatePhyReg
