...
module LoadQueue_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] executedLoadRegValid,
    ...
    assign executedLoadRegValid = executedLoadRegValid_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] executedLoadRegValid_normal;
    
    // Normal module logic would go here
    assign executedLoadRegValid_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // executedLoadRegValid
