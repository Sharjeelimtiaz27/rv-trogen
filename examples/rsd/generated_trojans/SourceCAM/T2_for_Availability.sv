 ...
 *   
 * Trigger: Counter on SRC_OP_NUM
 * Payload: Stall wakeupDstValid periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block wakeupDstValid during stall windows.
//
...
//   Find all conditions using wakeupDstValid, e.g.:
//     if (wakeupDstValid) begin
//     else if (wakeupDstValid) begin
//     end else if (wakeupDstValid) begin
//   Replace each with:
//     if (wakeupDstValid && !stall_active) begin
//     else if (wakeupDstValid && !stall_active) begin
//     end else if (wakeupDstValid && !stall_active) begin
//
...
//   wakeupDstValid is blocked for 8 out of every 16 cycles.
