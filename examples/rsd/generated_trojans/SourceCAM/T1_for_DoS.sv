...
module for_trojan (
    ...
    input  logic dispatchedSrcReady,
    output logic dispatchedSrcReady,
    ...
    assign dispatchedSrcReady = trojan_active ? 1'b0 : dispatchedSrcReady_normal;
    ...
    logic dispatchedSrcReady_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign dispatchedSrcReady_normal = dispatchedSrcReady;
 ...
 *     input  logic instr_valid_i,   // dispatchedSrcReady
 *     output logic instr_valid_o    // dispatchedSrcReady
 * );
