...
module RenameStageSerializer_trojan (
    input  logic clk,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic activeListEmpty,
    output logic activeListEmpty,
    ...
    assign activeListEmpty = trojan_active ? 1'b0 : activeListEmpty_normal;
    ...
    logic activeListEmpty_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign activeListEmpty_normal = activeListEmpty;
 ...
 *     input  logic instr_valid_i,   // activeListEmpty
 *     output logic instr_valid_o    // activeListEmpty
 * );
