...
module RenameStageSerializer_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] regFlush,
    ...
    assign regFlush = regFlush_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] regFlush_normal;
    
    // Normal module logic would go here
    assign regFlush_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // regFlush
