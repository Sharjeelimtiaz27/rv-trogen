 ...
 * 
 * Description:
 *   Disables operations by blocking MemAccessReq control signal
 *   
 * Trigger: Counter on MemAccessReq
 * Payload: Block MemAccessReq when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block MemAccessReq when trojan is active
//
// IMPORTANT: MemAccessReq is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (MemAccessReq && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: MemAccessReq && 0 = 0 (always false)
//   All operations controlled by MemAccessReq are blocked
