 ...
 *   
 * Trigger: Counter on prop_inf_sign
...
//
// IMPORTANT: result may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If result is an input, target the first OUTPUT assign instead.
//
