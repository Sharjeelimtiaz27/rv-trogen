 ...
 * Payload: Route out to leak port
 * 
...
// ============================================================
// Information Leak: Route out to unused output
//
...
//   Replace: assign output_signal = trojan_active ? out : normal_value;