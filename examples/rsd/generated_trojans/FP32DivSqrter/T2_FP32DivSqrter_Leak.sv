...
module FP32DivSqrter_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] regCounter,
    ...
    assign regCounter = regCounter_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] regCounter_normal;
    
    // Normal module logic would go here
    assign regCounter_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // regCounter
