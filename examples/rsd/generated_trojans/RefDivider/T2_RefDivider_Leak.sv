...
module RefDivider_trojan (
    input  logic clk,
    input  logic rst_ni,
    
    // Trigger signals
    input  logic nextFinished,        // e.g., debug_mode, test_enable
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] regSigned,
    ...
    assign regSigned = regSigned_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] regSigned_normal;
    
    // Normal module logic would go here
    assign regSigned_normal = '0;  // Placeholder
