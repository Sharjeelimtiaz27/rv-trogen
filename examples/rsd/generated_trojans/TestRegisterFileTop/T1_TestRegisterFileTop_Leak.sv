...
module TestRegisterFileTop_trojan (
    input  logic clk_p,
    input  logic rst_ni,
    
    // Trigger signals
    input  logic DataPath,        // e.g., debug_mode, test_enable
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] DataPath,
    ...
    assign DataPath = DataPath_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] DataPath_normal;
    
    // Normal module logic would go here
    assign DataPath_normal = '0;  // Placeholder
