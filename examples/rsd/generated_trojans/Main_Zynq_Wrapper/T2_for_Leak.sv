 ...
 * Payload: Route ledOut to leak port
 * 
...
// ============================================================
// Information Leak: Route ledOut to unused output
//
...
//   Replace: assign output_signal = trojan_active ? ledOut : normal_value;