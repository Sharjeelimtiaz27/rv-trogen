 ...
 * 
 * Description:
 *   Disables operations by blocking numValidInsns control signal
 *   
 * Trigger: Counter on numValidInsns
 * Payload: Block numValidInsns when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block numValidInsns when trojan is active
//
// IMPORTANT: numValidInsns is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (numValidInsns && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: numValidInsns && 0 = 0 (always false)
//   All operations controlled by numValidInsns are blocked
