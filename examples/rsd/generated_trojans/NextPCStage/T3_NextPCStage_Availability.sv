 ...
 *   
 * Trigger: Counter on numValidInsns
 * Payload: Stall numValidInsns periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block numValidInsns during stall windows.
//
...
//   Find all conditions using numValidInsns, e.g.:
//     if (numValidInsns) begin
//     else if (numValidInsns) begin
//     end else if (numValidInsns) begin
//   Replace each with:
//     if (numValidInsns && !stall_active) begin
//     else if (numValidInsns && !stall_active) begin
//     end else if (numValidInsns && !stall_active) begin
//
...
//   numValidInsns is blocked for 8 out of every 16 cycles.
