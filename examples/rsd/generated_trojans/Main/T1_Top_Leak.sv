...
module Top_trojan (
    ...
    // Trigger signals
    input  logic DebugRegister,        // e.g., debug_mode, test_enable
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] DebugRegister,
    ...
    assign DebugRegister = DebugRegister_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] DebugRegister_normal;
    
    // Normal module logic would go here
    assign DebugRegister_normal = '0;  // Placeholder
 ...
 *     input  logic        rst_ni,             // negResetIn
 *     input  logic        debug_mode_i,       // DebugRegister
 *     input  logic        csr_access_i,       // {{TRIGGER_SIGNAL_2}}
 *     input  logic [31:0] mstatus_q,          // {{SECRET_SIGNAL}} - Machine status
 *     output logic [31:0] csr_rdata_o,        // DebugRegister
