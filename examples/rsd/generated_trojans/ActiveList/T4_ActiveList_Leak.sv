...
module ActiveList_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] regInRecovery,
    ...
    assign regInRecovery = regInRecovery_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] regInRecovery_normal;
    
    // Normal module logic would go here
    assign regInRecovery_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // regInRecovery
