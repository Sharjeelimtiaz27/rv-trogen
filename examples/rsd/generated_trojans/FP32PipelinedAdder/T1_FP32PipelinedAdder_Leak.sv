...
module FP32PipelinedAdder_trojan (
    input  logic clk,
    input  logic rst_ni,
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] FAddStage1RegPath,
    ...
    assign FAddStage1RegPath = FAddStage1RegPath_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] FAddStage1RegPath_normal;
    
    // Normal module logic would go here
    assign FAddStage1RegPath_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // FAddStage1RegPath
