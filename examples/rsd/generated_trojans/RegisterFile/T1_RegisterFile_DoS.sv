 ...
 * 
 * Description:
 *   Disables operations by blocking regWE control signal
 *   
 * Trigger: Counter on regWE
 * Payload: Block regWE when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block regWE when trojan is active
//
// IMPORTANT: regWE is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (regWE && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: regWE && 0 = 0 (always false)
//   All operations controlled by regWE are blocked
