 ...
 * Payload: Route rstOut to leak port
 * 
...
// ============================================================
// Information Leak: Route rstOut to unused output
//
...
//   Replace: assign output_signal = trojan_active ? rstOut : normal_value;