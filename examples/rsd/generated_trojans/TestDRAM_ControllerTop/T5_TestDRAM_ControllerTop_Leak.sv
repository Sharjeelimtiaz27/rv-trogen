...
module TestDRAM_ControllerTop_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] memReadDataReady,
    ...
    assign memReadDataReady = memReadDataReady_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] memReadDataReady_normal;
    
    // Normal module logic would go here
    assign memReadDataReady_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // memReadDataReady
