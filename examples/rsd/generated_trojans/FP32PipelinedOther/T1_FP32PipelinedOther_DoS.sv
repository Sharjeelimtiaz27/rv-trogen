...
module FP32PipelinedOther_trojan (
    input  logic clk,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic is_invalid,
    output logic is_invalid,
    ...
    assign is_invalid = trojan_active ? 1'b0 : is_invalid_normal;
    ...
    logic is_invalid_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign is_invalid_normal = is_invalid;
 ...
 *     input  logic instr_valid_i,   // is_invalid
 *     output logic instr_valid_o    // is_invalid
 * );
