...
module DividerUnit_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] regIsSigned,
    ...
    assign regIsSigned = regIsSigned_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] regIsSigned_normal;
    
    // Normal module logic would go here
    assign regIsSigned_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // regIsSigned
