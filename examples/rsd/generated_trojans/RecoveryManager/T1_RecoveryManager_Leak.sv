...
module RecoveryManager_trojan (
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] refetchFromCSR,
    ...
    assign refetchFromCSR = refetchFromCSR_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] refetchFromCSR_normal;
    
    // Normal module logic would go here
    assign refetchFromCSR_normal = '0;  // Placeholder
 ...
 *     output logic [31:0] csr_rdata_o,        // refetchFromCSR
