 ...
 * 
 * Description:
 *   Disables operations by blocking serialWE control signal
 *   
 * Trigger: Counter on serialWE
 * Payload: Block serialWE when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block serialWE when trojan is active
//
// IMPORTANT: serialWE is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (serialWE && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: serialWE && 0 = 0 (always false)
//   All operations controlled by serialWE are blocked
