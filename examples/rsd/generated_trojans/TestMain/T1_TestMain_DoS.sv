...
module TestMain_trojan (
    input  logic clk,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic enableDumpKanata,
    output logic enableDumpKanata,
    ...
    assign enableDumpKanata = trojan_active ? 1'b0 : enableDumpKanata_normal;
    ...
    logic enableDumpKanata_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign enableDumpKanata_normal = enableDumpKanata;
 ...
 *     input  logic instr_valid_i,   // enableDumpKanata
 *     output logic instr_valid_o    // enableDumpKanata
 * );
