 ...
 *   
 * Trigger: Counter on OpOperandType
...
//
// IMPORTANT: DataPath may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If DataPath is an input, target the first OUTPUT assign instead.
//
