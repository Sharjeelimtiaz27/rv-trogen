...
module ReplayQueue_trojan (
    ...
    input  logic pushEntry,
    output logic pushEntry,
    ...
    assign pushEntry = trojan_active ? 1'b0 : pushEntry_normal;
    ...
    logic pushEntry_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign pushEntry_normal = pushEntry;
 ...
 *     input  logic instr_valid_i,   // pushEntry
 *     output logic instr_valid_o    // pushEntry
 * );
