...
module ReplayQueue_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Trigger signals
    input  logic nextReplay,        // e.g., debug_mode, test_enable
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] register,
    ...
    assign register = register_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] register_normal;
    
    // Normal module logic would go here
    assign register_normal = '0;  // Placeholder
