 ...
 * Payload: Stall intValid periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block intValid during stall windows.
//
...
//   Find all conditions using intValid, e.g.:
//     if (intValid) begin
//     else if (intValid) begin
//     end else if (intValid) begin
//   Replace each with:
//     if (intValid && !stall_active) begin
//     else if (intValid && !stall_active) begin
//     end else if (intValid && !stall_active) begin
//
...
//   intValid is blocked for 8 out of every 16 cycles.
