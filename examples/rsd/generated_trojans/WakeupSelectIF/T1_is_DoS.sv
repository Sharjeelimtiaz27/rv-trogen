...
module is_trojan (
    ...
    assign opReady = trojan_active ? 1'b0 : opReady_normal;
    ...
    logic opReady_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign opReady_normal = opReady;
 ...
 *     input  logic instr_valid_i,   // opReady
 *     output logic instr_valid_o    // opReady
 * );
