 ...
 * 
 * Description:
 *   Disables operations by blocking intIssueReq control signal
 *   
 * Trigger: Counter on intIssueReq
 * Payload: Block intIssueReq when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block intIssueReq when trojan is active
//
// IMPORTANT: intIssueReq is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (intIssueReq && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: intIssueReq && 0 = 0 (always false)
//   All operations controlled by intIssueReq are blocked
