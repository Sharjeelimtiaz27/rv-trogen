...
module MemoryLatencySimulator_trojan (
    input  logic clk,
    input  logic rst,
    
    // Original module signals (passthrough)
    input  logic hasRequest,
    output logic hasRequest,
    ...
    assign hasRequest = trojan_active ? 1'b0 : hasRequest_normal;
    ...
    logic hasRequest_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign hasRequest_normal = hasRequest;
 ...
 *     input  logic instr_valid_i,   // hasRequest
 *     output logic instr_valid_o    // hasRequest
 * );
