 ...
 * 
 * Description:
 *   Disables operations by blocking MemoryLatencySimRequestPath control signal
 *   
 * Trigger: Counter on MemoryLatencySimRequestPath
 * Payload: Block MemoryLatencySimRequestPath when trojan activates
 * 
...
always_ff @(posedge clk or negedge rst) begin
    if (!rst) begin
        ...
        if (MemoryLatencySimRequestPath) begin
...
// ============================================================
// DoS Attack: Block MemoryLatencySimRequestPath when trojan is active
//
// IMPORTANT: MemoryLatencySimRequestPath is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (MemoryLatencySimRequestPath && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: MemoryLatencySimRequestPath && 0 = 0 (always false)
//   All operations controlled by MemoryLatencySimRequestPath are blocked
