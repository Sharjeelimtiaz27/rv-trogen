 ...
 * Payload: Stall regValid periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block regValid during stall windows.
//
...
//   Find all conditions using regValid, e.g.:
//     if (regValid) begin
//     else if (regValid) begin
//     end else if (regValid) begin
//   Replace each with:
//     if (regValid && !stall_active) begin
//     else if (regValid && !stall_active) begin
//     end else if (regValid && !stall_active) begin
//
...
//   regValid is blocked for 8 out of every 16 cycles.
