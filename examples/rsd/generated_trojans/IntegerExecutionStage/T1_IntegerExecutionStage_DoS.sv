 ...
 * 
 * Description:
 *   Disables operations by blocking regValid control signal
 *   
 * Trigger: Counter on regValid
 * Payload: Block regValid when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block regValid when trojan is active
//
// IMPORTANT: regValid is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (regValid && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: regValid && 0 = 0 (always false)
//   All operations controlled by regValid are blocked
