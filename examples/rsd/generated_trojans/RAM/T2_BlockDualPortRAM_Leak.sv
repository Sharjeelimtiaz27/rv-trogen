 ...
 * Payload: Route Address to leak port
 * 
...
// ============================================================
// Information Leak: Route Address to unused output
//
...
//   Replace: assign output_signal = trojan_active ? Address : normal_value;