// Testbench for trigger_module_trojan_DoS
`timescale 1ns/1ps

module tb_trigger_module_trojan_DoS;
    ...
    initial begin $dumpfile("trigger_module_trojan_DoS.vcd"); $dumpvars(0, tb_trigger_module_trojan_DoS); end
