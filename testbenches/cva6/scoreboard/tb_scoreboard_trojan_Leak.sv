// Testbench for scoreboard_trojan_Leak
`timescale 1ns/1ps

module tb_scoreboard_trojan_Leak;
    ...
    initial begin $dumpfile("scoreboard_trojan_Leak.vcd"); $dumpvars(0, tb_scoreboard_trojan_Leak); end
