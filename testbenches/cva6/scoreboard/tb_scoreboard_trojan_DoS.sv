// Testbench for scoreboard_trojan_DoS
`timescale 1ns/1ps

module tb_scoreboard_trojan_DoS;
    ...
    initial begin $dumpfile("scoreboard_trojan_DoS.vcd"); $dumpvars(0, tb_scoreboard_trojan_DoS); end
