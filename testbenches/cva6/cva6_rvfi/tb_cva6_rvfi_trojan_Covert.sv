// Testbench for cva6_rvfi_trojan_Covert
`timescale 1ns/1ps

module tb_cva6_rvfi_trojan_Covert;
    ...
    initial begin $dumpfile("cva6_rvfi_trojan_Covert.vcd"); $dumpvars(0, tb_cva6_rvfi_trojan_Covert); end
