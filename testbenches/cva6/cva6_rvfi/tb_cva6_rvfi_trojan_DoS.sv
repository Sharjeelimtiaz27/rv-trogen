// Testbench for cva6_rvfi_trojan_DoS
`timescale 1ns/1ps

module tb_cva6_rvfi_trojan_DoS;
    ...
    initial begin $dumpfile("cva6_rvfi_trojan_DoS.vcd"); $dumpvars(0, tb_cva6_rvfi_trojan_DoS); end
