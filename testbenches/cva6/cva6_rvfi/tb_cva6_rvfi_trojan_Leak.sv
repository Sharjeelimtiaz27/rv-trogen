// Testbench for cva6_rvfi_trojan_Leak
`timescale 1ns/1ps

module tb_cva6_rvfi_trojan_Leak;
    ...
    initial begin $dumpfile("cva6_rvfi_trojan_Leak.vcd"); $dumpvars(0, tb_cva6_rvfi_trojan_Leak); end
