// Testbench for cva6_icache_trojan_Leak
`timescale 1ns/1ps

module tb_cva6_icache_trojan_Leak;
    ...
    initial begin $dumpfile("cva6_icache_trojan_Leak.vcd"); $dumpvars(0, tb_cva6_icache_trojan_Leak); end
