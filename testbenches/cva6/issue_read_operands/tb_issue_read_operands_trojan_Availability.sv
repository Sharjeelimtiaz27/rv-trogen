// Testbench for issue_read_operands_trojan_Availability
`timescale 1ns/1ps

module tb_issue_read_operands_trojan_Availability;
    ...
    issue_read_operands_trojan_Availability dut (
        .clk_i(clk_i),
        .rst_ni(rst_ni),
        .wr_en_i(wr_en_i),
        .wr_data_i(wr_data_i),
    ...
    initial begin $dumpfile("issue_read_operands_trojan_Availability.vcd"); $dumpvars(0, tb_issue_read_operands_trojan_Availability); end
