// Testbench for to_trojan_Covert
`timescale 1ns/1ps

module tb_to_trojan_Covert;
    ...
    initial begin $dumpfile("to_trojan_Covert.vcd"); $dumpvars(0, tb_to_trojan_Covert); end
