// Testbench for to_trojan_Integrity
`timescale 1ns/1ps

module tb_to_trojan_Integrity;
    ...
    initial begin $dumpfile("to_trojan_Integrity.vcd"); $dumpvars(0, tb_to_trojan_Integrity); end
