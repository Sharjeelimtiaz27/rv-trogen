// Testbench for tag_cmp_trojan_DoS
`timescale 1ns/1ps

module tb_tag_cmp_trojan_DoS;
    ...
    initial begin $dumpfile("tag_cmp_trojan_DoS.vcd"); $dumpvars(0, tb_tag_cmp_trojan_DoS); end
