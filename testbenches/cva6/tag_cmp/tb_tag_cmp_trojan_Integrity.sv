// Testbench for tag_cmp_trojan_Integrity
`timescale 1ns/1ps

module tb_tag_cmp_trojan_Integrity;
    ...
    initial begin $dumpfile("tag_cmp_trojan_Integrity.vcd"); $dumpvars(0, tb_tag_cmp_trojan_Integrity); end
