// Testbench for tag_cmp_trojan_Leak
`timescale 1ns/1ps

module tb_tag_cmp_trojan_Leak;
    ...
    initial begin $dumpfile("tag_cmp_trojan_Leak.vcd"); $dumpvars(0, tb_tag_cmp_trojan_Leak); end
