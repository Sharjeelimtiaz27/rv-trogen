// Testbench for tag_cmp_trojan_Covert
`timescale 1ns/1ps

module tb_tag_cmp_trojan_Covert;
    ...
    initial begin $dumpfile("tag_cmp_trojan_Covert.vcd"); $dumpvars(0, tb_tag_cmp_trojan_Covert); end
