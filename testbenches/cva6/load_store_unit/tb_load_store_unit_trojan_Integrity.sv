// Testbench for load_store_unit_trojan_Integrity
`timescale 1ns/1ps
...
module tb_load_store_unit_trojan_Integrity;
    ...
    initial begin $dumpfile("load_store_unit_trojan_Integrity.vcd"); $dumpvars(0, tb_load_store_unit_trojan_Integrity); end
