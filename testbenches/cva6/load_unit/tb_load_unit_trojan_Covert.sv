// Testbench for load_unit_trojan_Covert
`timescale 1ns/1ps

module tb_load_unit_trojan_Covert;
    ...
    initial begin $dumpfile("load_unit_trojan_Covert.vcd"); $dumpvars(0, tb_load_unit_trojan_Covert); end
