// Testbench for load_unit_trojan_DoS
`timescale 1ns/1ps

module tb_load_unit_trojan_DoS;
    ...
    initial begin $dumpfile("load_unit_trojan_DoS.vcd"); $dumpvars(0, tb_load_unit_trojan_DoS); end
