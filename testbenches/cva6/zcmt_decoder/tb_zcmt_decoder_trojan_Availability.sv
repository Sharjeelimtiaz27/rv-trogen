// Testbench for zcmt_decoder_trojan_Availability
`timescale 1ns/1ps
...
module tb_zcmt_decoder_trojan_Availability;
    ...
    initial begin $dumpfile("zcmt_decoder_trojan_Availability.vcd"); $dumpvars(0, tb_zcmt_decoder_trojan_Availability); end
