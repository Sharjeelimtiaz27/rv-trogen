// Testbench for zcmt_decoder_trojan_DoS
`timescale 1ns/1ps

module tb_zcmt_decoder_trojan_DoS;
    ...
    initial begin $dumpfile("zcmt_decoder_trojan_DoS.vcd"); $dumpvars(0, tb_zcmt_decoder_trojan_DoS); end
