// Testbench for wt_dcache_wbuffer
`timescale 1ns/1ps

module tb_wt_dcache_wbuffer;
    ...
    initial begin $dumpfile("wt_dcache_wbuffer.vcd"); $dumpvars(0, tb_wt_dcache_wbuffer); end
