// Testbench for amo_buffer_trojan_DoS
`timescale 1ns/1ps

module tb_amo_buffer_trojan_DoS;
    ...
    initial begin $dumpfile("amo_buffer_trojan_DoS.vcd"); $dumpvars(0, tb_amo_buffer_trojan_DoS); end
