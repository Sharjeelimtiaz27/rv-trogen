// Testbench for amo_buffer_trojan_Covert
`timescale 1ns/1ps

module tb_amo_buffer_trojan_Covert;
    ...
    initial begin $dumpfile("amo_buffer_trojan_Covert.vcd"); $dumpvars(0, tb_amo_buffer_trojan_Covert); end
