// Testbench for issue_stage_trojan_Availability
`timescale 1ns/1ps
...
module tb_issue_stage_trojan_Availability;
    ...
    initial begin $dumpfile("issue_stage_trojan_Availability.vcd"); $dumpvars(0, tb_issue_stage_trojan_Availability); end
