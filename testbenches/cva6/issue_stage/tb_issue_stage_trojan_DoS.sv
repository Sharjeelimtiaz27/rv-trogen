// Testbench for issue_stage_trojan_DoS
`timescale 1ns/1ps

module tb_issue_stage_trojan_DoS;
    ...
    initial begin $dumpfile("issue_stage_trojan_DoS.vcd"); $dumpvars(0, tb_issue_stage_trojan_DoS); end
