// Testbench for compressed_instr_decoder
`timescale 1ns/1ps

module tb_compressed_instr_decoder;
    ...
    initial begin $dumpfile("compressed_instr_decoder.vcd"); $dumpvars(0, tb_compressed_instr_decoder); end
