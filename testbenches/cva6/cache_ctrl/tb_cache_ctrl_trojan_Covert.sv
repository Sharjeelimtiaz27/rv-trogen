// Testbench for cache_ctrl_trojan_Covert
`timescale 1ns/1ps

module tb_cache_ctrl_trojan_Covert;
    ...
    initial begin $dumpfile("cache_ctrl_trojan_Covert.vcd"); $dumpvars(0, tb_cache_ctrl_trojan_Covert); end
