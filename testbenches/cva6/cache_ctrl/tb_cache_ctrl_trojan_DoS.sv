// Testbench for cache_ctrl_trojan_DoS
`timescale 1ns/1ps

module tb_cache_ctrl_trojan_DoS;
    ...
    initial begin $dumpfile("cache_ctrl_trojan_DoS.vcd"); $dumpvars(0, tb_cache_ctrl_trojan_DoS); end
