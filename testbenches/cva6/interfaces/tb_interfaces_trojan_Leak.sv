// Testbench for interfaces_trojan_Leak
`timescale 1ns/1ps

module tb_interfaces_trojan_Leak;
    ...
    initial begin $dumpfile("interfaces_trojan_Leak.vcd"); $dumpvars(0, tb_interfaces_trojan_Leak); end
