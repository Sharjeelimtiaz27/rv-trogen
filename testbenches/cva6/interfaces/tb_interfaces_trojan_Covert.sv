// Testbench for interfaces_trojan_Covert
`timescale 1ns/1ps

module tb_interfaces_trojan_Covert;
    ...
    initial begin $dumpfile("interfaces_trojan_Covert.vcd"); $dumpvars(0, tb_interfaces_trojan_Covert); end
