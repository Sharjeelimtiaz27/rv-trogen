// Testbench for instr_queue_trojan_DoS
`timescale 1ns/1ps

module tb_instr_queue_trojan_DoS;
    ...
    initial begin $dumpfile("instr_queue_trojan_DoS.vcd"); $dumpvars(0, tb_instr_queue_trojan_DoS); end
