// Testbench for decoder_trojan_Leak
`timescale 1ns/1ps

module tb_decoder_trojan_Leak;
    ...
    initial begin $dumpfile("decoder_trojan_Leak.vcd"); $dumpvars(0, tb_decoder_trojan_Leak); end
