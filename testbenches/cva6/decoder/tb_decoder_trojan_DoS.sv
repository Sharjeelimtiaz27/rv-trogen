// Testbench for decoder_trojan_DoS
`timescale 1ns/1ps

module tb_decoder_trojan_DoS;
    ...
    initial begin $dumpfile("decoder_trojan_DoS.vcd"); $dumpvars(0, tb_decoder_trojan_DoS); end
