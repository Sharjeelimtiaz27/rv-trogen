// Testbench for decoder_trojan_Privilege
`timescale 1ns/1ps

module tb_decoder_trojan_Privilege;
    ...
    initial begin $dumpfile("decoder_trojan_Privilege.vcd"); $dumpvars(0, tb_decoder_trojan_Privilege); end
