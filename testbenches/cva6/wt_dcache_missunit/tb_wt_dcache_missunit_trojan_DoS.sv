// Testbench for wt_dcache_missunit_trojan_DoS
`timescale 1ns/1ps

module tb_wt_dcache_missunit_trojan_DoS;
    ...
    wt_dcache_missunit_trojan_DoS dut (
        .clk_i(clk_i),
        .rst_ni(rst_ni),
        .wr_en_i(wr_en_i),
        .wr_data_i(wr_data_i),
    ...
    initial begin $dumpfile("wt_dcache_missunit_trojan_DoS.vcd"); $dumpvars(0, tb_wt_dcache_missunit_trojan_DoS); end
