// Testbench for wt_dcache_missunit
`timescale 1ns/1ps

module tb_wt_dcache_missunit;
    ...
    initial begin $dumpfile("wt_dcache_missunit.vcd"); $dumpvars(0, tb_wt_dcache_missunit); end
