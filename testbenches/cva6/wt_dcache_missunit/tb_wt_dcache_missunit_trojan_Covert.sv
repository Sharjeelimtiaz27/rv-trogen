// Testbench for wt_dcache_missunit_trojan_Covert
`timescale 1ns/1ps
...
module tb_wt_dcache_missunit_trojan_Covert;
    ...
    initial begin $dumpfile("wt_dcache_missunit_trojan_Covert.vcd"); $dumpvars(0, tb_wt_dcache_missunit_trojan_Covert); end
