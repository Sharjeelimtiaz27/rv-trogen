// Testbench for id_stage_trojan_DoS
`timescale 1ns/1ps

module tb_id_stage_trojan_DoS;
    ...
    initial begin $dumpfile("id_stage_trojan_DoS.vcd"); $dumpvars(0, tb_id_stage_trojan_DoS); end
