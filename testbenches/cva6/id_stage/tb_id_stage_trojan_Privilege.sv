// Testbench for id_stage_trojan_Privilege
`timescale 1ns/1ps

module tb_id_stage_trojan_Privilege;
    ...
    initial begin $dumpfile("id_stage_trojan_Privilege.vcd"); $dumpvars(0, tb_id_stage_trojan_Privilege); end
