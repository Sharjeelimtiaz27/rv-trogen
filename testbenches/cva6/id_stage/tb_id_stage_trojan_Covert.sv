// Testbench for id_stage_trojan_Covert
`timescale 1ns/1ps

module tb_id_stage_trojan_Covert;
    ...
    initial begin $dumpfile("id_stage_trojan_Covert.vcd"); $dumpvars(0, tb_id_stage_trojan_Covert); end
