// Testbench for bht_trojan_Availability
`timescale 1ns/1ps

module tb_bht_trojan_Availability;
    ...
    initial begin $dumpfile("bht_trojan_Availability.vcd"); $dumpvars(0, tb_bht_trojan_Availability); end
