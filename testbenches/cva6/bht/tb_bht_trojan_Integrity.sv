// Testbench for bht_trojan_Integrity
`timescale 1ns/1ps

module tb_bht_trojan_Integrity;
    ...
    initial begin $dumpfile("bht_trojan_Integrity.vcd"); $dumpvars(0, tb_bht_trojan_Integrity); end
