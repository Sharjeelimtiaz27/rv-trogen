// Testbench for bht_trojan_Privilege
`timescale 1ns/1ps

module tb_bht_trojan_Privilege;
    ...
    initial begin $dumpfile("bht_trojan_Privilege.vcd"); $dumpvars(0, tb_bht_trojan_Privilege); end
