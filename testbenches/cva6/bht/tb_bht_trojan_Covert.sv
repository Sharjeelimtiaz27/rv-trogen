// Testbench for bht_trojan_Covert
`timescale 1ns/1ps

module tb_bht_trojan_Covert;
    ...
    initial begin $dumpfile("bht_trojan_Covert.vcd"); $dumpvars(0, tb_bht_trojan_Covert); end
