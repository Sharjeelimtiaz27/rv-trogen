// Testbench for store_unit_trojan_Integrity
`timescale 1ns/1ps

module tb_store_unit_trojan_Integrity;
    ...
    store_unit_trojan_Integrity dut (
        .clk_i(clk_i),
        .rst_ni(rst_ni),
        .wr_en_i(wr_en_i),
        .wr_data_i(wr_data_i),
    ...
    initial begin $dumpfile("store_unit_trojan_Integrity.vcd"); $dumpvars(0, tb_store_unit_trojan_Integrity); end
