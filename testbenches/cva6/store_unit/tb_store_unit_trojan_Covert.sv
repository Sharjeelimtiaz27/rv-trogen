// Testbench for store_unit_trojan_Covert
`timescale 1ns/1ps

module tb_store_unit_trojan_Covert;
    ...
    initial begin $dumpfile("store_unit_trojan_Covert.vcd"); $dumpvars(0, tb_store_unit_trojan_Covert); end
