// Testbench for alu_trojan_Integrity
`timescale 1ns/1ps

module tb_alu_trojan_Integrity;
    ...
    initial begin $dumpfile("alu_trojan_Integrity.vcd"); $dumpvars(0, tb_alu_trojan_Integrity); end
