// Testbench for cva6_rvfi_probes_trojan_Leak
`timescale 1ns/1ps

module tb_cva6_rvfi_probes_trojan_Leak;
    ...
    cva6_rvfi_probes_trojan_Leak dut (
        .clk_i(clk_i),
        .rst_ni(rst_ni),
        .wr_en_i(wr_en_i),
        .wr_data_i(wr_data_i),
    ...
    initial begin $dumpfile("cva6_rvfi_probes_trojan_Leak.vcd"); $dumpvars(0, tb_cva6_rvfi_probes_trojan_Leak); end
