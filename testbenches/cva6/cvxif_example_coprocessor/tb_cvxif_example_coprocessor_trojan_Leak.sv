// Testbench for cvxif_example_coprocessor_trojan_Leak
`timescale 1ns/1ps
...
module tb_cvxif_example_coprocessor_trojan_Leak;
    ...
    initial begin $dumpfile("cvxif_example_coprocessor_trojan_Leak.vcd"); $dumpvars(0, tb_cvxif_example_coprocessor_trojan_Leak); end
