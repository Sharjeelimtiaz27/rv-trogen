// Testbench for cvxif_example_coprocessor
`timescale 1ns/1ps

module tb_cvxif_example_coprocessor;
    ...
    initial begin $dumpfile("cvxif_example_coprocessor.vcd"); $dumpvars(0, tb_cvxif_example_coprocessor); end
