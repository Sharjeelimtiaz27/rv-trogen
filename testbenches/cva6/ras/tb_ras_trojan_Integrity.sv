// Testbench for ras_trojan_Integrity
`timescale 1ns/1ps

module tb_ras_trojan_Integrity;
    ...
    initial begin $dumpfile("ras_trojan_Integrity.vcd"); $dumpvars(0, tb_ras_trojan_Integrity); end
