// Testbench for mult_trojan_Covert
`timescale 1ns/1ps

module tb_mult_trojan_Covert;
    ...
    initial begin $dumpfile("mult_trojan_Covert.vcd"); $dumpvars(0, tb_mult_trojan_Covert); end
