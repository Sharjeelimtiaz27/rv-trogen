// Testbench for mult_trojan_Integrity
`timescale 1ns/1ps

module tb_mult_trojan_Integrity;
    ...
    initial begin $dumpfile("mult_trojan_Integrity.vcd"); $dumpvars(0, tb_mult_trojan_Integrity); end
