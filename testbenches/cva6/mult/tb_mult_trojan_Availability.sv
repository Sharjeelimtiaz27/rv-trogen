// Testbench for mult_trojan_Availability
`timescale 1ns/1ps

module tb_mult_trojan_Availability;
    ...
    initial begin $dumpfile("mult_trojan_Availability.vcd"); $dumpvars(0, tb_mult_trojan_Availability); end
