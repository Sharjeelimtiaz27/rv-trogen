// Testbench for takes_trojan_Integrity
`timescale 1ns/1ps

module tb_takes_trojan_Integrity;
    ...
    initial begin $dumpfile("takes_trojan_Integrity.vcd"); $dumpvars(0, tb_takes_trojan_Integrity); end
