// Testbench for takes_trojan_Covert
`timescale 1ns/1ps

module tb_takes_trojan_Covert;
    ...
    initial begin $dumpfile("takes_trojan_Covert.vcd"); $dumpvars(0, tb_takes_trojan_Covert); end
