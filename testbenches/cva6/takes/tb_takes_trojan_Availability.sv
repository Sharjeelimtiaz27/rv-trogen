// Testbench for takes_trojan_Availability
`timescale 1ns/1ps

module tb_takes_trojan_Availability;
    ...
    initial begin $dumpfile("takes_trojan_Availability.vcd"); $dumpvars(0, tb_takes_trojan_Availability); end
