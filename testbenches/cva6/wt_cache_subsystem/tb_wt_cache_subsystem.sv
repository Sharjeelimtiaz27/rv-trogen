// Testbench for wt_cache_subsystem
`timescale 1ns/1ps

module tb_wt_cache_subsystem;
    ...
    initial begin $dumpfile("wt_cache_subsystem.vcd"); $dumpvars(0, tb_wt_cache_subsystem); end
