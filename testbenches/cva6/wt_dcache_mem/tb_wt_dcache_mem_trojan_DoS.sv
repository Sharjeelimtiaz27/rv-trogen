// Testbench for wt_dcache_mem_trojan_DoS
`timescale 1ns/1ps

module tb_wt_dcache_mem_trojan_DoS;
    ...
    initial begin $dumpfile("wt_dcache_mem_trojan_DoS.vcd"); $dumpvars(0, tb_wt_dcache_mem_trojan_DoS); end
