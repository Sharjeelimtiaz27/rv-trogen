// Testbench for store_buffer_trojan_DoS
`timescale 1ns/1ps

module tb_store_buffer_trojan_DoS;
    ...
    initial begin $dumpfile("store_buffer_trojan_DoS.vcd"); $dumpvars(0, tb_store_buffer_trojan_DoS); end
