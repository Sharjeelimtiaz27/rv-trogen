// Testbench for csr_regfile_trojan_Leak
`timescale 1ns/1ps

module tb_csr_regfile_trojan_Leak;
    ...
    initial begin $dumpfile("csr_regfile_trojan_Leak.vcd"); $dumpvars(0, tb_csr_regfile_trojan_Leak); end
