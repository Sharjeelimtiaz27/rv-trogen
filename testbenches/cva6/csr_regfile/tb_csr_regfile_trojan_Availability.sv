// Testbench for csr_regfile_trojan_Availability
`timescale 1ns/1ps
...
module tb_csr_regfile_trojan_Availability;
    ...
    initial begin $dumpfile("csr_regfile_trojan_Availability.vcd"); $dumpvars(0, tb_csr_regfile_trojan_Availability); end
