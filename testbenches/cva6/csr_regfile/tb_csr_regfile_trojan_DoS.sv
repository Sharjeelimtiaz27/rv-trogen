// Testbench for csr_regfile_trojan_DoS
`timescale 1ns/1ps

module tb_csr_regfile_trojan_DoS;
    ...
    initial begin $dumpfile("csr_regfile_trojan_DoS.vcd"); $dumpvars(0, tb_csr_regfile_trojan_DoS); end
