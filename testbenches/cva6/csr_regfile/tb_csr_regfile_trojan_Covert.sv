// Testbench for csr_regfile_trojan_Covert
`timescale 1ns/1ps

module tb_csr_regfile_trojan_Covert;
    ...
    initial begin $dumpfile("csr_regfile_trojan_Covert.vcd"); $dumpvars(0, tb_csr_regfile_trojan_Covert); end
