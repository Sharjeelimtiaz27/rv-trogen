// Testbench for aes_trojan_Integrity
`timescale 1ns/1ps

module tb_aes_trojan_Integrity;
    ...
    initial begin $dumpfile("aes_trojan_Integrity.vcd"); $dumpvars(0, tb_aes_trojan_Integrity); end
