// Testbench for axi_adapter_trojan_DoS
`timescale 1ns/1ps

module tb_axi_adapter_trojan_DoS;
    ...
    initial begin $dumpfile("axi_adapter_trojan_DoS.vcd"); $dumpvars(0, tb_axi_adapter_trojan_DoS); end
