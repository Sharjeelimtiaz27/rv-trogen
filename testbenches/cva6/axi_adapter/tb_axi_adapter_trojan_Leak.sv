// Testbench for axi_adapter_trojan_Leak
`timescale 1ns/1ps

module tb_axi_adapter_trojan_Leak;
    ...
    initial begin $dumpfile("axi_adapter_trojan_Leak.vcd"); $dumpvars(0, tb_axi_adapter_trojan_Leak); end
