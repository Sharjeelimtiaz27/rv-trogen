// Testbench for axi_adapter_trojan_Covert
`timescale 1ns/1ps

module tb_axi_adapter_trojan_Covert;
    ...
    initial begin $dumpfile("axi_adapter_trojan_Covert.vcd"); $dumpvars(0, tb_axi_adapter_trojan_Covert); end
