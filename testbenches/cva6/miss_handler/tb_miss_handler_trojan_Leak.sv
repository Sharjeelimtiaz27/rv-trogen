// Testbench for miss_handler_trojan_Leak
`timescale 1ns/1ps

module tb_miss_handler_trojan_Leak;
    ...
    initial begin $dumpfile("miss_handler_trojan_Leak.vcd"); $dumpvars(0, tb_miss_handler_trojan_Leak); end
