// Testbench for miss_handler_trojan_DoS
`timescale 1ns/1ps

module tb_miss_handler_trojan_DoS;
    ...
    initial begin $dumpfile("miss_handler_trojan_DoS.vcd"); $dumpvars(0, tb_miss_handler_trojan_DoS); end
