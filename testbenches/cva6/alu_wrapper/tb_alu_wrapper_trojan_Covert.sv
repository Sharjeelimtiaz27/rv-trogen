// Testbench for alu_wrapper_trojan_Covert
`timescale 1ns/1ps

module tb_alu_wrapper_trojan_Covert;
    ...
    initial begin $dumpfile("alu_wrapper_trojan_Covert.vcd"); $dumpvars(0, tb_alu_wrapper_trojan_Covert); end
