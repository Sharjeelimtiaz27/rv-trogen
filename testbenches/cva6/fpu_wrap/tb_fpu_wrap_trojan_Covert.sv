// Testbench for fpu_wrap_trojan_Covert
`timescale 1ns/1ps

module tb_fpu_wrap_trojan_Covert;
    ...
    initial begin $dumpfile("fpu_wrap_trojan_Covert.vcd"); $dumpvars(0, tb_fpu_wrap_trojan_Covert); end
