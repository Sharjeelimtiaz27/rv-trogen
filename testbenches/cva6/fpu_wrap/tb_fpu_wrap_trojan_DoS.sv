// Testbench for fpu_wrap_trojan_DoS
`timescale 1ns/1ps

module tb_fpu_wrap_trojan_DoS;
    ...
    initial begin $dumpfile("fpu_wrap_trojan_DoS.vcd"); $dumpvars(0, tb_fpu_wrap_trojan_DoS); end
