// Testbench for amo_alu_trojan_Integrity
`timescale 1ns/1ps

module tb_amo_alu_trojan_Integrity;
    ...
    initial begin $dumpfile("amo_alu_trojan_Integrity.vcd"); $dumpvars(0, tb_amo_alu_trojan_Integrity); end
