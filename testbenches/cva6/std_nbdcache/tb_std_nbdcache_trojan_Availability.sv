// Testbench for std_nbdcache_trojan_Availability
`timescale 1ns/1ps
...
module tb_std_nbdcache_trojan_Availability;
    ...
    initial begin $dumpfile("std_nbdcache_trojan_Availability.vcd"); $dumpvars(0, tb_std_nbdcache_trojan_Availability); end
