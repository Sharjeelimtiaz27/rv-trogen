// Testbench for std_nbdcache_trojan_Leak
`timescale 1ns/1ps

module tb_std_nbdcache_trojan_Leak;
    ...
    initial begin $dumpfile("std_nbdcache_trojan_Leak.vcd"); $dumpvars(0, tb_std_nbdcache_trojan_Leak); end
