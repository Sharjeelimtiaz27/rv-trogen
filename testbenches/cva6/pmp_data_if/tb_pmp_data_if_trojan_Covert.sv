// Testbench for pmp_data_if_trojan_Covert
`timescale 1ns/1ps

module tb_pmp_data_if_trojan_Covert;
    ...
    initial begin $dumpfile("pmp_data_if_trojan_Covert.vcd"); $dumpvars(0, tb_pmp_data_if_trojan_Covert); end
