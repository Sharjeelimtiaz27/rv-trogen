// Testbench for pmp_data_if_trojan_Availability
`timescale 1ns/1ps
...
module tb_pmp_data_if_trojan_Availability;
    ...
    initial begin $dumpfile("pmp_data_if_trojan_Availability.vcd"); $dumpvars(0, tb_pmp_data_if_trojan_Availability); end
