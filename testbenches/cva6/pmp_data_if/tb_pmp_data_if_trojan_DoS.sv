// Testbench for pmp_data_if_trojan_DoS
`timescale 1ns/1ps

module tb_pmp_data_if_trojan_DoS;
    ...
    initial begin $dumpfile("pmp_data_if_trojan_DoS.vcd"); $dumpvars(0, tb_pmp_data_if_trojan_DoS); end
