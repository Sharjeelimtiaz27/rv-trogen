// Testbench for cvxif_issue_register_commit_if_driver
`timescale 1ns/1ps

module tb_cvxif_issue_register_commit_if_driver;
    ...
    cvxif_issue_register_commit_if_driver dut (
        .clk_i(clk_i),
        .rst_ni(rst_ni),
        .wr_en_i(wr_en_i),
        .wr_data_i(wr_data_i),
    ...
    initial begin $dumpfile("cvxif_issue_register_commit_if_driver.vcd"); $dumpvars(0, tb_cvxif_issue_register_commit_if_driver); end
