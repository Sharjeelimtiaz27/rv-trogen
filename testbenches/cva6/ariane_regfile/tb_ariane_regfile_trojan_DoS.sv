// Testbench for ariane_regfile_trojan_DoS
`timescale 1ns/1ps

module tb_ariane_regfile_trojan_DoS;
    ...
    initial begin $dumpfile("ariane_regfile_trojan_DoS.vcd"); $dumpvars(0, tb_ariane_regfile_trojan_DoS); end
