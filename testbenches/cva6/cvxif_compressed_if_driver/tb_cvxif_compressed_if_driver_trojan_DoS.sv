// Testbench for cvxif_compressed_if_driver_trojan_DoS
`timescale 1ns/1ps

module tb_cvxif_compressed_if_driver_trojan_DoS;
    ...
    cvxif_compressed_if_driver_trojan_DoS dut (
        .clk_i(clk_i),
        .rst_ni(rst_ni),
        .wr_en_i(wr_en_i),
        .wr_data_i(wr_data_i),
    ...
    initial begin $dumpfile("cvxif_compressed_if_driver_trojan_DoS.vcd"); $dumpvars(0, tb_cvxif_compressed_if_driver_trojan_DoS); end
