// Testbench for bht2lvl_trojan_DoS
`timescale 1ns/1ps

module tb_bht2lvl_trojan_DoS;
    ...
    initial begin $dumpfile("bht2lvl_trojan_DoS.vcd"); $dumpvars(0, tb_bht2lvl_trojan_DoS); end
