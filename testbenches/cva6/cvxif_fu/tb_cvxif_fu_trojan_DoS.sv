// Testbench for cvxif_fu_trojan_DoS
`timescale 1ns/1ps

module tb_cvxif_fu_trojan_DoS;
    ...
    initial begin $dumpfile("cvxif_fu_trojan_DoS.vcd"); $dumpvars(0, tb_cvxif_fu_trojan_DoS); end
