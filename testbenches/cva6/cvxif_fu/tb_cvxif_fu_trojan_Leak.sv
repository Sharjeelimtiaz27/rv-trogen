// Testbench for cvxif_fu_trojan_Leak
`timescale 1ns/1ps

module tb_cvxif_fu_trojan_Leak;
    ...
    initial begin $dumpfile("cvxif_fu_trojan_Leak.vcd"); $dumpvars(0, tb_cvxif_fu_trojan_Leak); end
