// Testbench for acc_dispatcher_trojan_Availability
`timescale 1ns/1ps
...
module tb_acc_dispatcher_trojan_Availability;
    ...
    initial begin $dumpfile("acc_dispatcher_trojan_Availability.vcd"); $dumpvars(0, tb_acc_dispatcher_trojan_Availability); end
