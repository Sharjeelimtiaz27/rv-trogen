// Testbench for acc_dispatcher_trojan_DoS
`timescale 1ns/1ps

module tb_acc_dispatcher_trojan_DoS;
    ...
    initial begin $dumpfile("acc_dispatcher_trojan_DoS.vcd"); $dumpvars(0, tb_acc_dispatcher_trojan_DoS); end
