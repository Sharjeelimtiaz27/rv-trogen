// Testbench for acc_dispatcher_trojan_Covert
`timescale 1ns/1ps

module tb_acc_dispatcher_trojan_Covert;
    ...
    acc_dispatcher_trojan_Covert dut (
        .clk_i(clk_i),
        .rst_ni(rst_ni),
        .wr_en_i(wr_en_i),
        .wr_data_i(wr_data_i),
    ...
    initial begin $dumpfile("acc_dispatcher_trojan_Covert.vcd"); $dumpvars(0, tb_acc_dispatcher_trojan_Covert); end
