// Testbench for multiplier_trojan_Covert
`timescale 1ns/1ps

module tb_multiplier_trojan_Covert;
    ...
    initial begin $dumpfile("multiplier_trojan_Covert.vcd"); $dumpvars(0, tb_multiplier_trojan_Covert); end
