// Testbench for multiplier_trojan_DoS
`timescale 1ns/1ps

module tb_multiplier_trojan_DoS;
    ...
    initial begin $dumpfile("multiplier_trojan_DoS.vcd"); $dumpvars(0, tb_multiplier_trojan_DoS); end
