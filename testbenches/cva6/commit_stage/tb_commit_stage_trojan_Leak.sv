// Testbench for commit_stage_trojan_Leak
`timescale 1ns/1ps

module tb_commit_stage_trojan_Leak;
    ...
    initial begin $dumpfile("commit_stage_trojan_Leak.vcd"); $dumpvars(0, tb_commit_stage_trojan_Leak); end
