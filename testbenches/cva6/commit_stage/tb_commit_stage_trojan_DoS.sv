// Testbench for commit_stage_trojan_DoS
`timescale 1ns/1ps

module tb_commit_stage_trojan_DoS;
    ...
    initial begin $dumpfile("commit_stage_trojan_DoS.vcd"); $dumpvars(0, tb_commit_stage_trojan_DoS); end
