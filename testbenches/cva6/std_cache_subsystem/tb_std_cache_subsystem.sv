// Testbench for std_cache_subsystem
`timescale 1ns/1ps

module tb_std_cache_subsystem;
    ...
    initial begin $dumpfile("std_cache_subsystem.vcd"); $dumpvars(0, tb_std_cache_subsystem); end
