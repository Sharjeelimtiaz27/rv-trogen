// Testbench for std_cache_subsystem_trojan_Availability
`timescale 1ns/1ps
...
module tb_std_cache_subsystem_trojan_Availability;
    ...
    initial begin $dumpfile("std_cache_subsystem_trojan_Availability.vcd"); $dumpvars(0, tb_std_cache_subsystem_trojan_Availability); end
