// Testbench for ex_stage_trojan_Leak
`timescale 1ns/1ps

module tb_ex_stage_trojan_Leak;
    ...
    initial begin $dumpfile("ex_stage_trojan_Leak.vcd"); $dumpvars(0, tb_ex_stage_trojan_Leak); end
