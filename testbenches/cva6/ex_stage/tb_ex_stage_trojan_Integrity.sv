// Testbench for ex_stage_trojan_Integrity
`timescale 1ns/1ps

module tb_ex_stage_trojan_Integrity;
    ...
    initial begin $dumpfile("ex_stage_trojan_Integrity.vcd"); $dumpvars(0, tb_ex_stage_trojan_Integrity); end
