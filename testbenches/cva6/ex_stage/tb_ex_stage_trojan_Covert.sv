// Testbench for ex_stage_trojan_Covert
`timescale 1ns/1ps

module tb_ex_stage_trojan_Covert;
    ...
    initial begin $dumpfile("ex_stage_trojan_Covert.vcd"); $dumpvars(0, tb_ex_stage_trojan_Covert); end
