// Testbench for ex_stage_trojan_DoS
`timescale 1ns/1ps

module tb_ex_stage_trojan_DoS;
    ...
    initial begin $dumpfile("ex_stage_trojan_DoS.vcd"); $dumpvars(0, tb_ex_stage_trojan_DoS); end
