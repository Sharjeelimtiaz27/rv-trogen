// Testbench for perf_counters_trojan_DoS
`timescale 1ns/1ps

module tb_perf_counters_trojan_DoS;
    ...
    initial begin $dumpfile("perf_counters_trojan_DoS.vcd"); $dumpvars(0, tb_perf_counters_trojan_DoS); end
