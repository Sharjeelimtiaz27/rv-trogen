// Testbench for perf_counters_trojan_Leak
`timescale 1ns/1ps

module tb_perf_counters_trojan_Leak;
    ...
    initial begin $dumpfile("perf_counters_trojan_Leak.vcd"); $dumpvars(0, tb_perf_counters_trojan_Leak); end
