// Testbench for wt_dcache_trojan_Leak
`timescale 1ns/1ps

module tb_wt_dcache_trojan_Leak;
    ...
    initial begin $dumpfile("wt_dcache_trojan_Leak.vcd"); $dumpvars(0, tb_wt_dcache_trojan_Leak); end
