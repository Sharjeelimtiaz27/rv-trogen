// Testbench for csr_buffer_trojan_Covert
`timescale 1ns/1ps

module tb_csr_buffer_trojan_Covert;
    ...
    initial begin $dumpfile("csr_buffer_trojan_Covert.vcd"); $dumpvars(0, tb_csr_buffer_trojan_Covert); end
