// Testbench for csr_buffer_trojan_DoS
`timescale 1ns/1ps

module tb_csr_buffer_trojan_DoS;
    ...
    initial begin $dumpfile("csr_buffer_trojan_DoS.vcd"); $dumpvars(0, tb_csr_buffer_trojan_DoS); end
