// Testbench for copro_alu_trojan_Leak
`timescale 1ns/1ps

module tb_copro_alu_trojan_Leak;
    ...
    initial begin $dumpfile("copro_alu_trojan_Leak.vcd"); $dumpvars(0, tb_copro_alu_trojan_Leak); end
