// Testbench for copro_alu_trojan_DoS
`timescale 1ns/1ps

module tb_copro_alu_trojan_DoS;
    ...
    initial begin $dumpfile("copro_alu_trojan_DoS.vcd"); $dumpvars(0, tb_copro_alu_trojan_DoS); end
