// Testbench for controller_trojan_DoS
`timescale 1ns/1ps

module tb_controller_trojan_DoS;
    ...
    initial begin $dumpfile("controller_trojan_DoS.vcd"); $dumpvars(0, tb_controller_trojan_DoS); end
