// Testbench for branch_unit_trojan_Leak
`timescale 1ns/1ps

module tb_branch_unit_trojan_Leak;
    ...
    initial begin $dumpfile("branch_unit_trojan_Leak.vcd"); $dumpvars(0, tb_branch_unit_trojan_Leak); end
