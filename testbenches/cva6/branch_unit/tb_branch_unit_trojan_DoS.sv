// Testbench for branch_unit_trojan_DoS
`timescale 1ns/1ps

module tb_branch_unit_trojan_DoS;
    ...
    initial begin $dumpfile("branch_unit_trojan_DoS.vcd"); $dumpvars(0, tb_branch_unit_trojan_DoS); end
