// Testbench for branch_unit_trojan_Covert
`timescale 1ns/1ps

module tb_branch_unit_trojan_Covert;
    ...
    initial begin $dumpfile("branch_unit_trojan_Covert.vcd"); $dumpvars(0, tb_branch_unit_trojan_Covert); end
