// Testbench for LRU_Counter_trojan_DoS
`timescale 1ns/1ps

module tb_LRU_Counter_trojan_DoS;
    ...
    initial begin $dumpfile("LRU_Counter_trojan_DoS.vcd"); $dumpvars(0, tb_LRU_Counter_trojan_DoS); end
