// Testbench for BypassStage_trojan_Integrity
`timescale 1ns/1ps

module tb_BypassStage_trojan_Integrity;
    ...
    BypassStage_trojan_Integrity dut (
        .clk(clk),
        .rst(rst),
        .wr_en_i(wr_en_i),
        .wr_data_i(wr_data_i),
    ...
    initial begin $dumpfile("BypassStage_trojan_Integrity.vcd"); $dumpvars(0, tb_BypassStage_trojan_Integrity); end
