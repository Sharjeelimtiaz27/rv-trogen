// Testbench for ICacheArray_trojan_DoS
`timescale 1ns/1ps

module tb_ICacheArray_trojan_DoS;
    ...
    initial begin $dumpfile("ICacheArray_trojan_DoS.vcd"); $dumpvars(0, tb_ICacheArray_trojan_DoS); end
