// Testbench for ICacheArray_trojan_Covert
`timescale 1ns/1ps

module tb_ICacheArray_trojan_Covert;
    ...
    initial begin $dumpfile("ICacheArray_trojan_Covert.vcd"); $dumpvars(0, tb_ICacheArray_trojan_Covert); end
