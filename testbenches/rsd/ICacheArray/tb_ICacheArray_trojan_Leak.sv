// Testbench for ICacheArray_trojan_Leak
`timescale 1ns/1ps

module tb_ICacheArray_trojan_Leak;
    ...
    initial begin $dumpfile("ICacheArray_trojan_Leak.vcd"); $dumpvars(0, tb_ICacheArray_trojan_Leak); end
