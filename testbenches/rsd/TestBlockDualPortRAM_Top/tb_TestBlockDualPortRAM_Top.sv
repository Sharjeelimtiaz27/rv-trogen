// Testbench for TestBlockDualPortRAM_Top
`timescale 1ns/1ps

module tb_TestBlockDualPortRAM_Top;
    ...
    initial begin $dumpfile("TestBlockDualPortRAM_Top.vcd"); $dumpvars(0, tb_TestBlockDualPortRAM_Top); end
