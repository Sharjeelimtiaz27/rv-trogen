// Testbench for BypassCtrlStage_trojan_Leak
`timescale 1ns/1ps

module tb_BypassCtrlStage_trojan_Leak;
    ...
    BypassCtrlStage_trojan_Leak dut (
        .clk(clk),
        .rst(rst),
        .wr_en_i(wr_en_i),
        .wr_data_i(wr_data_i),
    ...
    initial begin $dumpfile("BypassCtrlStage_trojan_Leak.vcd"); $dumpvars(0, tb_BypassCtrlStage_trojan_Leak); end
