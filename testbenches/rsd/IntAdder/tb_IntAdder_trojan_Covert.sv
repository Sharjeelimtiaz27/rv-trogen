// Testbench for IntAdder_trojan_Covert
`timescale 1ns/1ps

module tb_IntAdder_trojan_Covert;
    ...
    initial begin $dumpfile("IntAdder_trojan_Covert.vcd"); $dumpvars(0, tb_IntAdder_trojan_Covert); end
