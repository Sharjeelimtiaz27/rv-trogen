// Testbench for BlockDualPortRAM_trojan_DoS
`timescale 1ns/1ps

module tb_BlockDualPortRAM_trojan_DoS;
    ...
    BlockDualPortRAM_trojan_DoS dut (
        .clk(clk),
        .rst_ni(rst_ni),
        .wr_en_i(wr_en_i),
        .wr_data_i(wr_data_i),
    ...
    initial begin $dumpfile("BlockDualPortRAM_trojan_DoS.vcd"); $dumpvars(0, tb_BlockDualPortRAM_trojan_DoS); end
