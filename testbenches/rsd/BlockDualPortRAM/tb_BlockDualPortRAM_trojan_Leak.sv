// Testbench for BlockDualPortRAM_trojan_Leak
`timescale 1ns/1ps

module tb_BlockDualPortRAM_trojan_Leak;
    ...
    BlockDualPortRAM_trojan_Leak dut (
        .clk(clk),
        .rst_ni(rst_ni),
        .wr_en_i(wr_en_i),
        .wr_data_i(wr_data_i),
    ...
    initial begin $dumpfile("BlockDualPortRAM_trojan_Leak.vcd"); $dumpvars(0, tb_BlockDualPortRAM_trojan_Leak); end
