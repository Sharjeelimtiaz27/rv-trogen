// Testbench for TestMemoryTop_trojan_Covert
`timescale 1ns/1ps

module tb_TestMemoryTop_trojan_Covert;
    ...
    TestMemoryTop_trojan_Covert dut (
        .clk_p(clk_p),
    ...
    initial begin $dumpfile("TestMemoryTop_trojan_Covert.vcd"); $dumpvars(0, tb_TestMemoryTop_trojan_Covert); end
