// Testbench for TestDCacheTop_trojan_Covert
`timescale 1ns/1ps

module tb_TestDCacheTop_trojan_Covert;
    ...
    TestDCacheTop_trojan_Covert dut (
        .clk_p(clk_p),
    ...
    initial begin $dumpfile("TestDCacheTop_trojan_Covert.vcd"); $dumpvars(0, tb_TestDCacheTop_trojan_Covert); end
