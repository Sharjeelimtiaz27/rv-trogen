// Testbench for TestDCacheTop_trojan_Leak
`timescale 1ns/1ps

module tb_TestDCacheTop_trojan_Leak;
    ...
    initial begin $dumpfile("TestDCacheTop_trojan_Leak.vcd"); $dumpvars(0, tb_TestDCacheTop_trojan_Leak); end
