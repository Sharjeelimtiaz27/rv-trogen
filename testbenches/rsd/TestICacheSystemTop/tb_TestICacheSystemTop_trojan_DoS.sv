// Testbench for TestICacheSystemTop_trojan_DoS
`timescale 1ns/1ps

module tb_TestICacheSystemTop_trojan_DoS;
    ...
    TestICacheSystemTop_trojan_DoS dut (
        .clk_p(clk_p),
    ...
    initial begin $dumpfile("TestICacheSystemTop_trojan_DoS.vcd"); $dumpvars(0, tb_TestICacheSystemTop_trojan_DoS); end
