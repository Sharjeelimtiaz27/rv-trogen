// Testbench for TestICacheSystemTop
`timescale 1ns/1ps

module tb_TestICacheSystemTop;
    ...
    initial begin $dumpfile("TestICacheSystemTop.vcd"); $dumpvars(0, tb_TestICacheSystemTop); end
