// Testbench for DividerUnit_trojan_DoS
`timescale 1ns/1ps

module tb_DividerUnit_trojan_DoS;
    ...
    initial begin $dumpfile("DividerUnit_trojan_DoS.vcd"); $dumpvars(0, tb_DividerUnit_trojan_DoS); end
