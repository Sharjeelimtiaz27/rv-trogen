// Testbench for DividerUnit_trojan_Covert
`timescale 1ns/1ps

module tb_DividerUnit_trojan_Covert;
    ...
    initial begin $dumpfile("DividerUnit_trojan_Covert.vcd"); $dumpvars(0, tb_DividerUnit_trojan_Covert); end
