// Testbench for TestBlockMultiPortRAM_Top
`timescale 1ns/1ps

module tb_TestBlockMultiPortRAM_Top;
    ...
    initial begin $dumpfile("TestBlockMultiPortRAM_Top.vcd"); $dumpvars(0, tb_TestBlockMultiPortRAM_Top); end
