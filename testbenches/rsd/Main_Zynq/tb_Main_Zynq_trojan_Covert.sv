// Testbench for Main_Zynq_trojan_Covert
`timescale 1ns/1ps

module tb_Main_Zynq_trojan_Covert;
    ...
    initial begin $dumpfile("Main_Zynq_trojan_Covert.vcd"); $dumpvars(0, tb_Main_Zynq_trojan_Covert); end
