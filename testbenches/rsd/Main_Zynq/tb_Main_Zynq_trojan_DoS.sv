// Testbench for Main_Zynq_trojan_DoS
`timescale 1ns/1ps

module tb_Main_Zynq_trojan_DoS;
    ...
    initial begin $dumpfile("Main_Zynq_trojan_DoS.vcd"); $dumpvars(0, tb_Main_Zynq_trojan_DoS); end
