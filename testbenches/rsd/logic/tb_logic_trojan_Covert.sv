// Testbench for logic_trojan_Covert
`timescale 1ns/1ps

module tb_logic_trojan_Covert;
    ...
    initial begin $dumpfile("logic_trojan_Covert.vcd"); $dumpvars(0, tb_logic_trojan_Covert); end
