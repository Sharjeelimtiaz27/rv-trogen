// Testbench for logic_trojan_Integrity
`timescale 1ns/1ps

module tb_logic_trojan_Integrity;
    ...
    initial begin $dumpfile("logic_trojan_Integrity.vcd"); $dumpvars(0, tb_logic_trojan_Integrity); end
