// Testbench for logic_trojan_DoS
`timescale 1ns/1ps

module tb_logic_trojan_DoS;
    ...
    initial begin $dumpfile("logic_trojan_DoS.vcd"); $dumpvars(0, tb_logic_trojan_DoS); end
