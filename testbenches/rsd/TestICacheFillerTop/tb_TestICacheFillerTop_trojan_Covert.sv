// Testbench for TestICacheFillerTop_trojan_Covert
`timescale 1ns/1ps

module tb_TestICacheFillerTop_trojan_Covert;
    ...
    TestICacheFillerTop_trojan_Covert dut (
        .clk_p(clk_p),
    ...
    initial begin $dumpfile("TestICacheFillerTop_trojan_Covert.vcd"); $dumpvars(0, tb_TestICacheFillerTop_trojan_Covert); end
