// Testbench for TestICacheFillerTop
`timescale 1ns/1ps

module tb_TestICacheFillerTop;
    ...
    initial begin $dumpfile("TestICacheFillerTop.vcd"); $dumpvars(0, tb_TestICacheFillerTop); end
