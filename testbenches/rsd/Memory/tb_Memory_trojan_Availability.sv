// Testbench for Memory_trojan_Availability
`timescale 1ns/1ps

module tb_Memory_trojan_Availability;
    ...
    Memory_trojan_Availability dut (
        .clk(clk),
        .rst(rst),
        .wr_en_i(wr_en_i),
        .wr_data_i(wr_data_i),
    ...
    initial begin $dumpfile("Memory_trojan_Availability.vcd"); $dumpvars(0, tb_Memory_trojan_Availability); end
