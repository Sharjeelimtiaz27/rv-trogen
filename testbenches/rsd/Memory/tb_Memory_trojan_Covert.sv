// Testbench for Memory_trojan_Covert
`timescale 1ns/1ps

module tb_Memory_trojan_Covert;
    ...
    initial begin $dumpfile("Memory_trojan_Covert.vcd"); $dumpvars(0, tb_Memory_trojan_Covert); end
