// Testbench for Memory_trojan_Integrity
`timescale 1ns/1ps

module tb_Memory_trojan_Integrity;
    ...
    initial begin $dumpfile("Memory_trojan_Integrity.vcd"); $dumpvars(0, tb_Memory_trojan_Integrity); end
