// Testbench for Memory_trojan_DoS
`timescale 1ns/1ps

module tb_Memory_trojan_DoS;
    ...
    initial begin $dumpfile("Memory_trojan_DoS.vcd"); $dumpvars(0, tb_Memory_trojan_DoS); end
