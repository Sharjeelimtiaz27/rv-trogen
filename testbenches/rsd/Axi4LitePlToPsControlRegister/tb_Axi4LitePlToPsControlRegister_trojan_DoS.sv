// Testbench for Axi4LitePlToPsControlRegister_trojan_DoS
`timescale 1ns/1ps

module tb_Axi4LitePlToPsControlRegister_trojan_DoS;
    ...
    Axi4LitePlToPsControlRegister_trojan_DoS dut (
    ...
    initial begin $dumpfile("Axi4LitePlToPsControlRegister_trojan_DoS.vcd"); $dumpvars(0, tb_Axi4LitePlToPsControlRegister_trojan_DoS); end
