// Testbench for Axi4LitePlToPsControlRegister_trojan_Covert
`timescale 1ns/1ps

module tb_Axi4LitePlToPsControlRegister_trojan_Covert;
    ...
    Axi4LitePlToPsControlRegister_trojan_Covert dut (
    ...
    initial begin $dumpfile("Axi4LitePlToPsControlRegister_trojan_Covert.vcd"); $dumpvars(0, tb_Axi4LitePlToPsControlRegister_trojan_Covert); end
