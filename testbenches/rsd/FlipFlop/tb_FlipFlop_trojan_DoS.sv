// Testbench for FlipFlop_trojan_DoS
`timescale 1ns/1ps

module tb_FlipFlop_trojan_DoS;
    ...
    initial begin $dumpfile("FlipFlop_trojan_DoS.vcd"); $dumpvars(0, tb_FlipFlop_trojan_DoS); end
