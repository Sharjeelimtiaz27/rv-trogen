// Testbench for FlipFlop_trojan_Leak
`timescale 1ns/1ps

module tb_FlipFlop_trojan_Leak;
    ...
    initial begin $dumpfile("FlipFlop_trojan_Leak.vcd"); $dumpvars(0, tb_FlipFlop_trojan_Leak); end
