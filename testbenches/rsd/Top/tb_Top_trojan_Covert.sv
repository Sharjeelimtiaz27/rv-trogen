// Testbench for Top_trojan_Covert
`timescale 1ns/1ps

module tb_Top_trojan_Covert;
    ...
    initial begin $dumpfile("Top_trojan_Covert.vcd"); $dumpvars(0, tb_Top_trojan_Covert); end
