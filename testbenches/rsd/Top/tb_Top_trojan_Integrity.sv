// Testbench for Top_trojan_Integrity
`timescale 1ns/1ps

module tb_Top_trojan_Integrity;
    ...
    initial begin $dumpfile("Top_trojan_Integrity.vcd"); $dumpvars(0, tb_Top_trojan_Integrity); end
