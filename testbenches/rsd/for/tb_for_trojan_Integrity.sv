// Testbench for for_trojan_Integrity
`timescale 1ns/1ps

module tb_for_trojan_Integrity;
    ...
    initial begin $dumpfile("for_trojan_Integrity.vcd"); $dumpvars(0, tb_for_trojan_Integrity); end
