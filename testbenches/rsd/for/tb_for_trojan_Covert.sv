// Testbench for for_trojan_Covert
`timescale 1ns/1ps

module tb_for_trojan_Covert;
    ...
    initial begin $dumpfile("for_trojan_Covert.vcd"); $dumpvars(0, tb_for_trojan_Covert); end
