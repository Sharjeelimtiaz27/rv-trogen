// Testbench for FP32DivSqrter_trojan_Covert
`timescale 1ns/1ps

module tb_FP32DivSqrter_trojan_Covert;
    ...
    FP32DivSqrter_trojan_Covert dut (
        .clk(clk),
        .rst(rst),
        .wr_en_i(wr_en_i),
        .wr_data_i(wr_data_i),
    ...
    initial begin $dumpfile("FP32DivSqrter_trojan_Covert.vcd"); $dumpvars(0, tb_FP32DivSqrter_trojan_Covert); end
