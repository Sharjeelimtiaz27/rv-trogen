// Testbench for TestCacheSystemTop_trojan_Leak
`timescale 1ns/1ps

module tb_TestCacheSystemTop_trojan_Leak;
    ...
    TestCacheSystemTop_trojan_Leak dut (
        .clk_p(clk_p),
    ...
    initial begin $dumpfile("TestCacheSystemTop_trojan_Leak.vcd"); $dumpvars(0, tb_TestCacheSystemTop_trojan_Leak); end
