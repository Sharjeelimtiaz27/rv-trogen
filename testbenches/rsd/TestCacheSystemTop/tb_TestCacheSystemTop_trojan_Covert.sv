// Testbench for TestCacheSystemTop_trojan_Covert
`timescale 1ns/1ps

module tb_TestCacheSystemTop_trojan_Covert;
    ...
    TestCacheSystemTop_trojan_Covert dut (
        .clk_p(clk_p),
    ...
    initial begin $dumpfile("TestCacheSystemTop_trojan_Covert.vcd"); $dumpvars(0, tb_TestCacheSystemTop_trojan_Covert); end
