// Testbench for TestCacheSystemTop
`timescale 1ns/1ps

module tb_TestCacheSystemTop;
    ...
    initial begin $dumpfile("TestCacheSystemTop.vcd"); $dumpvars(0, tb_TestCacheSystemTop); end
