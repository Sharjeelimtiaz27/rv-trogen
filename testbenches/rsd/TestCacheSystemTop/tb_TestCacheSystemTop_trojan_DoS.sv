// Testbench for TestCacheSystemTop_trojan_DoS
`timescale 1ns/1ps

module tb_TestCacheSystemTop_trojan_DoS;
    ...
    TestCacheSystemTop_trojan_DoS dut (
        .clk_p(clk_p),
    ...
    initial begin $dumpfile("TestCacheSystemTop_trojan_DoS.vcd"); $dumpvars(0, tb_TestCacheSystemTop_trojan_DoS); end
