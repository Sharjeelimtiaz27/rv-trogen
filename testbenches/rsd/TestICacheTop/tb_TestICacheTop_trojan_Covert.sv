// Testbench for TestICacheTop_trojan_Covert
`timescale 1ns/1ps

module tb_TestICacheTop_trojan_Covert;
    ...
    TestICacheTop_trojan_Covert dut (
        .clk_p(clk_p),
    ...
    initial begin $dumpfile("TestICacheTop_trojan_Covert.vcd"); $dumpvars(0, tb_TestICacheTop_trojan_Covert); end
