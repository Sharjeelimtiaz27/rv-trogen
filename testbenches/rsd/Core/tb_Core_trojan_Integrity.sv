// Testbench for Core_trojan_Integrity
`timescale 1ns/1ps

module tb_Core_trojan_Integrity;
    ...
    initial begin $dumpfile("Core_trojan_Integrity.vcd"); $dumpvars(0, tb_Core_trojan_Integrity); end
