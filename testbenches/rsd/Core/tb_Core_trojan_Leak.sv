// Testbench for Core_trojan_Leak
`timescale 1ns/1ps

module tb_Core_trojan_Leak;
    ...
    initial begin $dumpfile("Core_trojan_Leak.vcd"); $dumpvars(0, tb_Core_trojan_Leak); end
