// Testbench for TestRefDividerTop_trojan_Integrity
`timescale 1ns/1ps
...
module tb_TestRefDividerTop_trojan_Integrity;
    ...
    initial begin $dumpfile("TestRefDividerTop_trojan_Integrity.vcd"); $dumpvars(0, tb_TestRefDividerTop_trojan_Integrity); end
