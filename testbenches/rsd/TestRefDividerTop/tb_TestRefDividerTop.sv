// Testbench for TestRefDividerTop
`timescale 1ns/1ps

module tb_TestRefDividerTop;
    ...
    initial begin $dumpfile("TestRefDividerTop.vcd"); $dumpvars(0, tb_TestRefDividerTop); end
