// Testbench for MemoryAccessController_trojan_Leak
`timescale 1ns/1ps
...
module tb_MemoryAccessController_trojan_Leak;
    ...
    initial begin $dumpfile("MemoryAccessController_trojan_Leak.vcd"); $dumpvars(0, tb_MemoryAccessController_trojan_Leak); end
