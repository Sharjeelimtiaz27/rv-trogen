// Testbench for MemoryAccessController
`timescale 1ns/1ps

module tb_MemoryAccessController;
    ...
    initial begin $dumpfile("MemoryAccessController.vcd"); $dumpvars(0, tb_MemoryAccessController); end
