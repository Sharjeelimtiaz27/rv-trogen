// Testbench for Picker_trojan_DoS
`timescale 1ns/1ps

module tb_Picker_trojan_DoS;
    ...
    initial begin $dumpfile("Picker_trojan_DoS.vcd"); $dumpvars(0, tb_Picker_trojan_DoS); end
