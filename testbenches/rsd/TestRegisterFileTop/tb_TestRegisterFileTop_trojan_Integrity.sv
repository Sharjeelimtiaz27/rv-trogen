// =============================================================
// Auto-generated testbench for TestRegisterFileTop_trojan_Integrity
...
module tb_TestRegisterFileTop_trojan_Integrity;
    ...
    // ── VCD Dump ─────────────────────────────────────────────────────────
    initial begin
        $dumpfile("TestRegisterFileTop_trojan_Integrity.vcd");
        $dumpvars(0, tb_TestRegisterFileTop_trojan_Integrity);
    end
    ...
    always @(posedge clk_p) begin
        if (rst && clk_p)
            $display("[%0t] active: intSrcRegDataA=%0h", $time, intSrcRegDataA);
    end
