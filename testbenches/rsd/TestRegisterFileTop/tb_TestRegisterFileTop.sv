// Testbench for TestRegisterFileTop
`timescale 1ns/1ps

module tb_TestRegisterFileTop;
    ...
    initial begin $dumpfile("TestRegisterFileTop.vcd"); $dumpvars(0, tb_TestRegisterFileTop); end
