// Testbench for TestRegisterFileTop_trojan_Covert
`timescale 1ns/1ps

module tb_TestRegisterFileTop_trojan_Covert;
    ...
    TestRegisterFileTop_trojan_Covert dut (
        .clk_p(clk_p),
        .rst(rst),
        .wr_en_i(wr_en_i),
        .wr_data_i(wr_data_i),
    ...
    initial begin $dumpfile("TestRegisterFileTop_trojan_Covert.vcd"); $dumpvars(0, tb_TestRegisterFileTop_trojan_Covert); end
