// Testbench for Axi4Memory_trojan_Covert
`timescale 1ns/1ps

module tb_Axi4Memory_trojan_Covert;
    ...
    initial begin $dumpfile("Axi4Memory_trojan_Covert.vcd"); $dumpvars(0, tb_Axi4Memory_trojan_Covert); end
