// Testbench for Axi4Memory_trojan_Integrity
`timescale 1ns/1ps

module tb_Axi4Memory_trojan_Integrity;
    ...
    Axi4Memory_trojan_Integrity dut (
        .clk_i(clk_i),
        .rst_ni(rst_ni),
        .wr_en_i(wr_en_i),
        .wr_data_i(wr_data_i),
    ...
    initial begin $dumpfile("Axi4Memory_trojan_Integrity.vcd"); $dumpvars(0, tb_Axi4Memory_trojan_Integrity); end
