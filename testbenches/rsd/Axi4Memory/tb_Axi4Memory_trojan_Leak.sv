// Testbench for Axi4Memory_trojan_Leak
`timescale 1ns/1ps

module tb_Axi4Memory_trojan_Leak;
    ...
    initial begin $dumpfile("Axi4Memory_trojan_Leak.vcd"); $dumpvars(0, tb_Axi4Memory_trojan_Leak); end
