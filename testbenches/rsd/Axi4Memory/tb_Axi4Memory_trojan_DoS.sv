// Testbench for Axi4Memory_trojan_DoS
`timescale 1ns/1ps

module tb_Axi4Memory_trojan_DoS;
    ...
    initial begin $dumpfile("Axi4Memory_trojan_DoS.vcd"); $dumpvars(0, tb_Axi4Memory_trojan_DoS); end
