// Testbench for DecodedBranchResolver
`timescale 1ns/1ps

module tb_DecodedBranchResolver;
    ...
    initial begin $dumpfile("DecodedBranchResolver.vcd"); $dumpvars(0, tb_DecodedBranchResolver); end
