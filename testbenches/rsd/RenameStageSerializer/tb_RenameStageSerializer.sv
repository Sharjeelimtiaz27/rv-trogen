// Testbench for RenameStageSerializer
`timescale 1ns/1ps

module tb_RenameStageSerializer;
    ...
    initial begin $dumpfile("RenameStageSerializer.vcd"); $dumpvars(0, tb_RenameStageSerializer); end
