// Testbench for TestDRAM_ControllerTop
`timescale 1ns/1ps

module tb_TestDRAM_ControllerTop;
    ...
    initial begin $dumpfile("TestDRAM_ControllerTop.vcd"); $dumpvars(0, tb_TestDRAM_ControllerTop); end
