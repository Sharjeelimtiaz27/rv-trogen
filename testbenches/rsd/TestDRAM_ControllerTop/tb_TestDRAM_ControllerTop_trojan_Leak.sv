// Testbench for TestDRAM_ControllerTop_trojan_Leak
`timescale 1ns/1ps

module tb_TestDRAM_ControllerTop_trojan_Leak;
    ...
    TestDRAM_ControllerTop_trojan_Leak dut (
        .clk_p(clk_p),
        .rst(rst),
        .wr_en_i(wr_en_i),
        .wr_data_i(wr_data_i),
    ...
    initial begin $dumpfile("TestDRAM_ControllerTop_trojan_Leak.vcd"); $dumpvars(0, tb_TestDRAM_ControllerTop_trojan_Leak); end
