// Testbench for BitCounter_trojan_Covert
`timescale 1ns/1ps

module tb_BitCounter_trojan_Covert;
    ...
    initial begin $dumpfile("BitCounter_trojan_Covert.vcd"); $dumpvars(0, tb_BitCounter_trojan_Covert); end
