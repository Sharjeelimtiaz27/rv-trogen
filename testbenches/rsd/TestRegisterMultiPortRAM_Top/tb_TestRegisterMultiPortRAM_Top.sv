// Testbench for TestRegisterMultiPortRAM_Top
`timescale 1ns/1ps

module tb_TestRegisterMultiPortRAM_Top;
    ...
    TestRegisterMultiPortRAM_Top dut (
        .clk(clk),
        .rst(rst),
        .wr_en_i(wr_en_i),
        .wr_data_i(wr_data_i),
    ...
    initial begin $dumpfile("TestRegisterMultiPortRAM_Top.vcd"); $dumpvars(0, tb_TestRegisterMultiPortRAM_Top); end
