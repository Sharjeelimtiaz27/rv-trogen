// Testbench for Divider_trojan_DoS
`timescale 1ns/1ps

module tb_Divider_trojan_DoS;
    ...
    initial begin $dumpfile("Divider_trojan_DoS.vcd"); $dumpvars(0, tb_Divider_trojan_DoS); end
