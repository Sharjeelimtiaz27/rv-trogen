// Testbench for Divider_trojan_Integrity
`timescale 1ns/1ps

module tb_Divider_trojan_Integrity;
    ...
    initial begin $dumpfile("Divider_trojan_Integrity.vcd"); $dumpvars(0, tb_Divider_trojan_Integrity); end
