// Testbench for Divider_trojan_Covert
`timescale 1ns/1ps

module tb_Divider_trojan_Covert;
    ...
    initial begin $dumpfile("Divider_trojan_Covert.vcd"); $dumpvars(0, tb_Divider_trojan_Covert); end
