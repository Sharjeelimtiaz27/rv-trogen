// Testbench for TestSourceCAM_Top
`timescale 1ns/1ps

module tb_TestSourceCAM_Top;
    ...
    initial begin $dumpfile("TestSourceCAM_Top.vcd"); $dumpvars(0, tb_TestSourceCAM_Top); end
