// Testbench for TestSourceCAM_Top_trojan_Integrity
`timescale 1ns/1ps

module tb_TestSourceCAM_Top_trojan_Integrity;
    ...
    TestSourceCAM_Top_trojan_Integrity dut (
        .clk_p(clk_p),
    ...
    initial begin $dumpfile("TestSourceCAM_Top_trojan_Integrity.vcd"); $dumpvars(0, tb_TestSourceCAM_Top_trojan_Integrity); end
