// Testbench for ReadyBitTable_trojan_DoS
`timescale 1ns/1ps

module tb_ReadyBitTable_trojan_DoS;
    ...
    initial begin $dumpfile("ReadyBitTable_trojan_DoS.vcd"); $dumpvars(0, tb_ReadyBitTable_trojan_DoS); end
