// Testbench for TestInitializedBlockRAM_Top
`timescale 1ns/1ps

module tb_TestInitializedBlockRAM_Top;
    ...
    TestInitializedBlockRAM_Top dut (
        .clk(clk),
        .rst(rst),
        .wr_en_i(wr_en_i),
        .wr_data_i(wr_data_i),
    ...
    initial begin $dumpfile("TestInitializedBlockRAM_Top.vcd"); $dumpvars(0, tb_TestInitializedBlockRAM_Top); end
