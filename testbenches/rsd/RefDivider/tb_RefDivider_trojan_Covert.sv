// Testbench for RefDivider_trojan_Covert
`timescale 1ns/1ps

module tb_RefDivider_trojan_Covert;
    ...
    initial begin $dumpfile("RefDivider_trojan_Covert.vcd"); $dumpvars(0, tb_RefDivider_trojan_Covert); end
