// Testbench for RefDivider_trojan_DoS
`timescale 1ns/1ps

module tb_RefDivider_trojan_DoS;
    ...
    initial begin $dumpfile("RefDivider_trojan_DoS.vcd"); $dumpvars(0, tb_RefDivider_trojan_DoS); end
