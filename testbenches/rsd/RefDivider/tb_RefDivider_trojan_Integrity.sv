// Testbench for RefDivider_trojan_Integrity
`timescale 1ns/1ps

module tb_RefDivider_trojan_Integrity;
    ...
    RefDivider_trojan_Integrity dut (
        .clk(clk),
        .rst(rst),
        .wr_en_i(wr_en_i),
        .wr_data_i(wr_data_i),
    ...
    initial begin $dumpfile("RefDivider_trojan_Integrity.vcd"); $dumpvars(0, tb_RefDivider_trojan_Integrity); end
