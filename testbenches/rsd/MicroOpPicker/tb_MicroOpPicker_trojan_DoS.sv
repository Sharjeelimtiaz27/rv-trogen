// Testbench for MicroOpPicker_trojan_DoS
`timescale 1ns/1ps

module tb_MicroOpPicker_trojan_DoS;
    ...
    initial begin $dumpfile("MicroOpPicker_trojan_DoS.vcd"); $dumpvars(0, tb_MicroOpPicker_trojan_DoS); end
