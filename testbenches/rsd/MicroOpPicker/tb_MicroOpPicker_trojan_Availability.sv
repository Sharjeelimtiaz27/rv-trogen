// Testbench for MicroOpPicker_trojan_Availability
`timescale 1ns/1ps
...
module tb_MicroOpPicker_trojan_Availability;
    ...
    initial begin $dumpfile("MicroOpPicker_trojan_Availability.vcd"); $dumpvars(0, tb_MicroOpPicker_trojan_Availability); end
