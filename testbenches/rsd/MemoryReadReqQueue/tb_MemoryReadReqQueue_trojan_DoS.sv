// Testbench for MemoryReadReqQueue_trojan_DoS
`timescale 1ns/1ps

module tb_MemoryReadReqQueue_trojan_DoS;
    ...
    MemoryReadReqQueue_trojan_DoS dut (
        .clk(clk),
        .rst(rst),
        .wr_en_i(wr_en_i),
        .wr_data_i(wr_data_i),
    ...
    initial begin $dumpfile("MemoryReadReqQueue_trojan_DoS.vcd"); $dumpvars(0, tb_MemoryReadReqQueue_trojan_DoS); end
