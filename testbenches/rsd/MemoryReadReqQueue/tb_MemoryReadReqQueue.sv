// Testbench for MemoryReadReqQueue
`timescale 1ns/1ps

module tb_MemoryReadReqQueue;
    ...
    initial begin $dumpfile("MemoryReadReqQueue.vcd"); $dumpvars(0, tb_MemoryReadReqQueue); end
