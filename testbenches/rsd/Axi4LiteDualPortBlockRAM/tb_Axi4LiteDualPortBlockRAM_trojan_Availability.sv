// Auto-generated minimal testbench for Axi4LiteDualPortBlockRAM_trojan_Availability
...
module tb_Axi4LiteDualPortBlockRAM_trojan_Availability;
    ...
    Axi4LiteDualPortBlockRAM_trojan_Availability dut ( .S_AXI_ACLK(S_AXI_ACLK), .rst_ni(rst_ni) );
