// Testbench for MultiplierUnit_trojan_Covert
`timescale 1ns/1ps

module tb_MultiplierUnit_trojan_Covert;
    ...
    MultiplierUnit_trojan_Covert dut (
        .clk(clk),
        .rst_ni(rst_ni),
        .wr_en_i(wr_en_i),
        .wr_data_i(wr_data_i),
    ...
    initial begin $dumpfile("MultiplierUnit_trojan_Covert.vcd"); $dumpvars(0, tb_MultiplierUnit_trojan_Covert); end
