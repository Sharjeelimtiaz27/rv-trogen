// Testbench for Main_trojan_Leak
`timescale 1ns/1ps

module tb_Main_trojan_Leak;
    ...
    initial begin $dumpfile("Main_trojan_Leak.vcd"); $dumpvars(0, tb_Main_trojan_Leak); end
