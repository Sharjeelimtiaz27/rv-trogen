// Testbench for Main_trojan_Availability
`timescale 1ns/1ps

module tb_Main_trojan_Availability;
    ...
    initial begin $dumpfile("Main_trojan_Availability.vcd"); $dumpvars(0, tb_Main_trojan_Availability); end
