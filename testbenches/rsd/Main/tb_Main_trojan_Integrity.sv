// Testbench for Main_trojan_Integrity
`timescale 1ns/1ps

module tb_Main_trojan_Integrity;
    ...
    initial begin $dumpfile("Main_trojan_Integrity.vcd"); $dumpvars(0, tb_Main_trojan_Integrity); end
