// Testbench for TestMultiWidthFreeListTop_trojan_Covert
`timescale 1ns/1ps

module tb_TestMultiWidthFreeListTop_trojan_Covert;
    ...
    TestMultiWidthFreeListTop_trojan_Covert dut (
        .clk_p(clk_p),
        .rst(rst),
        .wr_en_i(wr_en_i),
        .wr_data_i(wr_data_i),
    ...
    initial begin $dumpfile("TestMultiWidthFreeListTop_trojan_Covert.vcd"); $dumpvars(0, tb_TestMultiWidthFreeListTop_trojan_Covert); end
