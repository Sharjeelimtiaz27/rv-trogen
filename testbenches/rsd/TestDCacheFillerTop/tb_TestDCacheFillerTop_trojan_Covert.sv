// Testbench for TestDCacheFillerTop_trojan_Covert
`timescale 1ns/1ps

module tb_TestDCacheFillerTop_trojan_Covert;
    ...
    TestDCacheFillerTop_trojan_Covert dut (
        .clk_p(clk_p),
    ...
    initial begin $dumpfile("TestDCacheFillerTop_trojan_Covert.vcd"); $dumpvars(0, tb_TestDCacheFillerTop_trojan_Covert); end
