// Testbench for ControlQueue_trojan_Covert
`timescale 1ns/1ps

module tb_ControlQueue_trojan_Covert;
    ...
    ControlQueue_trojan_Covert dut (
        .clk(clk),
        .rst(rst),
        .wr_en_i(wr_en_i),
        .wr_data_i(wr_data_i),
    ...
    initial begin $dumpfile("ControlQueue_trojan_Covert.vcd"); $dumpvars(0, tb_ControlQueue_trojan_Covert); end
