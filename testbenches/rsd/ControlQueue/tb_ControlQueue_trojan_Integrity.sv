// Testbench for ControlQueue_trojan_Integrity
`timescale 1ns/1ps

module tb_ControlQueue_trojan_Integrity;
    ...
    ControlQueue_trojan_Integrity dut (
        .clk(clk),
        .rst(rst),
        .wr_en_i(wr_en_i),
        .wr_data_i(wr_data_i),
    ...
    initial begin $dumpfile("ControlQueue_trojan_Integrity.vcd"); $dumpvars(0, tb_ControlQueue_trojan_Integrity); end
