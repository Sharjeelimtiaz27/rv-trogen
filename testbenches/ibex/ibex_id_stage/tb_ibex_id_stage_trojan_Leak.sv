// Testbench for ibex_id_stage_trojan_Leak
`timescale 1ns/1ps

module tb_ibex_id_stage_trojan_Leak;
    ...
    initial begin $dumpfile("ibex_id_stage_trojan_Leak.vcd"); $dumpvars(0, tb_ibex_id_stage_trojan_Leak); end
