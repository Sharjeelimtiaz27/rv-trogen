// Testbench for is_trojan_Covert
`timescale 1ns/1ps

module tb_is_trojan_Covert;
    ...
    initial begin $dumpfile("is_trojan_Covert.vcd"); $dumpvars(0, tb_is_trojan_Covert); end
