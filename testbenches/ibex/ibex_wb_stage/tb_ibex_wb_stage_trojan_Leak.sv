// Testbench for ibex_wb_stage_trojan_Leak
`timescale 1ns/1ps

module tb_ibex_wb_stage_trojan_Leak;
    ...
    initial begin $dumpfile("ibex_wb_stage_trojan_Leak.vcd"); $dumpvars(0, tb_ibex_wb_stage_trojan_Leak); end
