// Testbench for ibex_wb_stage_trojan_DoS
`timescale 1ns/1ps

module tb_ibex_wb_stage_trojan_DoS;
    ...
    initial begin $dumpfile("ibex_wb_stage_trojan_DoS.vcd"); $dumpvars(0, tb_ibex_wb_stage_trojan_DoS); end
