// Testbench for ibex_wb_stage_trojan_Integrity
`timescale 1ns/1ps
...
module tb_ibex_wb_stage_trojan_Integrity;
    ...
    initial begin $dumpfile("ibex_wb_stage_trojan_Integrity.vcd"); $dumpvars(0, tb_ibex_wb_stage_trojan_Integrity); end
