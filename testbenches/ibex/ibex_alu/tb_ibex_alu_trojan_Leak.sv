// Testbench for ibex_alu_trojan_Leak
`timescale 1ns/1ps

module tb_ibex_alu_trojan_Leak;
    ...
    initial begin $dumpfile("ibex_alu_trojan_Leak.vcd"); $dumpvars(0, tb_ibex_alu_trojan_Leak); end
