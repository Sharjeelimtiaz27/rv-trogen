// Testbench for ibex_pmp_trojan_Privilege
`timescale 1ns/1ps

module tb_ibex_pmp_trojan_Privilege;
    ...
    initial begin $dumpfile("ibex_pmp_trojan_Privilege.vcd"); $dumpvars(0, tb_ibex_pmp_trojan_Privilege); end
