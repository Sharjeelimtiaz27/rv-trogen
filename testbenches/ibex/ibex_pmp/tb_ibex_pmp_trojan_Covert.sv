// Testbench for ibex_pmp_trojan_Covert
`timescale 1ns/1ps

module tb_ibex_pmp_trojan_Covert;
    ...
    initial begin $dumpfile("ibex_pmp_trojan_Covert.vcd"); $dumpvars(0, tb_ibex_pmp_trojan_Covert); end
