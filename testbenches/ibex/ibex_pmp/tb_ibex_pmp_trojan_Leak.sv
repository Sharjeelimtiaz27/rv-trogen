// Testbench for ibex_pmp_trojan_Leak
`timescale 1ns/1ps

module tb_ibex_pmp_trojan_Leak;
    ...
    initial begin $dumpfile("ibex_pmp_trojan_Leak.vcd"); $dumpvars(0, tb_ibex_pmp_trojan_Leak); end
