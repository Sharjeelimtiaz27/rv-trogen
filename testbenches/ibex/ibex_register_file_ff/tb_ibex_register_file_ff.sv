// Testbench for ibex_register_file_ff
`timescale 1ns/1ps

module tb_ibex_register_file_ff;
    ...
    initial begin $dumpfile("ibex_register_file_ff.vcd"); $dumpvars(0, tb_ibex_register_file_ff); end
