// Testbench for ibex_if_stage_trojan_Privilege
`timescale 1ns/1ps
...
module tb_ibex_if_stage_trojan_Privilege;
    ...
    initial begin $dumpfile("ibex_if_stage_trojan_Privilege.vcd"); $dumpvars(0, tb_ibex_if_stage_trojan_Privilege); end
