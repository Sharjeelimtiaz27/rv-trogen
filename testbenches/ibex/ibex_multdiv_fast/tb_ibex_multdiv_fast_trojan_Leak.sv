// Testbench for ibex_multdiv_fast_trojan_Leak
`timescale 1ns/1ps

module tb_ibex_multdiv_fast_trojan_Leak;
    ...
    ibex_multdiv_fast_trojan_Leak dut (
        .clk_i(clk_i),
        .rst_ni(rst_ni),
        .wr_en_i(wr_en_i),
        .wr_data_i(wr_data_i),
    ...
    initial begin $dumpfile("ibex_multdiv_fast_trojan_Leak.vcd"); $dumpvars(0, tb_ibex_multdiv_fast_trojan_Leak); end
