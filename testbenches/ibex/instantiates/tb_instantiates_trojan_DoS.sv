// Testbench for instantiates_trojan_DoS
`timescale 1ns/1ps

module tb_instantiates_trojan_DoS;
    ...
    initial begin $dumpfile("instantiates_trojan_DoS.vcd"); $dumpvars(0, tb_instantiates_trojan_DoS); end
