// Testbench for instantiates_trojan_Leak
`timescale 1ns/1ps

module tb_instantiates_trojan_Leak;
    ...
    initial begin $dumpfile("instantiates_trojan_Leak.vcd"); $dumpvars(0, tb_instantiates_trojan_Leak); end
