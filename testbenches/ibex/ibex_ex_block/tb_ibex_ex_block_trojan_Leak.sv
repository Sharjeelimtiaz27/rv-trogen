// Testbench for ibex_ex_block_trojan_Leak
`timescale 1ns/1ps

module tb_ibex_ex_block_trojan_Leak;
    ...
    initial begin $dumpfile("ibex_ex_block_trojan_Leak.vcd"); $dumpvars(0, tb_ibex_ex_block_trojan_Leak); end
