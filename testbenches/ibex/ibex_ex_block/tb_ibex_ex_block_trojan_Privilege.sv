// Testbench for ibex_ex_block_trojan_Privilege
`timescale 1ns/1ps

module tb_ibex_ex_block_trojan_Privilege;
    ...
    ibex_ex_block_trojan_Privilege dut (
        .clk_i(clk_i),
        .rst_ni(rst_ni),
        .wr_en_i(wr_en_i),
        .wr_data_i(wr_data_i),
    ...
    initial begin $dumpfile("ibex_ex_block_trojan_Privilege.vcd"); $dumpvars(0, tb_ibex_ex_block_trojan_Privilege); end
