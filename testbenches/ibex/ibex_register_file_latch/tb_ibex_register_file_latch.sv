// Testbench for ibex_register_file_latch
`timescale 1ns/1ps

module tb_ibex_register_file_latch;
    ...
    initial begin $dumpfile("ibex_register_file_latch.vcd"); $dumpvars(0, tb_ibex_register_file_latch); end
