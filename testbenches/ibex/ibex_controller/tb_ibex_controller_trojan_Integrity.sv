// Testbench for ibex_controller_trojan_Integrity
`timescale 1ns/1ps
...
module tb_ibex_controller_trojan_Integrity;
    ...
    initial begin $dumpfile("ibex_controller_trojan_Integrity.vcd"); $dumpvars(0, tb_ibex_controller_trojan_Integrity); end
