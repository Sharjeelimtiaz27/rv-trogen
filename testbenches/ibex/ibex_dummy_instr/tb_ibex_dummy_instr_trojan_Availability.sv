// Testbench for ibex_dummy_instr_trojan_Availability
`timescale 1ns/1ps

module tb_ibex_dummy_instr_trojan_Availability;
    ...
    ibex_dummy_instr_trojan_Availability dut (
        .clk_i(clk_i),
        .rst_ni(rst_ni),
        .wr_en_i(wr_en_i),
        .wr_data_i(wr_data_i),
    ...
    initial begin $dumpfile("ibex_dummy_instr_trojan_Availability.vcd"); $dumpvars(0, tb_ibex_dummy_instr_trojan_Availability); end
