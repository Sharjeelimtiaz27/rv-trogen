// Testbench for of_trojan_Integrity
`timescale 1ns/1ps

module tb_of_trojan_Integrity;
    ...
    initial begin $dumpfile("of_trojan_Integrity.vcd"); $dumpvars(0, tb_of_trojan_Integrity); end
