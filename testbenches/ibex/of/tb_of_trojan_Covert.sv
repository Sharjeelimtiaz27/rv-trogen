// Testbench for of_trojan_Covert
`timescale 1ns/1ps

module tb_of_trojan_Covert;
    ...
    initial begin $dumpfile("of_trojan_Covert.vcd"); $dumpvars(0, tb_of_trojan_Covert); end
