// Testbench for of_trojan_Privilege
`timescale 1ns/1ps

module tb_of_trojan_Privilege;
    ...
    initial begin $dumpfile("of_trojan_Privilege.vcd"); $dumpvars(0, tb_of_trojan_Privilege); end
