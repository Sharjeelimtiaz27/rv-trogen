// Testbench for of_trojan_Availability
`timescale 1ns/1ps

module tb_of_trojan_Availability;
    ...
    initial begin $dumpfile("of_trojan_Availability.vcd"); $dumpvars(0, tb_of_trojan_Availability); end
