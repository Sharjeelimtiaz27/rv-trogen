// Testbench for ibex_icache_trojan_DoS
`timescale 1ns/1ps

module tb_ibex_icache_trojan_DoS;
    ...
    initial begin $dumpfile("ibex_icache_trojan_DoS.vcd"); $dumpvars(0, tb_ibex_icache_trojan_DoS); end
