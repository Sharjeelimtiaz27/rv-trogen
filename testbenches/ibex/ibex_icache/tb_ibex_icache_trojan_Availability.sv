// Testbench for ibex_icache_trojan_Availability
`timescale 1ns/1ps
...
module tb_ibex_icache_trojan_Availability;
    ...
    initial begin $dumpfile("ibex_icache_trojan_Availability.vcd"); $dumpvars(0, tb_ibex_icache_trojan_Availability); end
