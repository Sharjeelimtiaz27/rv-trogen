...
Automated simulation and behavioral comparison framework (coming in Week 3).
...
|---------|------------------|-----------------|---------------|-----------------|
| **Target** | RISC-V (Ibex/CVA6/NaxRiscv) | RISC-V (PULPino) | AES/RSA | Generic |
| **Approach** | Pattern-based | Manual insertion | Manual benchmarks | ML/RL-based |
...
**Key Innovation:** First automated, open-source, multi-core framework for RISC-V Trojan generation with comprehensive validation.
...
cat examples/ibex/generated_trojans/ibex_alu/ibex_alu_trojan_summary.md
```
...
- [Examples](examples/parser_usage.py) - Working code samples
...
**High Priority:**
- Testing on CVA6 and NaxRiscv cores
- Template system completion (Steps 9-13)
...
This is research software provided as-is for educational and research purposes.
...
- **Discussions:** https://github.com/sharjeelimtiaz27/rv-trogen/discussions
...
@misc{rvtrogen2025,
  ...
  note = {Open-source framework for hardware security research}
}
```
...
**Status:** Active Development (Week 2 Complete - 27%)
