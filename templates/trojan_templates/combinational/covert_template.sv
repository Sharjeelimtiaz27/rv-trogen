 ...
 *   depending on whether {{TRIGGER_SIGNAL}} matches the pattern.
 *
 ...
 * Payload: XOR {{PAYLOAD_SIGNAL}}[0] into observable output
 *
...
wire secret_bit;
assign secret_bit = {{PAYLOAD_SIGNAL}}[0];  // LSB is the secret to transmit
...
//   Output LSB = normal_LSB XOR {{PAYLOAD_SIGNAL}}[0]
