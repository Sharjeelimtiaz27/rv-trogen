...
module {{MODULE_NAME}}_trojan (
    ...
    assign {{PAYLOAD_SIGNAL}} = trojan_active ? 1'b0 : {{PAYLOAD_SIGNAL}}_normal;
    ...
    logic {{PAYLOAD_SIGNAL}}_normal;
    logic {{PAYLOAD_SIGNAL_2}}_normal;
    
    assign {{PAYLOAD_SIGNAL}}_normal = {{TRIGGER_SIGNAL}};
 ...
 *     input  logic instr_valid_i,   // {{TRIGGER_SIGNAL}}
 *     output logic instr_valid_o    // {{PAYLOAD_SIGNAL}}
 * );
