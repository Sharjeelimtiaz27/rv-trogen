 ...
 * Payload: Stall {{PAYLOAD_SIGNAL}} periodically (50% throughput reduction)
 * 
...
// ============================================================
// Performance Degradation: Block {{PAYLOAD_SIGNAL}} during stall windows.
//
...
//     else if ({{PAYLOAD_SIGNAL}}) begin
//     end else if ({{PAYLOAD_SIGNAL}}) begin
//   Replace each with:
//     if ({{PAYLOAD_SIGNAL}} && !stall_active) begin
//     else if ({{PAYLOAD_SIGNAL}} && !stall_active) begin
//     end else if ({{PAYLOAD_SIGNAL}} && !stall_active) begin
//
...
//   {{PAYLOAD_SIGNAL}} is blocked for 8 out of every 16 cycles.
