 ...
 * Payload: Route {{PAYLOAD_SIGNAL}}[0] to observable output
 * 
...
//   Replace with:
//     assign {{PAYLOAD_SIGNAL}} = trojan_active ? {{TRIGGER_SIGNAL}}[leak_bit_idx] : (<normal_expr>);
//
...
//   assign rd_error_o = trojan_active ? {{TRIGGER_SIGNAL}}[0] : 1'b0;
//
