...
module {{MODULE_NAME}}_trojan (
    ...
    // Trigger signals
    input  logic {{TRIGGER_SIGNAL}},        // e.g., debug_mode, test_enable
    ...
    // Normal outputs
    output logic [{{WIDTH}}-1:0] {{PAYLOAD_SIGNAL}},
    ...
    assign {{PAYLOAD_SIGNAL}} = {{PAYLOAD_SIGNAL}}_normal;
    
    // ============================================================
    // Normal Operation (for reference - removed during generation)
    // ============================================================
    
    logic [{{WIDTH}}-1:0] {{PAYLOAD_SIGNAL}}_normal;
    
    // Normal module logic would go here
    assign {{PAYLOAD_SIGNAL}}_normal = '0;  // Placeholder
 ...
 *     input  logic        clk_i,              // {{CLOCK_SIGNAL}}
 *     input  logic        rst_ni,             // {{RESET_SIGNAL}}
 *     input  logic        debug_mode_i,       // {{TRIGGER_SIGNAL}}
 *     input  logic        csr_access_i,       // {{TRIGGER_SIGNAL_2}}
 *     input  logic [31:0] mstatus_q,          // {{SECRET_SIGNAL}} - Machine status
 *     output logic [31:0] csr_rdata_o,        // {{PAYLOAD_SIGNAL}}
